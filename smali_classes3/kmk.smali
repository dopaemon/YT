...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Ladaz;-><init>(Ljava/lang/String;Landroid/media/MediaCodecInfo$CodecCapabilities;)V
    ...
    sput-object v0, Lkmk;->a:Ljava/util/Map;
...
.method public static declared-synchronized a(Ljava/lang/String;Z)Ljava/util/List;
    ...
    invoke-direct {v1, p0, p1}, Lkmf;-><init>(Ljava/lang/String;Z)V

    sget-object v2, Lkmk;->a:Ljava/util/Map;
    ...
    .line 3
    invoke-direct {v3, p1}, Lkmj;-><init>(Z)V
    ...
    .line 4
    :goto_0
    invoke-static {v1, v3}, Lkmk;->b(Lkmf;Lkmh;)Ljava/util/List;
    ...
    .line 6
    invoke-static {v1, p1}, Lkmk;->b(Lkmf;Lkmh;)Ljava/util/List;
...
.method private static b(Lkmf;Lkmh;)Ljava/util/List;
    .locals 16
    ...
    iget-object v4, v1, Lkmf;->a:Ljava/lang/String;

    .line 2
    invoke-interface/range {p1 .. p1}, Lkmh;->a()I

    move-result v5

    .line 3
    invoke-interface/range {p1 .. p1}, Lkmh;->d()Z
    ...
    .line 4
    invoke-interface {v2, v8}, Lkmh;->b(I)Landroid/media/MediaCodecInfo;
    ...
    sget-object v12, Lksh;->b:Ljava/lang/String;
    ...
    sget-object v0, Lksh;->b:Ljava/lang/String;
    ...
    sget-object v13, Lksh;->b:Ljava/lang/String;
    ...
    sget-object v14, Lksh;->c:Ljava/lang/String;
    ...
    .line 43
    invoke-interface {v2, v4, v0}, Lkmh;->c(Ljava/lang/String;Landroid/media/MediaCodecInfo$CodecCapabilities;)Z

    move-result v7

    if-eqz v6, :cond_9

    iget-boolean v2, v1, Lkmf;->b:Z
    ...
    .line 45
    invoke-direct {v2, v10, v0}, Ladaz;-><init>(Ljava/lang/String;Landroid/media/MediaCodecInfo$CodecCapabilities;)V
    ...
    invoke-direct {v2, v7, v0}, Ladaz;-><init>(Ljava/lang/String;Landroid/media/MediaCodecInfo$CodecCapabilities;)V
    ...
    .line 50
    invoke-direct {v1, v0}, Lkmg;-><init>(Ljava/lang/Throwable;)V
