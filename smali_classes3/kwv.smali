...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lkzy;)V
    .locals 0

    iput-object p1, p0, Lkwv;->a:Landroid/content/Context;

    iput-object p2, p0, Lkwv;->b:Lkzy;
...
.method public final bridge synthetic b()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lkwv;->a:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v2, p0, Lkwv;->a:Landroid/content/Context;

    const-string v3, "com.google.android.gms.ads.DynamiteOfflineUtilsCreatorImpl"

    sget-object v4, Lkwu;->a:Lkwu;

    .line 2
    invoke-static {v2, v3, v4}, Llat;->i(Landroid/content/Context;Ljava/lang/String;Llbi;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Llav;

    iget-object v3, p0, Lkwv;->b:Lkzy;
    ...
    .line 3
    invoke-virtual {v2, v0, v4}, Ldth;->pQ(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v3, v2}, Llau;-><init>(Landroid/os/IBinder;)V

    .line 11
    :goto_0
    invoke-virtual {v0}, Landroid/os/Parcel;->recycle()V
    :try_end_0
    .catch Llbj; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final bridge synthetic c(Lkxz;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Llau;-><init>(Landroid/os/IBinder;)V
