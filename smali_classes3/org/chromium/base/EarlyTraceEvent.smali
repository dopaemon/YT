...
.method public static a(Ljava/lang/String;Z)V
    ...
    .line 2
    invoke-direct {v0, p0, v1, p1}, Laphg;-><init>(Ljava/lang/String;ZZ)V
...
.method private static f(Ljava/util/List;)V
    ...
    .line 3
    iget-boolean v3, v2, Laphf;->a:Z

    if-eqz v3, :cond_0

    .line 4
    iget-object v3, v2, Laphf;->b:Ljava/lang/String;

    iget-wide v4, v2, Laphf;->c:J

    iget-wide v6, v2, Laphf;->d:J
...
.method private static g(Ljava/util/List;)V
    ...
    .line 3
    iget-boolean v4, v3, Laphg;->a:Z

    if-eqz v4, :cond_1

    .line 4
    iget-boolean v4, v3, Laphg;->b:Z

    if-eqz v4, :cond_0

    .line 5
    iget-object v5, v3, Laphg;->c:Ljava/lang/String;

    iget-wide v6, v3, Laphg;->e:J

    add-long/2addr v6, v0

    iget v8, v3, Laphg;->d:I

    iget-wide v9, v3, Laphg;->f:J
    ...
    .line 7
    :cond_0
    iget-object v11, v3, Laphg;->c:Ljava/lang/String;

    iget-wide v4, v3, Laphg;->e:J

    add-long v12, v4, v0

    iget v14, v3, Laphg;->d:I

    iget-wide v3, v3, Laphg;->f:J
...
.method static setBackgroundStartupTracingFlag(Z)V
    ...
    .line 1
    sget-object v0, Laphe;->a:Landroid/content/SharedPreferences;
