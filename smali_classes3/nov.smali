...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lnos;)V
    .locals 1
    ...
    iput-object v0, p0, Lnov;->c:Ljava/util/Queue;

    new-instance v0, Lnoz;

    .line 2
    invoke-direct {v0, p1, p0, p2}, Lnoz;-><init>(Landroid/content/Context;Lnow;Lnos;)V

    iput-object v0, p0, Lnov;->a:Lnox;
...
.method public final a()Lduh;
    ...
    iget-object v0, p0, Lnov;->a:Lnox;

    .line 2
    invoke-interface {v0}, Lnox;->f()Z
...
.method public final b()V
    ...
    .line 1
    :goto_0
    iget-object v0, p0, Lnov;->c:Ljava/util/Queue;
    ...
    .line 3
    invoke-interface {v1}, Lnox;->g()I

    move-result v1

    invoke-interface {v0, v1}, Lnou;->a(I)V
...
.method public final c(Landroid/os/Bundle;)Z
    ...
    .line 8
    invoke-interface {p1, v0, v2}, Lnox;->c([BLcom/google/android/apps/gsa/publicsearch/SystemParcelableWrapper;)V
    :try_end_0
...
.method public final d(Lnou;)V
    ...
    .line 5
    invoke-virtual {p1}, Lnoz;->j()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p1}, Lnoz;->k()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p1}, Lnoz;->m()V
    ...
    .line 3
    invoke-interface {v0}, Lnox;->g()I

    move-result v0

    invoke-interface {p1, v0}, Lnou;->a(I)V
