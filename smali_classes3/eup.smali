...
.method public final onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    iput-boolean v0, p1, Leur;->l:Z

    iget-boolean v2, p1, Leur;->m:Z

    if-eqz v2, :cond_6

    iput-boolean v1, p1, Leur;->d:Z

    new-instance v2, Landroid/widget/FrameLayout;

    invoke-virtual {p1}, Leur;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v2, v3}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    iget-boolean v3, p1, Leur;->n:Z
    ...
    .line 2
    invoke-virtual {p1, v5}, Leur;->getLocationInWindow([I)V

    .line 3
    invoke-virtual {p1}, Leur;->a()Landroid/widget/ImageView;

    move-result-object v6

    .line 4
    invoke-virtual {p1}, Leur;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    invoke-virtual {p1}, Leur;->getWidth()I

    move-result v8

    invoke-virtual {p1}, Leur;->getHeight()I
    ...
    .line 10
    invoke-virtual {p1}, Leur;->getResources()Landroid/content/res/Resources;
    ...
    iput-object v0, p1, Leur;->g:Landroid/widget/ImageView;

    iget-object v0, p1, Leur;->g:Landroid/widget/ImageView;

    .line 17
    invoke-virtual {p1}, Leur;->getDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p1, Leur;->f:Landroid/app/Dialog;
    ...
    .line 29
    :cond_1
    iget-object v0, p1, Leur;->f:Landroid/app/Dialog;
    ...
    iget-object v0, p1, Leur;->i:Lniz;

    if-eqz v0, :cond_6

    iget-object v0, p1, Leur;->j:Lalxp;
    ...
    iget-object v2, p1, Leur;->h:Lnjf;

    if-eqz v2, :cond_4

    iget-object v2, v2, Lnjf;->r:Lnjm;

    iput-object v2, v0, Lsvk;->f:Ljava/lang/Object;

    :cond_4
    iget-object v2, p1, Leur;->i:Lniz;

    iget-object p1, p1, Leur;->j:Lalxp;
    ...
    .line 28
    invoke-interface {v2, p1, v0}, Lniz;->b(Lalxp;Lnix;)Lantl;
