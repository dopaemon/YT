...
.method static constructor <clinit>()V
    ...
    .line 5
    invoke-static {v1}, Lnic;->a(I)Landroid/graphics/Paint;

    move-result-object v1

    sput-object v1, Lnib;->e:Landroid/graphics/Paint;

    .line 6
    invoke-static {v2}, Lnic;->a(I)Landroid/graphics/Paint;

    move-result-object v1

    sput-object v1, Lnib;->f:Landroid/graphics/Paint;

    .line 7
    invoke-static {v3}, Lnic;->a(I)Landroid/graphics/Paint;

    move-result-object v1

    sput-object v1, Lnib;->g:Landroid/graphics/Paint;

    .line 8
    invoke-static {v0}, Lnic;->a(I)Landroid/graphics/Paint;

    move-result-object v0

    sput-object v0, Lnib;->h:Landroid/graphics/Paint;
...
.method public constructor <init>(Ldap;)V
    ...
    iput-object v1, v0, Lnib;->i:Landroid/graphics/Path;
    ...
    iput-object v2, v0, Lnib;->j:Landroid/graphics/Path;
    ...
    iput-object v3, v0, Lnib;->k:Landroid/graphics/Path;
    ...
    iput-object v4, v0, Lnib;->l:Landroid/graphics/Path;

    .line 6
    invoke-virtual/range {p1 .. p1}, Ldap;->h()Ldma;
    ...
    .line 7
    invoke-virtual/range {p1 .. p1}, Ldap;->b()Landroid/graphics/Rect;
    ...
    .line 9
    invoke-virtual {v5, v9}, Ldma;->T(I)F
    ...
    .line 10
    invoke-virtual {v5, v11}, Ldma;->T(I)F
    ...
    .line 11
    invoke-virtual {v5, v13}, Ldma;->T(I)F
    ...
    .line 12
    invoke-virtual {v5, v15}, Ldma;->T(I)F
    ...
    .line 14
    invoke-virtual {v5, v9}, Ldma;->S(I)F
    ...
    .line 15
    invoke-virtual {v5, v11}, Ldma;->S(I)F
    ...
    .line 16
    invoke-virtual {v5, v13}, Ldma;->S(I)F
    ...
    .line 17
    invoke-virtual {v5, v15}, Ldma;->S(I)F
    ...
    .line 19
    invoke-virtual {v5, v9}, Ldma;->U(I)F
    ...
    .line 20
    invoke-virtual {v5, v11}, Ldma;->U(I)F
    ...
    .line 21
    invoke-virtual {v5, v13}, Ldma;->U(I)F
    ...
    .line 22
    invoke-virtual {v5, v15}, Ldma;->U(I)F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    .line 1
    iget-object v0, p0, Lnib;->i:Landroid/graphics/Path;

    sget-object v1, Lnib;->e:Landroid/graphics/Paint;

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v0, p0, Lnib;->j:Landroid/graphics/Path;

    sget-object v1, Lnib;->f:Landroid/graphics/Paint;

    .line 2
    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v0, p0, Lnib;->k:Landroid/graphics/Path;

    sget-object v1, Lnib;->g:Landroid/graphics/Paint;

    .line 3
    invoke-virtual {p1, v0, v1}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v0, p0, Lnib;->l:Landroid/graphics/Path;

    sget-object v1, Lnib;->h:Landroid/graphics/Paint;
