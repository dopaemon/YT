...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lko;->j:Landroid/graphics/RectF;
    ...
    sput-object v0, Lko;->k:Lj$/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v1, p0, Lko;->f:[I

    iput-boolean v0, p0, Lko;->g:Z

    iput-object p1, p0, Lko;->h:Landroid/widget/TextView;

    invoke-virtual {p1}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lko;->i:Landroid/content/Context;
...
.method public static d(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, Lko;->m(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private static m(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    .line 1
    :try_start_0
    sget-object v0, Lko;->k:Lj$/util/concurrent/ConcurrentHashMap;
...
.method final e()V
    ...
    iget-object v0, p0, Lko;->h:Landroid/widget/TextView;
    ...
    :cond_1
    iget-object v0, p0, Lko;->m:Leb;

    iget-object v2, p0, Lko;->h:Landroid/widget/TextView;

    .line 3
    invoke-virtual {v0, v2}, Leb;->z(Landroid/widget/TextView;)Z
    ...
    iget-object v3, p0, Lko;->h:Landroid/widget/TextView;
    ...
    :cond_3
    sget-object v3, Lko;->j:Landroid/graphics/RectF;
    ...
    iget-object v7, p0, Lko;->f:[I

    .line 14
    aget v7, v7, v6

    iget-object v8, p0, Lko;->h:Landroid/widget/TextView;
    ...
    iget-object v9, p0, Lko;->h:Landroid/widget/TextView;
    ...
    iget-object v10, p0, Lko;->h:Landroid/widget/TextView;
    ...
    iget-object v10, p0, Lko;->l:Landroid/text/TextPaint;
    ...
    iput-object v10, p0, Lko;->l:Landroid/text/TextPaint;
    ...
    iget-object v11, p0, Lko;->h:Landroid/widget/TextView;
    ...
    iget-object v7, p0, Lko;->h:Landroid/widget/TextView;
    ...
    .line 23
    invoke-static {v7, v10, v11}, Lko;->d(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v12, p0, Lko;->l:Landroid/text/TextPaint;
    ...
    iget-object v12, p0, Lko;->h:Landroid/widget/TextView;
    ...
    :try_start_1
    iget-object v7, p0, Lko;->m:Leb;

    iget-object v11, p0, Lko;->h:Landroid/widget/TextView;

    .line 35
    invoke-virtual {v7, v10, v11}, Leb;->y(Landroid/text/StaticLayout$Builder;Landroid/widget/TextView;)V
    :try_end_1
    ...
    .line 43
    invoke-virtual {p0, v4, v0}, Lko;->f(IF)V
...
.method final f(IF)V
    ...
    .line 1
    iget-object v0, p0, Lko;->i:Landroid/content/Context;
    ...
    iget-object p2, p0, Lko;->h:Landroid/widget/TextView;
    ...
    iget-object p1, p0, Lko;->h:Landroid/widget/TextView;
    ...
    iput-boolean p2, p0, Lko;->b:Z

    :try_start_0
    const-string v0, "nullLayouts"

    .line 8
    invoke-static {v0}, Lko;->m(Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object v1, p0, Lko;->h:Landroid/widget/TextView;
