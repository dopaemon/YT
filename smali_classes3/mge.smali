...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lllz;Llma;Ljava/lang/String;Llpb;)V
    .locals 7
    ...
    iput-object p1, p0, Lmge;->e:Ljava/util/HashMap;

    iput-object p5, p0, Lmge;->a:Ljava/lang/String;

    iget-object p1, p6, Llpb;->e:Ljava/lang/String;
...
.method public final h()[Lcom/google/android/gms/common/Feature;
    ...
    .line 1
    sget-object v0, Lmfm;->q:[Lcom/google/android/gms/common/Feature;
...
.method public final declared-synchronized k(Landroid/os/Bundle;)V
    ...
    .line 4
    invoke-virtual {v0, v1, v2}, Lmgk;->b([Ljava/lang/String;[Ljava/lang/String;)V
    ...
    sput-object v0, Lmge;->c:Landroid/os/Bundle;
    ...
    sput-object p1, Lmge;->d:Landroid/os/Bundle;
    :try_end_0
...
.method public final l()V
    ...
    .line 1
    iget-object v0, p0, Lmge;->e:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lmge;->e:Ljava/util/HashMap;
    ...
    iget-object v3, v2, Lmfz;->a:Llnx;

    .line 4
    invoke-virtual {v3}, Llnx;->a()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 5
    :try_start_1
    invoke-virtual {p0}, Lmge;->p()Lmfx;

    move-result-object v3

    const/4 v4, 0x0

    invoke-virtual {v3, v2, v4, v4}, Lmfx;->a(Lmfw;ZI)V
    :try_end_1
    ...
    .line 6
    invoke-static {v3, v2}, Llhk;->t(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected final m(ILandroid/os/IBinder;Landroid/os/Bundle;I)V
    ...
    invoke-virtual {p0, p1}, Lmge;->k(Landroid/os/Bundle;)V
...
.method public final o(Llmx;I)V
    .locals 4

    .line 1
    invoke-super {p0}, Llpi;->H()V

    new-instance v0, Lmga;

    .line 2
    invoke-direct {v0, p1}, Lmga;-><init>(Llmx;)V
    ...
    .line 6
    invoke-static {v2, v3}, Ldtj;->e(Landroid/os/Parcel;Z)V
    ...
    .line 11
    invoke-virtual {v1, p2, v2}, Ldth;->pR(ILandroid/os/Parcel;)V
    :try_end_0
    ...
    .line 12
    invoke-virtual {v0, p2, p1, p1}, Lmfw;->a(ILandroid/os/Bundle;Lcom/google/android/gms/common/data/DataHolder;)V

    return-void
.end method

.method public final p()Lmfx;
    .locals 1

    .line 1
    invoke-super {p0}, Llpi;->D()Landroid/os/IInterface;
