...
# direct methods
.method public constructor <init>(Ltg;Ljava/io/File;)V
    .locals 0

    invoke-direct {p0}, Lorg/chromium/net/UrlRequest$Callback;-><init>()V

    iput-object p1, p0, Lmty;->a:Ltg;

    iput-object p2, p0, Lmty;->b:Ljava/io/File;
...
.method private final a()Z
    ...
    .line 1
    iget-object v0, p0, Lmty;->c:Ljava/nio/channels/FileChannel;
    ...
    .line 2
    iput-object v0, p0, Lmty;->d:Ljava/lang/Exception;

    :goto_0
    const/4 v0, 0x0

    .line 1
    iput-object v0, p0, Lmty;->c:Ljava/nio/channels/FileChannel;

    :cond_0
    iget-object v0, p0, Lmty;->d:Ljava/lang/Exception;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lmty;->a:Ltg;
...
.method public final onCanceled(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;)V
    ...
    .line 1
    invoke-direct {p0}, Lmty;->a()Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p1, p0, Lmty;->a:Ltg;
...
.method public final onFailed(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;Lorg/chromium/net/CronetException;)V
    ...
    .line 2
    invoke-virtual {p1, p3}, Ltg;->d(Ljava/lang/Throwable;)V
...
.method public final onReadCompleted(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;Ljava/nio/ByteBuffer;)V
    ...
    .line 4
    invoke-static {p1, p2}, Lmty;->b(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;)V
    ...
    iput-object p2, p0, Lmty;->d:Ljava/lang/Exception;
...
.method public final onResponseStarted(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lmty;->b:Ljava/io/File;
