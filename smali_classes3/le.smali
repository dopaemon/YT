...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lle;->i:Ljava/lang/reflect/Field;
...
.method private final c(Z)V
    ...
    iget-object v0, p0, Lle;->j:Lld;

    if-eqz v0, :cond_0

    iput-boolean p1, v0, Lld;->b:Z
...
.method public final a(Landroid/view/MotionEvent;I)Z
    ...
    .line 6
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lle;->getFirstVisiblePosition()I
    ...
    iput-boolean v4, v1, Lle;->l:Z

    .line 7
    invoke-virtual {v1, v7, v6}, Lle;->drawableHotspotChanged(FF)V

    .line 8
    invoke-virtual/range {p0 .. p0}, Lle;->isPressed()Z
    ...
    .line 9
    invoke-virtual {v1, v4}, Lle;->setPressed(Z)V

    .line 10
    :cond_5
    invoke-virtual/range {p0 .. p0}, Lle;->layoutChildren()V
    ...
    .line 19
    :cond_7
    invoke-virtual/range {p0 .. p0}, Lle;->getSelector()Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v0, v1, Lle;->i:Ljava/lang/reflect/Field;
    ...
    iget-object v5, v1, Lle;->i:Ljava/lang/reflect/Field;
    ...
    .line 29
    invoke-virtual/range {p0 .. p0}, Lle;->refreshDrawableState()V
    :try_end_0
    ...
    .line 33
    invoke-virtual/range {p0 .. p0}, Lle;->getVisibility()I
    ...
    .line 39
    invoke-virtual {v1, v12}, Lle;->getItemIdAtPosition(I)J

    move-result-wide v5

    .line 40
    invoke-virtual {v1, v10, v12, v5, v6}, Lle;->performItemClick(Landroid/view/View;IJ)Z
    ...
    .line 1
    iput-boolean v3, v1, Lle;->l:Z

    .line 41
    invoke-virtual {v1, v3}, Lle;->setPressed(Z)V

    .line 42
    invoke-virtual/range {p0 .. p0}, Lle;->drawableStateChanged()V
    ...
    invoke-virtual {v1, v5}, Lle;->getChildAt(I)Landroid/view/View;
    ...
    invoke-direct {v3, v1}, Ladd;-><init>(Landroid/widget/ListView;)V

    iput-object v3, v1, Lle;->m:Ladd;

    :cond_12
    iget-object v3, v1, Lle;->m:Ladd;

    .line 46
    invoke-virtual {v3, v4}, Ladd;->c(Z)V

    iget-object v3, v1, Lle;->m:Ladd;

    .line 47
    invoke-virtual {v3, v1, v2}, Ladd;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_8

    :cond_13
    iget-object v2, v1, Lle;->m:Ladd;
    ...
    .line 48
    invoke-virtual {v2, v3}, Ladd;->c(Z)V
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {v0, p0, v1}, Lbf;-><init>(Lle;I)V

    iput-object v0, p0, Lle;->b:Lbf;

    iget-object v3, v0, Lbf;->a:Ljava/lang/Object;
    ...
    .line 11
    :cond_3
    invoke-virtual {p0, v3}, Lle;->setSelection(I)V
...
.method public final setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v0, p1}, Lld;-><init>(Landroid/graphics/drawable/Drawable;)V
