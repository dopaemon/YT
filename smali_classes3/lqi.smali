...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llqi;->b:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Llqi;->a:Lj$/util/concurrent/ConcurrentHashMap;
...
.method public static a()Llqi;
    ...
    sget-object v0, Llqi;->b:Ljava/lang/Object;
...
.method public final b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, Llqi;->f(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Llqi;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Llqi;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Llqi;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    .line 2
    :cond_0
    invoke-static {p1, p2}, Llqi;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 2
    invoke-virtual/range {v1 .. v6}, Llqi;->d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual {v3, v0, v2}, Lkyo;->e(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Llqi;->f(Landroid/content/ServiceConnection;)Z
    ...
    .line 15
    iget-object p2, p0, Llqi;->a:Lj$/util/concurrent/ConcurrentHashMap;
