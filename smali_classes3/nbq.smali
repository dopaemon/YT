...
.method public constructor <init>(Lnkg;)V
    ...
    iput-object p1, p0, Lnbq;->a:Lnkg;

    return-void
.end method

.method private static c(Lczu;Lalzj;Lnkg;)I
    .locals 6

    .line 1
    iget-object p0, p0, Lczu;->b:Landroid/content/Context;

    iget p1, p1, Lalzj;->c:I
    ...
    .line 4
    invoke-virtual {p2, v2, p0}, Lnkg;->b(ILjava/lang/String;)V
    ...
    .line 6
    invoke-static {p0, v1}, Lxc;->a(Landroid/content/Context;I)I
    ...
    .line 7
    invoke-virtual {p2, v2, p1, p0}, Lnkg;->d(ILjava/lang/String;Ljava/lang/Throwable;)V

    return v4
.end method

.method private static d(Lalzj;Landroid/graphics/drawable/RippleDrawable;Landroid/util/DisplayMetrics;)V
    .locals 1

    .line 1
    iget p0, p0, Lalzj;->d:I
...
.method public final a()Ladon;
    ...
    .line 1
    sget-object v0, Lalzj;->b:Ladpd;

    return-object v0
.end method

.method public final synthetic b(Lczu;Ljava/lang/Object;Lnkz;)V
    .locals 4

    .line 1
    check-cast p2, Lalzj;

    iget-object v0, p0, Lnbq;->a:Lnkg;

    .line 2
    invoke-static {p1, p2, v0}, Lnbq;->c(Lczu;Lalzj;Lnkg;)I
    ...
    :cond_0
    iget-boolean v1, p2, Lalzj;->e:Z

    iget-object v2, p3, Lnkz;->d:Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    invoke-static {p2, v1, p1}, Lnbq;->d(Lalzj;Landroid/graphics/drawable/RippleDrawable;Landroid/util/DisplayMetrics;)V

    iput-object v1, p3, Lnkz;->d:Landroid/graphics/drawable/Drawable;
