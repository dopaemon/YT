...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p2, p0, Lmtf;->f:Ljava/util/concurrent/Executor;
    ...
    iput-object p1, p0, Lmtf;->e:Landroid/hardware/camera2/CameraManager;
...
# virtual methods
.method final synthetic a(Lcom/google/common/util/concurrent/SettableFuture;Lcom/google/common/util/concurrent/SettableFuture;Landroid/util/Size;Ltg;)Ljava/lang/Object;
    .locals 10

    .line 1
    :try_start_0
    iget-object v0, p0, Lmtf;->e:Landroid/hardware/camera2/CameraManager;

    iget-object v1, p0, Lmtf;->b:Ljava/lang/String;

    iget-object v2, p0, Lmtf;->f:Ljava/util/concurrent/Executor;

    new-instance v9, Lmtc;

    iget-object v8, p0, Lmtf;->f:Ljava/util/concurrent/Executor;
    ...
    .line 2
    invoke-direct/range {v3 .. v8}, Lmtc;-><init>(Ltg;Lcom/google/common/util/concurrent/SettableFuture;Lcom/google/common/util/concurrent/SettableFuture;Landroid/util/Size;Ljava/util/concurrent/Executor;)V
    ...
    .line 4
    invoke-virtual {p4, p3}, Ltg;->d(Ljava/lang/Throwable;)V
...
.method public final b()V
    ...
    .line 1
    iget-object v0, p0, Lmtf;->d:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-static {v0, v2}, Lmuc;->a(Lcom/google/common/util/concurrent/ListenableFuture;Ljava/util/concurrent/Executor;)V

    iput-object v1, p0, Lmtf;->d:Lcom/google/common/util/concurrent/ListenableFuture;

    :cond_0
    iget-object v0, p0, Lmtf;->c:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    iput-object v1, p0, Lmtf;->c:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final c()V
    ...
    iget-object v2, p0, Lmtf;->e:Landroid/hardware/camera2/CameraManager;
    ...
    iput-object v1, p0, Lmtf;->b:Ljava/lang/String;
    :try_end_0
