...
.method public final onDisconnected(Landroid/hardware/camera2/CameraDevice;)V
    ...
    .line 1
    iget-object v0, p0, Lual;->a:Luap;

    const-string v1, "Camera disconnected"

    invoke-virtual {v0, p1, v1}, Luap;->e(Landroid/hardware/camera2/CameraDevice;Ljava/lang/String;)V
...
.method public final onError(Landroid/hardware/camera2/CameraDevice;I)V
    ...
    .line 2
    invoke-virtual {v0, p1, p2}, Luap;->e(Landroid/hardware/camera2/CameraDevice;Ljava/lang/String;)V
...
.method public final onOpened(Landroid/hardware/camera2/CameraDevice;)V
    ...
    iput-object p1, v0, Luap;->h:Landroid/hardware/camera2/CameraDevice;

    iget-object p1, v0, Luap;->k:Ljava/util/concurrent/Semaphore;
    ...
    iget-object p1, p0, Lual;->a:Luap;

    iget-object p1, p1, Luap;->k:Ljava/util/concurrent/Semaphore;
    ...
    :try_start_0
    iget-object v3, p1, Luap;->b:Landroid/view/TextureView;
    ...
    iget-object v4, p1, Luap;->g:Landroid/util/Size;
    ...
    iget-object v5, p1, Luap;->g:Landroid/util/Size;
    ...
    iget-object v3, p1, Luap;->h:Landroid/hardware/camera2/CameraDevice;
    ...
    iput-object v3, p1, Luap;->e:Landroid/hardware/camera2/CaptureRequest$Builder;

    iget-object v3, p1, Luap;->e:Landroid/hardware/camera2/CaptureRequest$Builder;

    .line 8
    invoke-virtual {v3, v4}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V

    .line 9
    invoke-virtual {p1}, Luap;->a()Landroid/hardware/camera2/CameraCharacteristics;
    ...
    :cond_8
    sget-object v0, Luap;->a:Ljava/util/Comparator;
    ...
    iget-object v1, p1, Luap;->e:Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_a
    iget-object v0, p1, Luap;->h:Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-direct {v3, p1}, Luam;-><init>(Luap;)V
    ...
    iput-object v2, p1, Luap;->e:Landroid/hardware/camera2/CaptureRequest$Builder;
