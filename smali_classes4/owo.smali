...
# instance fields
.field public at:Landroid/widget/ListAdapter;
...
.method public J(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 1
    invoke-virtual {p0}, Lowo;->aK()Landroid/widget/ListAdapter;

    move-result-object p3

    iput-object p3, p0, Lowo;->at:Landroid/widget/ListAdapter;

    invoke-virtual {p0}, Lowo;->mU()I
    ...
    iget-object p3, p0, Lowo;->at:Landroid/widget/ListAdapter;

    .line 5
    invoke-virtual {p2, p3}, Landroid/widget/GridView;->setAdapter(Landroid/widget/ListAdapter;)V

    invoke-virtual {p0}, Lowo;->aM()Landroid/widget/AdapterView$OnItemClickListener;
    ...
    .line 11
    :goto_0
    invoke-virtual {p0}, Lowo;->aN()Ljava/lang/String;
...
.method protected abstract aK()Landroid/widget/ListAdapter;
.end method

.method protected abstract aM()Landroid/widget/AdapterView$OnItemClickListener;
.end method
...
.method public mr()V
    ...
    .line 3
    invoke-static {v1}, Lowo;->aT(Landroid/content/Context;)I
