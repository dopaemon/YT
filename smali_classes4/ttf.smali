...
.method static constructor <clinit>()V
    ...
    invoke-static {v1}, Lttf;->c([F)Ljava/nio/FloatBuffer;

    move-result-object v1

    sput-object v1, Lttf;->a:Ljava/nio/FloatBuffer;
    ...
    .line 2
    invoke-static {v0}, Lttf;->c([F)Ljava/nio/FloatBuffer;

    move-result-object v0

    sput-object v0, Lttf;->b:Ljava/nio/FloatBuffer;
...
.method public constructor <init>(Lusn;[B[B[B)V
    ...
    iput-object p3, p0, Lttf;->c:[F

    new-array p3, p2, [F

    iput-object p3, p0, Lttf;->d:[F

    new-array p3, p2, [F

    iput-object p3, p0, Lttf;->e:[F

    new-array p2, p2, [F

    iput-object p2, p0, Lttf;->f:[F

    iput-object p1, p0, Lttf;->i:Lusn;
...
.method public final declared-synchronized b(IIIII)V
    ...
    iget-object v6, v1, Lttf;->i:Lusn;

    const/4 v7, 0x0

    .line 8
    invoke-direct {v2, v6, v7, v7, v7}, Luus;-><init>(Lusn;[B[B[B)V

    iput-object v2, v1, Lttf;->h:Luus;
    ...
    iget-object v9, v1, Lttf;->c:[F

    .line 17
    invoke-static {v9, v5}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    iget-object v13, v1, Lttf;->d:[F

    const/4 v14, 0x0

    iget-object v15, v1, Lttf;->c:[F
    ...
    iget-object v6, v1, Lttf;->d:[F

    .line 21
    invoke-static {v6, v5, v12, v12, v11}, Landroid/opengl/Matrix;->translateM([FIFFF)V

    iget-object v6, v1, Lttf;->h:Luus;

    .line 22
    invoke-virtual {v6, v4, v0}, Luus;->a(II)V

    .line 23
    invoke-static {v4, v0}, Luus;->g(II)V

    iget-object v0, v1, Lttf;->h:Luus;

    const-string v4, "u_MVPMatrix"

    iget-object v6, v1, Lttf;->e:[F

    .line 24
    invoke-virtual {v0, v4, v6}, Luus;->f(Ljava/lang/String;[F)V
    ...
    sget-object v6, Lttf;->a:Ljava/nio/FloatBuffer;

    .line 26
    invoke-virtual {v0, v4, v6}, Luus;->c(Ljava/lang/String;Ljava/nio/FloatBuffer;)V

    iget-object v0, v1, Lttf;->h:Luus;

    const-string v4, "a_TextureCoord"

    sget-object v6, Lttf;->b:Ljava/nio/FloatBuffer;
    ...
    .line 35
    invoke-virtual {v0, v2}, Luus;->b(Ljava/lang/String;)V
