...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILtyn;ZZIJ)V
    .locals 2
    ...
    iput-object p1, p0, Ltzm;->l:Landroid/content/Context;

    iput-boolean p5, p0, Ltzm;->o:Z

    iput-boolean p6, p0, Ltzm;->g:Z

    iput-wide p8, p0, Ltzm;->q:J

    iput-object v0, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;

    iput-object p4, p0, Ltzm;->m:Ltyn;
    ...
    iput-object p1, p0, Ltzm;->n:Landroid/os/Handler;
    ...
    :cond_3
    iget-object p1, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;
...
.method final declared-synchronized b()I
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Ltzm;->f:Ltzx;

    if-eqz v0, :cond_2

    iget-boolean v1, v0, Ltzx;->o:Z
    :try_end_0
    ...
    :cond_0
    :try_start_1
    iget-object v0, v0, Ltzx;->b:Ltzj;

    invoke-virtual {v0}, Ltzj;->available()I
...
.method final declared-synchronized c()Landroid/util/Pair;
    ...
    iget-wide v2, v0, Ltzx;->f:J

    iget-wide v4, v0, Ltzx;->g:J
    ...
    :cond_1
    iget-wide v1, v0, Ltzx;->f:J

    iget-wide v3, v0, Ltzx;->g:J
...
.method public final declared-synchronized d()V
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;
    ...
    iget-object v3, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;
    ...
    .line 10
    invoke-direct {v0, v3}, Ltzs;-><init>(Ljava/nio/channels/SocketChannel;)V

    iput-object v0, p0, Ltzm;->e:Ltzs;

    iget-object v3, p0, Ltzm;->n:Landroid/os/Handler;

    iput-object p0, v0, Ltzs;->g:Ltzp;

    iput-object v3, v0, Ltzs;->h:Landroid/os/Handler;

    iget-boolean v0, p0, Ltzm;->o:Z

    const/4 v3, 0x0

    if-eqz v0, :cond_5

    iget-boolean v0, p0, Ltzm;->g:Z
    ...
    :goto_1
    iget-object v5, p0, Ltzm;->l:Landroid/content/Context;

    iget-object v6, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;

    iget-object v7, p0, Ltzm;->m:Ltyn;

    iget-boolean v8, p0, Ltzm;->g:Z

    iget-wide v9, p0, Ltzm;->q:J

    .line 11
    invoke-static {v5}, Ltzn;->a(Landroid/content/Context;)Ltzn;
    ...
    invoke-direct {v0, v13}, Ltzk;-><init>(Ltzj;)V
    ...
    .line 14
    invoke-direct/range {v4 .. v13}, Ltzx;-><init>(Landroid/content/Context;Ljava/nio/channels/SocketChannel;Ltyn;ZJLtzy;Ltzk;Ltzj;)V

    iput-object v0, p0, Ltzm;->f:Ltzx;

    iget-object v4, p0, Ltzm;->n:Landroid/os/Handler;

    iput-object p0, v0, Ltzx;->m:Ltzw;

    iput-object v4, v0, Ltzx;->n:Landroid/os/Handler;
    ...
    iget-object v4, v0, Ltzx;->a:Ljava/nio/ByteBuffer;
    ...
    .line 19
    invoke-virtual {v0, v4}, Ltzx;->g(Ljava/nio/ByteBuffer;)V

    const/16 v0, 0x5f8

    new-array v4, v0, [B

    iget-object v6, p0, Ltzm;->f:Ltzx;

    .line 20
    invoke-static {v2}, Labpc;->x(Z)V

    iget-object v7, v6, Ltzx;->a:Ljava/nio/ByteBuffer;
    ...
    .line 25
    invoke-virtual {v6, v7}, Ltzx;->g(Ljava/nio/ByteBuffer;)V

    new-instance v7, Ljava/util/Random;

    iget-object v8, v6, Ltzx;->d:Ltyn;

    .line 26
    invoke-interface {v8}, Ltyn;->g()J
    ...
    iget-object v7, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;
    ...
    iget-object v6, p0, Ltzm;->e:Ltzs;

    .line 37
    invoke-virtual {v6}, Ltzs;->a()B

    move-result v6

    if-ne v6, v5, :cond_11

    iget-object v5, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;
    ...
    iget-object v5, p0, Ltzm;->e:Ltzs;

    .line 45
    invoke-virtual {v5}, Ltzs;->d()I

    move-result v5

    iget-object v6, p0, Ltzm;->m:Ltyn;

    .line 46
    invoke-interface {v6}, Ltyn;->g()J
    ...
    .line 47
    invoke-virtual {v6, v5}, Ltzx;->h(I)V

    iget-object v5, p0, Ltzm;->f:Ltzx;

    long-to-int v6, v9

    .line 48
    invoke-virtual {v5, v6}, Ltzx;->h(I)V
    ...
    :cond_8
    iget-object v1, p0, Ltzm;->f:Ltzx;

    .line 52
    invoke-virtual {v1}, Ltzx;->a()V

    iget-object v1, p0, Ltzm;->a:Ljava/nio/channels/SocketChannel;
    ...
    iget-object v1, p0, Ltzm;->e:Ltzs;

    .line 60
    invoke-static {v2}, Labpc;->x(Z)V

    .line 61
    invoke-virtual {v1}, Ltzs;->d()I
    ...
    :cond_a
    iget-object v0, p0, Ltzm;->e:Ltzs;

    iget-object v1, v0, Ltzs;->k:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v4, v0, Ltzs;->b:Ljava/lang/Thread;
    ...
    .line 71
    :cond_b
    iput-boolean v3, v0, Ltzs;->c:Z

    new-instance v4, Ljava/lang/Thread;

    iget-object v5, v0, Ltzs;->l:Ljava/lang/Runnable;
    ...
    iput-object v4, v0, Ltzs;->b:Ljava/lang/Thread;

    iget-object v0, v0, Ltzs;->b:Ljava/lang/Thread;
    ...
    iget-object v1, v0, Ltzx;->r:Ljava/lang/Object;
    ...
    :try_start_4
    iget-object v4, v0, Ltzx;->k:Ljava/lang/Thread;
    ...
    :cond_c
    iget-boolean v4, v0, Ltzx;->o:Z

    if-eqz v4, :cond_d

    new-instance v4, Ltzv;

    .line 69
    invoke-direct {v4, v0}, Ltzv;-><init>(Ltzx;)V

    iput-object v4, v0, Ltzx;->k:Ljava/lang/Thread;
    ...
    iput-boolean v2, v0, Ltzx;->p:Z

    :cond_d
    iput-boolean v3, v0, Ltzx;->l:Z
...
.method public final declared-synchronized e()V
    ...
    :try_start_6
    iget-object v2, v0, Ltzs;->b:Ljava/lang/Thread;
    :try_end_6
    ...
    iput-object v3, v0, Ltzs;->b:Ljava/lang/Thread;
    ...
    :try_start_c
    iget-object v2, v0, Ltzx;->k:Ljava/lang/Thread;
    :try_end_c
    ...
    iput-object v3, v0, Ltzx;->k:Ljava/lang/Thread;
    ...
    .line 19
    :try_start_11
    iput-boolean v0, p0, Ltzm;->h:Z

    iput-boolean v0, p0, Ltzm;->i:Z
    :try_end_11
...
.method final declared-synchronized g(I)V
    ...
    invoke-virtual {v0, p1}, Ltzj;->b(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
