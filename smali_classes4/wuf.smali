...
.method public constructor <init>(Landroid/content/SharedPreferences;Lwqu;)V
    ...
    iput-object p1, p0, Lwuf;->a:Landroid/content/SharedPreferences;

    iput-object p2, p0, Lwuf;->b:Lwqu;
...
.method public final b(Ljava/util/Map;Lwsw;)V
    ...
    .line 4
    invoke-interface {p2}, Lwsw;->z()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p2}, Lwsw;->u()Ljava/lang/String;
    ...
    iget-object p2, p0, Lwuf;->a:Landroid/content/SharedPreferences;
