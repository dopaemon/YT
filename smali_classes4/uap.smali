...
.field private static final s:Llj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Luap;->a:Ljava/util/Comparator;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILandroid/view/TextureView;)V
    ...
    iput-object v0, p0, Luap;->k:Ljava/util/concurrent/Semaphore;
    ...
    invoke-direct {v0, p0, v2}, Luak;-><init>(Luap;I)V

    iput-object v0, p0, Luap;->q:Landroid/view/TextureView$SurfaceTextureListener;

    .line 3
    new-instance v0, Lual;

    invoke-direct {v0, p0}, Lual;-><init>(Luap;)V

    iput-object v0, p0, Luap;->r:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    iput-object p2, p0, Luap;->n:Ljava/lang/String;

    iput p3, p0, Luap;->o:I

    iput-object p4, p0, Luap;->b:Landroid/view/TextureView;
    ...
    iput-object p2, p0, Luap;->m:Landroid/hardware/camera2/CameraManager;
    ...
    new-instance p3, Luao;

    invoke-direct {p3, p0}, Luao;-><init>(Luap;)V

    iput-object p3, p0, Luap;->d:Luao;
    ...
    invoke-direct {p3, p0}, Lubm;-><init>(Luap;)V

    const/4 p4, 0x0

    invoke-direct {p2, p1, p3, p4}, Lubb;-><init>(Landroid/content/Context;Lubm;[B)V

    iput-object p2, p0, Luap;->c:Lubb;
...
.method public final a()Landroid/hardware/camera2/CameraCharacteristics;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Luap;->m:Landroid/hardware/camera2/CameraManager;
...
.method public final b()V
    ...
    .line 1
    iput-object v0, p0, Luap;->g:Landroid/util/Size;

    iget-object v1, p0, Luap;->b:Landroid/view/TextureView;

    invoke-virtual {v1, v0}, Landroid/view/TextureView;->setSurfaceTextureListener(Landroid/view/TextureView$SurfaceTextureListener;)V

    iget-object v0, p0, Luap;->c:Lubb;

    .line 2
    invoke-virtual {v0}, Lubb;->disable()V

    const/4 v0, 0x1

    .line 3
    invoke-virtual {p0, v0}, Luap;->c(Z)V

    const/4 v0, 0x0

    iput-boolean v0, p0, Luap;->j:Z

    iput-boolean v0, p0, Luap;->f:Z
...
.method public final c(Z)V
    ...
    .line 1
    :try_start_0
    iget-object v5, p0, Luap;->k:Ljava/util/concurrent/Semaphore;

    invoke-virtual {v5}, Ljava/util/concurrent/Semaphore;->acquire()V

    iget-object v5, p0, Luap;->i:Landroid/hardware/camera2/CameraCaptureSession;
    :try_end_0
    ...
    :goto_0
    :try_start_3
    iget-object p1, p0, Luap;->i:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    :cond_0
    :goto_1
    iget-object p1, p0, Luap;->h:Landroid/hardware/camera2/CameraDevice;
    ...
    :cond_1
    iput-object v4, p0, Luap;->i:Landroid/hardware/camera2/CameraCaptureSession;

    iput-object v4, p0, Luap;->h:Landroid/hardware/camera2/CameraDevice;

    iget-object p1, p0, Luap;->k:Ljava/util/concurrent/Semaphore;
    ...
    iget-object v0, p0, Luap;->k:Ljava/util/concurrent/Semaphore;
...
.method public final d(II)V
    ...
    .line 1
    iget-object v0, p0, Luap;->g:Landroid/util/Size;

    if-eqz v0, :cond_3

    iget-object v0, p0, Luap;->b:Landroid/view/TextureView;
    ...
    iget-object v3, p0, Luap;->g:Landroid/util/Size;
    ...
    iget-object v4, p0, Luap;->g:Landroid/util/Size;
    ...
    :cond_2
    iget-object p1, p0, Luap;->b:Landroid/view/TextureView;
...
.method public final e(Landroid/hardware/camera2/CameraDevice;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Luap;->h:Landroid/hardware/camera2/CameraDevice;

    .line 4
    invoke-virtual {p0, v1}, Luap;->c(Z)V

    iget-object p1, p0, Luap;->l:Lubm;
    ...
    invoke-virtual {p1, v0}, Lubm;->a(Ljava/lang/Exception;)V
...
.method public final f(II)V
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1, p2}, Luap;->d(II)V
    ...
    :try_start_0
    iget-object v1, p0, Luap;->k:Ljava/util/concurrent/Semaphore;
    ...
    iget-object v3, p0, Luap;->l:Lubm;

    if-eqz v3, :cond_1

    .line 6
    invoke-virtual {v3, v1}, Lubm;->a(Ljava/lang/Exception;)V
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Luap;->h:Landroid/hardware/camera2/CameraDevice;
    ...
    :cond_4
    iget-object v1, p0, Luap;->m:Landroid/hardware/camera2/CameraManager;

    iget-object v3, p0, Luap;->n:Ljava/lang/String;

    iget-object v4, p0, Luap;->r:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    iget-object v2, p0, Luap;->k:Ljava/util/concurrent/Semaphore;
    ...
    .line 15
    invoke-virtual {p1, v1}, Lubm;->a(Ljava/lang/Exception;)V
...
.method public final g(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Luap;->i:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iget-object p2, p0, Luap;->l:Lubm;

    if-eqz p2, :cond_0

    .line 3
    invoke-virtual {p2, p1}, Lubm;->a(Ljava/lang/Exception;)V
...
.method public final h()V
    ...
    iget-object v0, p0, Luap;->d:Luao;

    iget-object v1, v0, Luao;->c:Ljava/lang/Thread;

    if-eqz v1, :cond_1

    .line 2
    invoke-virtual {v0}, Luao;->a()V
    ...
    iput-object v1, v0, Luao;->c:Ljava/lang/Thread;
    ...
    iput-object v1, v0, Luao;->d:Ljava/lang/Thread$UncaughtExceptionHandler;

    iget-object v1, v0, Luao;->c:Ljava/lang/Thread;

    iget-object v0, v0, Luao;->a:Ljava/lang/Thread$UncaughtExceptionHandler;
    ...
    iget-object v1, p0, Luap;->q:Landroid/view/TextureView$SurfaceTextureListener;
    ...
    invoke-virtual {p0, v0, v1}, Luap;->f(II)V
    ...
    invoke-virtual {p0, v0, v1}, Luap;->d(II)V

    iget-object v0, p0, Luap;->c:Lubb;

    .line 11
    invoke-virtual {v0}, Lubb;->enable()V

    .line 12
    invoke-virtual {p0}, Luap;->i()V
...
.method public final i()V
    ...
    :cond_0
    iget-object v0, p0, Luap;->e:Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_1
    iget-object v1, p0, Luap;->i:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    invoke-direct {v1, p0, v0}, Luan;-><init>(Luap;Landroid/hardware/camera2/CaptureRequest;)V

    invoke-virtual {p0, v0, v1}, Luap;->g(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)V

    return-void
.end method

.method public final k(Lubm;)Z
    .locals 12
    ...
    invoke-virtual {p0}, Luap;->b()V

    .line 2
    :cond_0
    invoke-virtual {p0}, Luap;->a()Landroid/hardware/camera2/CameraCharacteristics;
    ...
    .line 3
    :goto_6
    iput-object v2, p0, Luap;->g:Landroid/util/Size;
    ...
    :cond_c
    iput-object p1, p0, Luap;->l:Lubm;

    const/4 p1, 0x1

    iput-boolean p1, p0, Luap;->f:Z
