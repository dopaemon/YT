...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lxip;->c:Landroid/content/Context;

    iput-object v0, p0, Lxip;->d:Ljava/lang/Object;

    return-void
.end method

.method private static i(Landroid/database/Cursor;)Lxik;
    .locals 17
    ...
    invoke-direct {v5, v6}, Lxer;-><init>([B)V
    ...
    invoke-direct {v6, v7}, Lxer;-><init>([B)V
    ...
    .line 21
    invoke-static {v5}, Lxim;->r(Lxdu;)Ljava/lang/String;
    ...
    invoke-direct/range {v11 .. v16}, Lxik;-><init>(Ljava/lang/String;Ljava/lang/String;ILxdu;I)V

    add-int/lit8 v5, v1, -0x1

    .line 22
    sget-object v7, Lakse;->a:Lakse;
    ...
    :goto_0
    iput-object v1, v0, Lxik;->j:Lakse;

    iput v2, v0, Lxik;->b:I

    iput-wide v8, v0, Lxik;->d:J

    iput-wide v3, v0, Lxik;->c:J

    iput-object v6, v0, Lxik;->f:Lxdu;
...
.method private static final k(Lxik;)Landroid/content/ContentValues;
    .locals 5
    ...
    .line 3
    iget-object v1, p0, Lxik;->j:Lakse;

    .line 4
    sget-object v2, Lakse;->a:Lakse;

    invoke-virtual {v1}, Lakse;->ordinal()I
    ...
    .line 8
    iget-object v1, p0, Lxik;->e:Lxdu;

    instance-of v2, v1, Lxer;
    ...
    .line 12
    :cond_5
    iget-object v1, p0, Lxik;->g:Ljava/lang/String;
...
.method public final a(Ljava/lang/String;)Labrk;
    ...
    .line 1
    iget-object v0, p0, Lxip;->a:Landroid/database/sqlite/SQLiteDatabase;

    if-nez v0, :cond_0

    invoke-static {}, Lxip;->j()V
    ...
    :cond_0
    iget-object v0, p0, Lxip;->d:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lxip;->a:Landroid/database/sqlite/SQLiteDatabase;

    sget-object v3, Lxip;->b:[Ljava/lang/String;
    ...
    .line 4
    invoke-static {p1}, Lxip;->i(Landroid/database/Cursor;)Lxik;
...
.method public final b(Lwqt;)Ljava/util/List;
    ...
    :cond_0
    iget-object v1, p0, Lxip;->d:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lxip;->a:Landroid/database/sqlite/SQLiteDatabase;

    sget-object v4, Lxip;->b:[Ljava/lang/String;
...
.method public final c(Lxik;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lxip;->f(Lxik;)V
...
.method public final d(Lxik;)V
    ...
    .line 1
    invoke-static {p1}, Lxip;->k(Lxik;)Landroid/content/ContentValues;
...
.method public final e()V
    ...
    iget-object v2, p0, Lxip;->c:Landroid/content/Context;

    .line 3
    invoke-direct {v1, v2}, Lxio;-><init>(Landroid/content/Context;)V

    .line 4
    invoke-virtual {v1}, Lxio;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v1

    iput-object v1, p0, Lxip;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method public final f(Lxik;)V
    ...
    invoke-virtual {p0, p1}, Lxip;->g(Ljava/lang/String;)V
