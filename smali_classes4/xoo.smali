...
.method public constructor <init>(Lxop;Lvxz;)V
    ...
    iput-object p1, p0, Lxoo;->c:Lxop;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lxoo;->a:Lvxz;
...
.method public final a()J
    ...
    .line 1
    iget-object v0, p0, Lxoo;->a:Lvxz;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lxoo;->b:[Lylh;

    if-nez v1, :cond_0

    iget-object v1, p0, Lxoo;->c:Lxop;

    invoke-static {v1}, Lxop;->a(Lxop;)J

    move-result-wide v1

    invoke-virtual {p0, v0, v1, v2}, Lxoo;->b(Lvxz;J)[Lylh;

    move-result-object v0

    iput-object v0, p0, Lxoo;->b:[Lylh;

    :cond_0
    iget-object v0, p0, Lxoo;->c:Lxop;

    invoke-static {v0}, Lxop;->a(Lxop;)J

    move-result-wide v0

    iget-wide v2, p0, Lxoo;->d:J
...
.method public final b(Lvxz;J)[Lylh;
    .locals 17
    ...
    .line 1
    invoke-static {v1, v2}, Lxop;->f(Lvxz;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 2
    invoke-static {v1, v3}, Lxop;->f(Lvxz;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 3
    invoke-static {v1, v4}, Lxop;->f(Lvxz;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 4
    invoke-static {v1, v5}, Lxop;->f(Lvxz;Ljava/lang/String;)Ljava/util/List;
    ...
    :try_start_1
    iget-wide v7, v0, Lxoo;->d:J

    add-long/2addr v7, v11

    iput-wide v7, v0, Lxoo;->d:J
    :try_end_1
    ...
    invoke-direct/range {v8 .. v15}, Lylh;-><init>(Ljava/lang/String;JJJ)V
