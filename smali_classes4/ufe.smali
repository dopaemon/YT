...
.field private final g:Lahkb;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Lzpv;Lsrw;Landroid/view/View;Landroid/widget/TextView;Landroid/support/v7/widget/SwitchCompat;Lahkb;)V
    .locals 1
    ...
    iput-object p1, p0, Lufe;->c:Landroid/app/Activity;

    .line 2
    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p3, p0, Lufe;->b:Lsrw;

    .line 3
    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p2, p0, Lufe;->a:Lzpv;

    .line 4
    invoke-virtual {p4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p4, p0, Lufe;->d:Landroid/view/View;

    .line 5
    invoke-virtual {p5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p5, p0, Lufe;->e:Landroid/widget/TextView;

    .line 6
    invoke-virtual {p6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p6, p0, Lufe;->f:Landroid/support/v7/widget/SwitchCompat;

    .line 7
    invoke-virtual {p7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p7, p0, Lufe;->g:Lahkb;

    .line 8
    invoke-virtual {p4, p0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-boolean p1, p7, Lahkb;->g:Z

    const/4 p2, 0x0

    .line 9
    invoke-direct {p0, p1, p2}, Lufe;->d(ZZ)V
    ...
    iget p1, p7, Lahkb;->b:I

    and-int/lit8 p1, p1, 0x2

    if-eqz p1, :cond_0

    iget-object p1, p7, Lahkb;->c:Lagca;
    ...
    .line 12
    invoke-static {p1, p3, p5}, Lssc;->a(Lagca;Lsrw;Z)Landroid/text/Spanned;
    ...
    iget-object p6, p5, Lssb;->c:Laezv;

    if-eqz p6, :cond_2

    .line 17
    sget-object p7, Lcom/google/protos/youtube/api/innertube/UrlEndpointOuterClass;->urlEndpoint:Ladpd;

    invoke-virtual {p6, p7}, Ladpa;->qr(Ladon;)Z
    ...
    iget-object p5, p5, Lssb;->c:Laezv;

    sget-object v0, Lcom/google/protos/youtube/api/innertube/UrlEndpointOuterClass;->urlEndpoint:Ladpd;

    .line 21
    invoke-virtual {p5, v0}, Ladpa;->qq(Ladon;)Ljava/lang/Object;

    move-result-object p5

    check-cast p5, Laldj;

    iget-object p5, p5, Laldj;->c:Ljava/lang/String;

    .line 22
    invoke-static {p5}, Lrlx;->am(Ljava/lang/String;)Landroid/net/Uri;
    ...
    :cond_4
    iget-object p2, p0, Lufe;->e:Landroid/widget/TextView;
...
.method private final d(ZZ)V
    ...
    .line 4
    iget-object v1, p0, Lufe;->g:Lahkb;

    iget v2, v1, Lahkb;->b:I

    and-int/lit8 v2, v2, 0x8

    if-eqz v2, :cond_2

    iget-object v2, p0, Lufe;->a:Lzpv;

    iget-object v1, v1, Lahkb;->e:Lagjl;
    ...
    iget-object v1, v1, Lahkb;->f:Lagjl;
    ...
    .line 6
    iget-object v3, p0, Lufe;->e:Landroid/widget/TextView;

    iget-object v4, p0, Lufe;->c:Landroid/app/Activity;
    ...
    :cond_6
    iget-object v1, p0, Lufe;->d:Landroid/view/View;
    ...
    iget-object p2, p0, Lufe;->d:Landroid/view/View;
    ...
    .line 14
    invoke-static {p2, v1, p1}, Lrzi;->c(Landroid/content/Context;Landroid/view/View;Ljava/lang/CharSequence;)V

    :cond_9
    iget-object p1, p0, Lufe;->g:Lahkb;

    iget p2, p1, Lahkb;->b:I

    and-int/lit8 p2, p2, 0x40

    if-eqz p2, :cond_b

    iget-object p1, p1, Lahkb;->h:Ladvo;
    ...
    :cond_a
    iget-object v2, p1, Ladvo;->c:Ladvn;
    ...
    iget p1, v2, Ladvn;->b:I

    and-int/lit8 p1, p1, 0x2

    if-eqz p1, :cond_c

    iget-object p1, v2, Ladvn;->c:Ljava/lang/String;
    ...
    iget-object p1, p1, Lahkb;->c:Lagca;
...
.method public final a(Landroid/widget/CompoundButton$OnCheckedChangeListener;)V
    ...
    .line 1
    iget-object v0, p0, Lufe;->f:Landroid/support/v7/widget/SwitchCompat;
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Lufe;->f:Landroid/support/v7/widget/SwitchCompat;
    ...
    invoke-direct {p0, p1, v0}, Lufe;->d(ZZ)V
