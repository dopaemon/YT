...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrwi;->h:[I

    new-array v0, v3, [I

    sput-object v0, Lrwi;->i:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lrwi;->j:Landroid/util/TypedValue;
...
.method public static e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lrwi;->h(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
...
.method public static f(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lrwi;->i(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V
...
.method public final a(IIIIII)Landroid/content/res/ColorStateList;
    ...
    iget-object v3, p0, Lrwi;->a:Landroid/content/Context;
    ...
    iget-object v4, p0, Lrwi;->j:Landroid/util/TypedValue;
    ...
    iget-object v3, p0, Lrwi;->j:Landroid/util/TypedValue;
    ...
    sget-object v3, Lrwi;->c:[I

    const/4 v4, 0x0

    aput-object v3, v1, v4

    invoke-static {p6, v2}, Lriy;->B(II)I

    move-result v2

    aput v2, v0, v4

    sget-object v2, Lrwi;->d:[I

    aput-object v2, v1, v6

    aput p1, v0, v6

    sget-object p1, Lrwi;->e:[I
...
.method public final b(Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2, v0}, Lrwi;->g(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
...
.method public final c(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lrwi;->d(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p1, p2, p3}, Lrwi;->i(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V
