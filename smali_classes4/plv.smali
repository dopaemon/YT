...
.method public constructor <init>(Ljava/nio/channels/FileChannel;Landroid/net/Uri;)V
    ...
    iput-object p2, p0, Lplv;->a:Landroid/net/Uri;

    iput-object p1, p0, Lplv;->b:Ljava/nio/channels/FileChannel;

    return-void
.end method

.method public static g(Landroid/content/Context;Landroid/net/Uri;)Lamtq;
    .locals 1
    ...
    invoke-direct {p0, v0, p1}, Lplv;-><init>(Ljava/nio/channels/FileChannel;Landroid/net/Uri;)V
    :try_end_0
...
.method public final a(Ljava/nio/ByteBuffer;)I
    ...
    .line 1
    iget-object v0, p0, Lplv;->b:Ljava/nio/channels/FileChannel;
...
.method public final e(JJ)Ljava/nio/ByteBuffer;
    ...
    iget-object p4, p0, Lplv;->b:Ljava/nio/channels/FileChannel;

    .line 3
    invoke-virtual {p4, p1, p2}, Ljava/nio/channels/FileChannel;->position(J)Ljava/nio/channels/FileChannel;

    iget-object p1, p0, Lplv;->b:Ljava/nio/channels/FileChannel;

    .line 4
    invoke-static {p1, p3}, Lamvr;->a(Ljava/nio/channels/ReadableByteChannel;Ljava/nio/ByteBuffer;)V
    :try_end_0
    ...
    :goto_0
    :try_start_1
    iget-object p2, p0, Lplv;->b:Ljava/nio/channels/FileChannel;
...
.method public final toString()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lplv;->a:Landroid/net/Uri;
