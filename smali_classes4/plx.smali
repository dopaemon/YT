...
.method public final c(Landroid/net/Uri;)I
    ...
    .line 1
    invoke-virtual {p0, v0, p1, v1}, Lplx;->d(Lpue;Landroid/net/Uri;I)I
...
.method public final d(Lpue;Landroid/net/Uri;I)I
    .locals 12

    const-string v0, "ContentUriUtils"

    .line 1
    iget-object v1, p0, Lplx;->b:Landroid/content/Context;
    ...
    invoke-static {p2}, Lozq;->a(Landroid/net/Uri;)Z

    move-result v3

    if-eqz v3, :cond_7

    sget-object v4, Lozq;->a:[Ljava/lang/String;
    ...
    :try_start_6
    iget-object v0, p0, Lplx;->a:Lpmf;

    .line 18
    invoke-interface {v0}, Lpmf;->a()Lpue;
    ...
    .line 19
    invoke-virtual {p1, v0, p2}, Lpue;->h(Landroid/content/Context;Landroid/net/Uri;)V
    :try_end_7
    ...
    .line 21
    invoke-virtual {p1, p3}, Lpue;->d(I)Landroid/media/MediaFormat;
