...
.method public constructor <init>(Ljava/util/Map;Z)V
    ...
    iput-object v0, p0, Lyoy;->a:Lorg/apache/http/params/HttpParams;

    .line 5
    invoke-static {}, Lyoy;->b()Lypd;

    move-result-object v0

    iput-object v0, p0, Lyoy;->c:Lypd;

    iput-boolean p2, p0, Lyoy;->d:Z
    ...
    iput-object v0, p0, Lyoy;->g:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    ...
    iget-object v1, p0, Lyoy;->g:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    ...
    iput-object p1, p0, Lyoy;->b:Lorg/apache/http/protocol/HttpService;

    iget-object p2, p0, Lyoy;->g:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
    ...
    iget-object p2, p0, Lyoy;->a:Lorg/apache/http/params/HttpParams;
...
# virtual methods
.method public final a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;JJ)Lanjt;
    .locals 1

    .line 1
    new-instance v0, Lanjt;

    invoke-direct {v0, p0, p1}, Lanjt;-><init>(Lyoy;Ljava/lang/String;)V

    const-string p1, "v"

    .line 2
    invoke-virtual {v0, p1, p2}, Lanjt;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2, p1}, Lanjt;->f(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "x"

    .line 4
    invoke-virtual {v0, p1, p4}, Lanjt;->f(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "l"

    .line 5
    invoke-virtual {v0, p1, p5, p6}, Lanjt;->g(Ljava/lang/String;J)V

    const-string p1, "m"

    .line 6
    invoke-virtual {v0, p1, p7, p8}, Lanjt;->g(Ljava/lang/String;J)V
