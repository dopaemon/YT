...
.field private volatile b:Lampr;

.field private volatile c:Lampr;

.field private volatile d:Lampr;
...
.method private onNetworkThreadReady()V
    ...
    .line 1
    invoke-static {}, Lampr;->S()Lampr;

    move-result-object v0

    iput-object v0, p0, Lorg/webrtc/PeerConnectionFactory;->b:Lampr;
...
.method private onSignalingThreadReady()V
    ...
    iput-object v0, p0, Lorg/webrtc/PeerConnectionFactory;->d:Lampr;
...
.method private onWorkerThreadReady()V
    ...
    iput-object v0, p0, Lorg/webrtc/PeerConnectionFactory;->c:Lampr;
