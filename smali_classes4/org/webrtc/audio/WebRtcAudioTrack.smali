...
.field public final g:Lvay;

.field private final h:Lapru;

.field private final i:Landroid/media/AudioAttributes;

.field private j:Lapsj;

.field private final k:Lapsg;
...
.method constructor <init>(Landroid/content/Context;Landroid/media/AudioManager;)V
    ...
    .line 1
    invoke-direct/range {v0 .. v7}, Lorg/webrtc/audio/WebRtcAudioTrack;-><init>(Landroid/content/Context;Landroid/media/AudioManager;Landroid/media/AudioAttributes;Lvay;[B[B[B)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroid/media/AudioManager;Landroid/media/AudioAttributes;Lvay;[B[B[B)V
    .locals 0

    .line 2
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    new-instance p5, Lapru;

    invoke-direct {p5}, Lapru;-><init>()V

    iput-object p5, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->h:Lapru;

    .line 3
    invoke-virtual {p5}, Lapru;->b()V
    ...
    iput-object p4, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->g:Lvay;

    new-instance p1, Lapsg;

    invoke-direct {p1, p2}, Lapsg;-><init>(Landroid/media/AudioManager;)V

    iput-object p1, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->k:Lapsg;
...
.method private final d(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->g:Lvay;
...
.method private final e(ILjava/lang/String;)V
    ...
    .line 1
    invoke-static {p1}, Lampr;->B(I)Ljava/lang/String;
...
.method private getStreamMaxVolume()I
    ...
    .line 1
    iget-object v0, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->h:Lapru;
...
.method private initPlayout(IID)I
    ...
    :try_start_0
    iget-object p4, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->i:Landroid/media/AudioAttributes;

    const-string v4, "createAudioTrackOnLollipopOrHigher"
    ...
    const-string v6, "nativeOutputSampleRate: "
    ...
    const-string v4, "Unable to use fast mode since requested sample rate is not native"
    ...
    .line 19
    :cond_2
    invoke-virtual {p4}, Landroid/media/AudioAttributes;->getContentType()I
    ...
    .line 21
    :cond_3
    invoke-virtual {p4}, Landroid/media/AudioAttributes;->getFlags()I
    ...
    .line 22
    invoke-virtual {p4}, Landroid/media/AudioAttributes;->getAllowedCapturePolicy()I

    move-result p4

    invoke-virtual {v5, p4}, Landroid/media/AudioAttributes$Builder;->setAllowedCapturePolicy(I)Landroid/media/AudioAttributes$Builder;
    ...
    iput-object v4, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->e:Landroid/media/AudioTrack;
    :try_end_0
    ...
    iput p1, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->l:I
    ...
    iget-object p2, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->e:Landroid/media/AudioTrack;
    ...
    .line 37
    invoke-virtual {p4}, Landroid/media/AudioTrack;->getSampleRate()I
...
.method private startPlayout()Z
    ...
    iget-object v0, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->k:Lapsg;
    ...
    iget-object v1, v0, Lapsg;->b:Ljava/lang/Object;
    ...
    .line 19
    :cond_1
    iget-object v1, v0, Lapsg;->a:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lapsg;->b:Ljava/lang/Object;

    iget-object v1, v0, Lapsg;->b:Ljava/lang/Object;

    new-instance v6, Lapsf;

    iget-object v2, v0, Lapsg;->a:Ljava/lang/Object;
    ...
    iget-object v5, v0, Lapsg;->a:Ljava/lang/Object;
    ...
    invoke-direct {v6, v0, v2, v5}, Lapsf;-><init>(Lapsg;II)V
    ...
    iget-object v0, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->j:Lapsj;
    ...
    .line 18
    invoke-direct {v0, p0}, Lapsj;-><init>(Lorg/webrtc/audio/WebRtcAudioTrack;)V

    iput-object v0, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->j:Lapsj;

    .line 19
    invoke-virtual {v0}, Lapsj;->start()V
...
.method private stopPlayout()Z
    ...
    iput-object v2, v0, Lapsg;->b:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->j:Lapsj;
    ...
    .line 9
    invoke-virtual {v1}, Lapsj;->interrupt()V
    ...
    .line 12
    invoke-static {v0, v1, v3}, Lampr;->A(Ljava/lang/String;Landroid/content/Context;Landroid/media/AudioManager;)V
    ...
    iput-object v2, p0, Lorg/webrtc/audio/WebRtcAudioTrack;->j:Lapsj;
