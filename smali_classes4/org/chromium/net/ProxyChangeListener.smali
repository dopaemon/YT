...
.method static synthetic access$100(Landroid/content/Intent;)Lapio;
    .locals 0

    .line 1
    invoke-static {p0}, Lorg/chromium/net/ProxyChangeListener;->extractNewProxy(Landroid/content/Intent;)Lapio;
...
.method static synthetic access$200(Lorg/chromium/net/ProxyChangeListener;Lapio;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lorg/chromium/net/ProxyChangeListener;->proxySettingsChanged(Lapio;)V
...
.method private static extractNewProxy(Landroid/content/Intent;)Lapio;
    .locals 1
    ...
    .line 3
    invoke-static {p0}, Lapio;->a(Landroid/net/ProxyInfo;)Lapio;
...
.method private getProxyConfig(Landroid/content/Intent;)Lapio;
    .locals 3
    ...
    .line 5
    invoke-static {p1}, Lorg/chromium/net/ProxyChangeListener;->extractNewProxy(Landroid/content/Intent;)Lapio;
    ...
    .line 4
    :cond_1
    invoke-static {v0}, Lapio;->a(Landroid/net/ProxyInfo;)Lapio;
...
.method private proxySettingsChanged(Lapio;)V
    .locals 8
    ...
    iget-object v4, p1, Lapio;->b:Ljava/lang/String;

    iget v5, p1, Lapio;->c:I

    iget-object v6, p1, Lapio;->d:Ljava/lang/String;

    iget-object v7, p1, Lapio;->e:[Ljava/lang/String;
...
.method private registerReceiver()V
    ...
    .line 5
    invoke-direct {v1, p0}, Lapin;-><init>(Lorg/chromium/net/ProxyChangeListener;)V
...
.method public synthetic lambda$updateProxyConfigFromConnectivityManager$0$org-chromium-net-ProxyChangeListener(Landroid/content/Intent;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lorg/chromium/net/ProxyChangeListener;->getProxyConfig(Landroid/content/Intent;)Lapio;
