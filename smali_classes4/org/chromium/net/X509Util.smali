...
.field private static sDefaultTrustManager:Lapiu;
...
.field private static sTestTrustManager:Lapiu;

.field private static sTrustStorageListener:Lapit;
...
.method private static createTrustManager(Ljava/security/KeyStore;)Lapiu;
    .locals 8
    ...
    invoke-direct {v5, v6}, Lapiv;-><init>(Ljavax/net/ssl/X509TrustManager;)V
    :try_end_1
    ...
    invoke-static {v0, v4, v5}, Laphj;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 12
    invoke-static {v0, v1, p0}, Laphj;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 5
    invoke-static {v0, p0, v2}, Laphj;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static ensureInitializedLocked()V
    ...
    :cond_0
    sget-object v0, Lorg/chromium/net/X509Util;->sDefaultTrustManager:Lapiu;
    ...
    .line 2
    invoke-static {v1}, Lorg/chromium/net/X509Util;->createTrustManager(Ljava/security/KeyStore;)Lapiu;

    move-result-object v0

    sput-object v0, Lorg/chromium/net/X509Util;->sDefaultTrustManager:Lapiu;
    ...
    :cond_4
    :goto_0
    sget-object v0, Lorg/chromium/net/X509Util;->sTestTrustManager:Lapiu;
    ...
    .line 10
    invoke-static {v0}, Lorg/chromium/net/X509Util;->createTrustManager(Ljava/security/KeyStore;)Lapiu;

    move-result-object v0

    sput-object v0, Lorg/chromium/net/X509Util;->sTestTrustManager:Lapiu;

    :cond_5
    sget-object v0, Lorg/chromium/net/X509Util;->sTrustStorageListener:Lapit;
    ...
    .line 11
    invoke-direct {v0}, Lapit;-><init>()V

    sput-object v0, Lorg/chromium/net/X509Util;->sTrustStorageListener:Lapit;
    ...
    sget-object v2, Lorg/chromium/net/X509Util;->sTrustStorageListener:Lapit;
...
.method private static isKnownRoot(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {v7, v5, v6}, Laphj;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static reloadDefaultTrustManager()V
    ...
    :try_start_0
    sput-object v1, Lorg/chromium/net/X509Util;->sDefaultTrustManager:Lapiu;
...
.method public static verifyServerCertificates([[BLjava/lang/String;Ljava/lang/String;)Lorg/chromium/net/AndroidCertVerifyResult;
    ...
    invoke-static {v5, v4, v6}, Laphj;->f(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :try_start_4
    sget-object v3, Lorg/chromium/net/X509Util;->sDefaultTrustManager:Lapiu;
    ...
    :cond_2
    :try_start_5
    invoke-interface {v3, p0, p1, p2}, Lapiu;->a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 24
    :try_start_6
    sget-object v4, Lorg/chromium/net/X509Util;->sTestTrustManager:Lapiu;

    .line 15
    invoke-interface {v4, p0, p1, p2}, Lapiu;->a([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 16
    invoke-static {p1, p0, p2}, Laphj;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
