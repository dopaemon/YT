...
.method public static synthetic access$100(Lorg/chromium/net/HttpNegotiateAuthenticator;Landroid/os/Bundle;Lapif;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lorg/chromium/net/HttpNegotiateAuthenticator;->processResult(Landroid/os/Bundle;Lapif;)V
...
.method private processResult(Landroid/os/Bundle;Lapif;)V
    .locals 4
...
.method private requestTokenWithActivity(Landroid/content/Context;Landroid/app/Activity;Lapif;[Ljava/lang/String;)V
    .locals 11
    ...
    .line 2
    invoke-static {p2, p4, p1}, Laphj;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 3
    iget-wide p1, p3, Lapif;->a:J
    ...
    .line 5
    :cond_0
    iget-object p1, p3, Lapif;->b:Ljava/lang/Object;

    iget-object v3, p0, Lorg/chromium/net/HttpNegotiateAuthenticator;->mAccountType:Ljava/lang/String;

    iget-object v0, p3, Lapif;->d:Ljava/lang/Object;

    iget-object v2, p3, Lapif;->c:Ljava/lang/Object;

    new-instance v9, Lapie;

    invoke-direct {v9, p0, p3, v1}, Lapie;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lapif;I)V
...
.method private requestTokenWithoutActivity(Landroid/content/Context;Lapif;[Ljava/lang/String;)V
    .locals 3
    ...
    .line 2
    invoke-static {p3, v0, p1}, Laphj;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 3
    iget-wide p1, p2, Lapif;->a:J
    ...
    .line 5
    :cond_0
    iget-object p1, p2, Lapif;->b:Ljava/lang/Object;

    iget-object v0, p0, Lorg/chromium/net/HttpNegotiateAuthenticator;->mAccountType:Ljava/lang/String;

    new-instance v2, Lapie;

    invoke-direct {v2, p0, p2, v1}, Lapie;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lapif;I)V
...
.method getNextAuthToken(JLjava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-object p3, v1, Lapif;->d:Ljava/lang/Object;

    invoke-static {v0}, Landroid/accounts/AccountManager;->get(Landroid/content/Context;)Landroid/accounts/AccountManager;

    move-result-object p3

    iput-object p3, v1, Lapif;->b:Ljava/lang/Object;

    iput-wide p1, v1, Lapif;->a:J
    ...
    iput-object p2, v1, Lapif;->c:Ljava/lang/Object;

    if-eqz p4, :cond_0

    iget-object p2, v1, Lapif;->c:Ljava/lang/Object;
    ...
    iget-object p3, v1, Lapif;->c:Ljava/lang/Object;
    ...
    .line 7
    invoke-direct {p0, v0, v1, p1}, Lorg/chromium/net/HttpNegotiateAuthenticator;->requestTokenWithoutActivity(Landroid/content/Context;Lapif;[Ljava/lang/String;)V
