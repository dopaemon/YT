...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lyvl;-><init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lyeu;->a:Landroid/util/SparseArray;
    ...
    iput-object v1, p0, Lyeu;->b:Landroid/util/SparseArray;
    ...
    iput-object p1, p0, Lyeu;->g:Lcom/google/android/libraries/youtube/player/subtitles/model/SubtitlesStyle;

    .line 11
    invoke-virtual {p0}, Lyeu;->e()V
...
.method private final j(Lcom/google/android/libraries/youtube/player/subtitles/ui/SubtitleWindowView;)V
    ...
    iget-object v1, p1, Lcom/google/android/libraries/youtube/player/subtitles/ui/SubtitleWindowView;->b:Lyuy;

    .line 2
    invoke-virtual {v1, v0}, Lyuy;->f(F)V
    ...
    .line 4
    invoke-virtual {v2, v0}, Lyuy;->f(F)V
    ...
    :cond_1
    :goto_1
    iget-object v0, p0, Lyeu;->g:Lcom/google/android/libraries/youtube/player/subtitles/model/SubtitlesStyle;
    ...
    .line 6
    invoke-virtual {v2, v0}, Lyuy;->setBackgroundColor(I)V
    ...
    .line 10
    invoke-virtual {v2, v0}, Lyuy;->e(I)V
    ...
    .line 12
    :goto_5
    invoke-virtual {p0}, Lyeu;->getContext()Landroid/content/Context;

    move-result-object v0

    iget-object v1, p0, Lyeu;->g:Lcom/google/android/libraries/youtube/player/subtitles/model/SubtitlesStyle;

    .line 13
    invoke-static {v0, v1}, Lyvd;->a(Landroid/content/Context;Lcom/google/android/libraries/youtube/player/subtitles/model/SubtitlesStyle;)Landroid/graphics/Typeface;
    ...
    .line 15
    invoke-virtual {v1, v0}, Lyuy;->g(Landroid/graphics/Typeface;)V
    ...
    .line 17
    invoke-virtual {v2, v0}, Lyuy;->g(Landroid/graphics/Typeface;)V
    ...
    .line 19
    invoke-virtual {v2, v0}, Lyuy;->b(I)V
    ...
    .line 21
    :goto_9
    invoke-virtual {p0}, Lyeu;->getResources()Landroid/content/res/Resources;
    ...
    .line 23
    invoke-virtual {v1, v0}, Lyuy;->c(I)V
    ...
    .line 25
    invoke-virtual {v2, v0}, Lyuy;->c(I)V
...
.method private final k(II)V
    ...
    :goto_0
    iget-object p2, p0, Lyeu;->b:Landroid/util/SparseArray;
    ...
    .line 7
    invoke-direct {p0, p2}, Lyeu;->j(Lcom/google/android/libraries/youtube/player/subtitles/ui/SubtitleWindowView;)V
...
.method public final c()V
    ...
    .line 1
    invoke-virtual {p0}, Lyeu;->removeAllViews()V

    iget-object v0, p0, Lyeu;->a:Landroid/util/SparseArray;

    .line 2
    invoke-virtual {v0}, Landroid/util/SparseArray;->clear()V

    iget-object v0, p0, Lyeu;->b:Landroid/util/SparseArray;
...
.method public final e()V
    ...
    .line 1
    invoke-virtual {p0, v0}, Lyeu;->setVisibility(I)V
...
.method public final f(F)V
    ...
    invoke-virtual {p0}, Lyeu;->getWidth()I

    move-result p1

    invoke-virtual {p0}, Lyeu;->getHeight()I

    move-result v0

    invoke-direct {p0, p1, v0}, Lyeu;->k(II)V
...
.method public final i(Ljava/util/List;)V
    ...
    :goto_0
    iget-object v3, p0, Lyeu;->a:Landroid/util/SparseArray;
    ...
    iget-object v4, p0, Lyeu;->b:Landroid/util/SparseArray;
    ...
    .line 9
    :cond_1
    iget-object v5, p0, Lyeu;->a:Landroid/util/SparseArray;
    ...
    .line 13
    invoke-direct {p0, v5}, Lyeu;->j(Lcom/google/android/libraries/youtube/player/subtitles/ui/SubtitleWindowView;)V
    ...
    .line 16
    invoke-virtual {p0, v5}, Lyeu;->addView(Landroid/view/View;)V
    ...
    iget-object v2, p0, Lyeu;->b:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v2}, Lyeu;->removeView(Landroid/view/View;)V

    iget-object v2, p0, Lyeu;->a:Landroid/util/SparseArray;
    ...
    .line 26
    :cond_7
    invoke-virtual {p0, v1}, Lyeu;->setVisibility(I)V
...
.method protected final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lyvl;->onConfigurationChanged(Landroid/content/res/Configuration;)V

    .line 2
    invoke-virtual {p0}, Lyeu;->requestLayout()V
...
.method protected final onLayout(ZIIII)V
    ...
    :goto_0
    iget-object v1, p0, Lyeu;->a:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, Lyeu;->b:Landroid/util/SparseArray;
...
.method protected final onMeasure(II)V
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Lyeu;->setMeasuredDimension(II)V

    .line 4
    invoke-direct {p0, p1, p2}, Lyeu;->k(II)V
