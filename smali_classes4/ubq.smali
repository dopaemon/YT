...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lpsy;Lzhe;)V
    .locals 5
    ...
    iput-object v0, p0, Lubq;->k:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lubq;->l:Landroid/graphics/Point;
    ...
    invoke-direct {v0, p0}, Lubm;-><init>(Lubq;)V

    iput-object v0, p0, Lubq;->v:Lubm;

    iput-object p1, p0, Lubq;->f:Landroid/content/Context;

    iput-object p3, p0, Lubq;->B:Lzhe;
    ...
    iput-object v0, p0, Lubq;->g:Landroid/view/WindowManager;
    ...
    iput-object v0, p0, Lubq;->a:Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Lubq;->b:Landroid/view/TextureView;
    ...
    iput-object v2, p0, Lubq;->c:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, Lubq;->A:Lcom/google/android/libraries/youtube/livecreation/screencast/controls/VolumeIndicatorView;
    ...
    iput-object v4, p0, Lubq;->d:Landroid/view/View;
    ...
    iput-object v4, p0, Lubq;->e:Landroid/view/View;

    .line 16
    invoke-static {v3}, Lubq;->n(Landroid/view/View;)V

    .line 17
    invoke-static {v1}, Lubq;->n(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lubq;->z:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lubq;->w:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lubq;->x:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lubq;->y:Landroid/graphics/drawable/Drawable;

    .line 22
    invoke-virtual {v2, v0}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    .line 23
    invoke-interface {p2}, Lpsy;->a()Lpsw;

    move-result-object p2

    if-eqz p2, :cond_0

    iget-object v0, p2, Lpsw;->e:Lsvq;
    ...
    .line 25
    invoke-static {p2}, Lxnz;->D(Lakpa;)Landroid/net/Uri;
    ...
    invoke-direct {v0, p1, v2, v1}, Lfpl;-><init>(Landroid/content/res/Resources;Landroid/widget/ImageView;I)V

    .line 26
    invoke-interface {p3, p2, v0}, Lzhe;->l(Landroid/net/Uri;Lrjq;)V
...
.method public final a()V
    ...
    .line 1
    iget-object v0, p0, Lubq;->A:Lcom/google/android/libraries/youtube/livecreation/screencast/controls/VolumeIndicatorView;
...
.method public final b()V
    ...
    :cond_1
    iget-object v0, p0, Lubq;->s:Lubp;

    .line 2
    invoke-virtual {v0}, Lubp;->a()V

    const/4 v0, 0x0

    .line 3
    invoke-virtual {p0, v0}, Lubq;->g(Z)V

    iget-boolean v2, p0, Lubq;->C:Z

    iget-object v3, p0, Lubq;->A:Lcom/google/android/libraries/youtube/livecreation/screencast/controls/VolumeIndicatorView;
    ...
    .line 8
    :goto_0
    iget-object v0, p0, Lubq;->d:Landroid/view/View;
...
.method public final d()V
    ...
    .line 1
    iget-object v0, p0, Lubq;->t:Luap;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Luap;->l()V

    iget-object v0, p0, Lubq;->t:Luap;

    .line 2
    invoke-virtual {v0}, Luap;->b()V

    iput-object v1, p0, Lubq;->t:Luap;

    :cond_0
    iput-object v1, p0, Lubq;->s:Lubp;
    ...
    iget-object v0, p0, Lubq;->m:Landroid/widget/FrameLayout;
    ...
    iget-object v0, p0, Lubq;->g:Landroid/view/WindowManager;

    iget-object v1, p0, Lubq;->m:Landroid/widget/FrameLayout;
...
.method public final e(ZLjava/lang/Runnable;)V
    ...
    iget-object v0, v0, Luap;->k:Ljava/util/concurrent/Semaphore;
    ...
    invoke-virtual {p0}, Lubq;->k()Z

    move-result p1

    if-eqz p1, :cond_7

    iget-object p1, p0, Lubq;->b:Landroid/view/TextureView;
    ...
    .line 19
    :cond_2
    iget-object p1, p0, Lubq;->c:Landroid/widget/ImageView;

    .line 15
    invoke-virtual {p1, v1}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object p1, p0, Lubq;->e:Landroid/view/View;

    .line 16
    invoke-virtual {p1, v0}, Landroid/view/View;->setVisibility(I)V

    iget-object p1, p0, Lubq;->t:Luap;

    if-eqz p1, :cond_7

    iget-object v0, p0, Lubq;->v:Lubm;

    .line 17
    invoke-virtual {p1, v0}, Luap;->k(Lubm;)Z
    ...
    .line 13
    :cond_4
    iget-object v2, p1, Luap;->d:Luao;

    .line 4
    invoke-virtual {v2}, Luao;->a()V

    iget-object v2, p1, Luap;->c:Lubb;

    .line 5
    invoke-virtual {v2}, Lubb;->disable()V

    iput-boolean v0, p1, Luap;->j:Z

    iget-object v2, p1, Luap;->i:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    .line 8
    invoke-virtual {p1, v2}, Lubm;->a(Ljava/lang/Exception;)V
    ...
    .line 9
    invoke-virtual {p1}, Luap;->b()V

    iget-object p1, p0, Lubq;->t:Luap;

    .line 10
    invoke-virtual {p1}, Luap;->l()V
...
.method public final f(Z)V
    ...
    iget-object p1, p0, Lubq;->A:Lcom/google/android/libraries/youtube/livecreation/screencast/controls/VolumeIndicatorView;
...
.method public final g(Z)V
    ...
    .line 1
    iget-object v0, p0, Lubq;->z:Landroid/widget/ImageView;

    if-eqz p1, :cond_0

    iget-object p1, p0, Lubq;->w:Landroid/graphics/drawable/Drawable;

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lubq;->x:Landroid/graphics/drawable/Drawable;
...
.method public final h(I)V
    ...
    invoke-virtual {p0}, Lubq;->j()V

    .line 2
    invoke-virtual {p0}, Lubq;->m()V
...
.method public final j()V
    ...
    iget-object v1, p0, Lubq;->l:Landroid/graphics/Point;

    iget-object v2, p0, Lubq;->f:Landroid/content/Context;
    ...
    iget-object v3, p0, Lubq;->f:Landroid/content/Context;
...
.method public final k()Z
    ...
    iget-object v0, p0, Lubq;->q:Ljava/lang/String;
...
.method public final m()V
    ...
    .line 1
    iget-object v0, p0, Lubq;->a:Landroid/view/ViewGroup;
    ...
    iget-object v5, p0, Lubq;->l:Landroid/graphics/Point;

    .line 6
    iget v5, v5, Landroid/graphics/Point;->x:I

    iget-object v6, p0, Lubq;->l:Landroid/graphics/Point;
    ...
    iget-object v5, p0, Lubq;->a:Landroid/view/ViewGroup;
    ...
    iget-object v6, p0, Lubq;->m:Landroid/widget/FrameLayout;
    ...
    :cond_9
    iget-object v5, p0, Lubq;->g:Landroid/view/WindowManager;

    iget-object v7, p0, Lubq;->m:Landroid/widget/FrameLayout;
    ...
    :cond_c
    :goto_4
    iget-object v1, p0, Lubq;->g:Landroid/view/WindowManager;

    iget-object v2, p0, Lubq;->a:Landroid/view/ViewGroup;

    .line 32
    invoke-interface {v1, v2, v0}, Landroid/view/WindowManager;->updateViewLayout(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v1, p0, Lubq;->k:Landroid/graphics/Rect;
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    :cond_0
    iget-object p1, p0, Lubq;->s:Lubp;

    if-eqz p1, :cond_1

    .line 2
    invoke-virtual {p1}, Lubp;->a()V

    :cond_1
    iget-object p1, p0, Lubq;->a:Landroid/view/ViewGroup;
