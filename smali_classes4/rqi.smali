...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrqi;->a:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lrlw;Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Ljava/util/concurrent/ExecutorService;)V
    .locals 1

    .line 1
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lrqi;->b:Landroid/content/Context;

    invoke-virtual {p1}, Lrlw;->a()Laezp;

    move-result-object p2

    iget-object p2, p2, Laezp;->d:Laefg;

    if-nez p2, :cond_0

    .line 2
    sget-object p2, Laefg;->a:Laefg;

    :cond_0
    iget p2, p2, Laefg;->g:I

    invoke-static {p2}, Labpc;->bP(I)I
    ...
    .line 3
    invoke-virtual {p1}, Lrlw;->d()Laikp;

    move-result-object p1

    iget-boolean p1, p1, Laikp;->i:Z
    ...
    .line 4
    invoke-direct {p1, p4}, Lrqh;-><init>(Ljava/util/concurrent/ExecutorService;)V

    iput-object p1, p0, Lrqi;->c:Lrqh;
    ...
    .line 5
    invoke-direct {p1, p3}, Lrqh;-><init>(Ljava/util/concurrent/ExecutorService;)V
...
.method private final declared-synchronized c()V
    ...
    .line 1
    :try_start_0
    sget-object v0, Lrqi;->a:Ljava/util/List;
    ...
    iget-object v5, p0, Lrqi;->c:Lrqh;

    iget-object v6, p0, Lrqi;->b:Landroid/content/Context;

    .line 2
    invoke-virtual {v5, v6}, Lrqh;->c(Landroid/content/Context;)V
    ...
    .line 12
    invoke-static {v6, v5, v7}, Lrqi;->b(Lorg/chromium/net/CronetProvider;Lorg/chromium/net/CronetProvider;Lorg/chromium/net/CronetProvider;)Ljava/util/List;
    ...
    .line 10
    invoke-static {v5, v6, v7}, Lrqi;->b(Lorg/chromium/net/CronetProvider;Lorg/chromium/net/CronetProvider;Lorg/chromium/net/CronetProvider;)Ljava/util/List;
...
# virtual methods
.method public final a(Lrjx;)Lorg/chromium/net/CronetEngine;
    .locals 8
    ...
    iget-object v1, p0, Lrqi;->c:Lrqh;

    .line 3
    invoke-virtual {v1}, Lrqh;->d()Z
    ...
    iget-object v2, p0, Lrqi;->b:Landroid/content/Context;
    ...
    invoke-interface {p1, v1, v2}, Lrjx;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lrqi;->c:Lrqh;

    .line 7
    invoke-virtual {v2}, Lrqh;->d()Z
    ...
    .line 10
    invoke-interface {p1, v2, v1}, Lrjx;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
