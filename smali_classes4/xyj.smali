...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lxyj;->b:Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;

    return-void
.end method

.method static a(Landroid/content/Context;Lrtg;)Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;
    .locals 1

    .line 1
    invoke-static {p0}, Lxyl;->b(Landroid/content/Context;)Z
    ...
    .line 3
    sget-object p0, Lxyj;->b:Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;
...
.method static b(Landroid/content/Context;Lrtg;)Ljava/util/List;
    .locals 2
    ...
    sget-object v1, Lxyj;->b:Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;

    .line 3
    invoke-static {p0, p1}, Lxyj;->a(Landroid/content/Context;Lrtg;)Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;
...
.method static e(Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;)I
    ...
    .line 1
    :cond_0
    sget-object v0, Lxyj;->b:Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;
...
.method static f(Landroid/content/Context;Lrtg;Lcom/google/vr/sdk/base/HeadsetSelector$HeadsetInfo;)V
    .locals 1
    ...
    sget-object p0, Lxob;->m:Lxob;

    .line 5
    invoke-interface {p1, p0}, Lrtg;->b(Labra;)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object p0

    sget-object p1, Lxie;->e:Lxie;

    .line 6
    invoke-static {p0, p1}, Lrll;->m(Lcom/google/common/util/concurrent/ListenableFuture;Lrlj;)V

    return-void

    :cond_0
    sget-object v0, Lxob;->n:Lxob;
