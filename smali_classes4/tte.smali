...
.method public constructor <init>(DZ)V
    ...
    invoke-direct {v0, v1}, Lttc;-><init>(I)V
    ...
    iput-object v0, p0, Ltte;->g:Ljava/util/concurrent/ExecutorService;

    iput-wide p1, p0, Ltte;->h:D

    iput-boolean p3, p0, Ltte;->i:Z
...
.method private final declared-synchronized o(I)Landroid/hardware/Camera;
    ...
    .line 5
    invoke-direct {v0, p1}, Lttb;-><init>(Ljava/lang/Throwable;)V
    ...
    .line 6
    invoke-direct {p1, v2}, Lttb;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, v0}, Lttb;-><init>(Ljava/lang/Throwable;)V
...
.method private final p()V
    ...
    :try_start_0
    iget-object v0, p0, Ltte;->l:Landroid/hardware/Camera;

    const/4 v1, 0x0

    iput-object v1, p0, Ltte;->l:Landroid/hardware/Camera;
...
.method final d(I)Ljava/util/concurrent/Future;
    ...
    iget-object p1, p0, Ltte;->g:Ljava/util/concurrent/ExecutorService;
...
.method public final declared-synchronized e()V
    ...
    invoke-virtual {p0, v0}, Ltte;->d(I)Ljava/util/concurrent/Future;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized h(I)V
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1}, Ltte;->d(I)Ljava/util/concurrent/Future;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized i(Landroid/graphics/SurfaceTexture;)V
    ...
    .line 1
    :try_start_0
    iput-object p1, p0, Ltte;->m:Landroid/graphics/SurfaceTexture;

    iput-object p1, p0, Ltte;->n:Landroid/graphics/SurfaceTexture;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Ltte;->m:Landroid/graphics/SurfaceTexture;
...
.method public final declared-synchronized j()V
    ...
    .line 5
    :cond_1
    invoke-virtual {p0, v1}, Ltte;->d(I)Ljava/util/concurrent/Future;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized l(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Ltte;->k(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Ltte;->l:Landroid/hardware/Camera;
...
.method public final declared-synchronized n(FFILvay;)V
    .locals 8
    ...
    :try_start_2
    iget-object v1, p0, Ltte;->l:Landroid/hardware/Camera;
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p3, v1}, Ltte;->c(FFIF)Landroid/graphics/Rect;
    ...
    .line 14
    :try_start_3
    iget-object p3, p4, Lvay;->a:Ljava/lang/Object;
    ...
    .line 15
    invoke-virtual {p4}, Ludw;->rm()Landroid/content/Context;
    ...
    .line 15
    invoke-virtual {v1}, Ludw;->rm()Landroid/content/Context;
    ...
    iget-object v2, v2, Ludw;->as:Landroid/widget/ImageView;
    ...
    iget-object v2, v2, Ludw;->at:Landroid/widget/ImageView;
    ...
    iget-object v5, v5, Ludw;->at:Landroid/widget/ImageView;
    ...
    iget-object p1, p3, Ludw;->as:Landroid/widget/ImageView;
    ...
    .line 27
    invoke-static {v2, p1, p2}, Lriy;->aq(Landroid/view/View;Lsbb;Ljava/lang/Class;)V
...
.method public final run()V
    ...
    .line 1
    iget-object v0, v1, Ltte;->n:Landroid/graphics/SurfaceTexture;

    if-eqz v0, :cond_1

    iget-object v2, v1, Ltte;->m:Landroid/graphics/SurfaceTexture;

    if-eq v0, v2, :cond_1

    iget-object v0, v1, Ltte;->l:Landroid/hardware/Camera;

    if-eqz v0, :cond_0

    iget-boolean v2, v1, Ltte;->o:Z
    ...
    iget-object v2, v1, Ltte;->n:Landroid/graphics/SurfaceTexture;
    ...
    iput-object v0, v1, Ltte;->m:Landroid/graphics/SurfaceTexture;

    const/4 v0, 0x0

    iput-object v0, v1, Ltte;->n:Landroid/graphics/SurfaceTexture;
    ...
    .line 4
    :cond_2
    invoke-direct/range {p0 .. p0}, Ltte;->p()V
    ...
    .line 5
    :try_start_2
    invoke-direct {v1, v0}, Ltte;->o(I)Landroid/hardware/Camera;

    move-result-object v3

    iput-object v3, v1, Ltte;->l:Landroid/hardware/Camera;
    ...
    iput-boolean v4, v1, Ltte;->b:Z

    iget-object v4, v1, Ltte;->l:Landroid/hardware/Camera;
    ...
    :goto_1
    iget-object v7, v1, Ltte;->l:Landroid/hardware/Camera;
    ...
    invoke-direct {v2, v8, v6}, Ltsy;-><init>(II)V
    ...
    invoke-direct {v10, v8, v5}, Ltsy;-><init>(II)V
    ...
    .line 41
    invoke-static {v7}, Ltte;->g(Landroid/hardware/Camera$Parameters;)V

    .line 42
    invoke-virtual {v7, v6}, Landroid/hardware/Camera$Parameters;->setRecordingHint(Z)V

    iget-boolean v2, v1, Ltte;->i:Z

    if-eqz v2, :cond_d

    .line 43
    invoke-static {v7}, Ltte;->q(Landroid/hardware/Camera$Parameters;)Z
    ...
    :cond_d
    iget-object v2, v1, Ltte;->l:Landroid/hardware/Camera;
    ...
    const-class v7, Lahwg;

    .line 49
    invoke-virtual {v5, v7}, Ltvy;->a(Ljava/lang/Class;)Ltvx;

    move-result-object v7

    .line 50
    iget-boolean v9, v7, Ltvx;->e:Z
    ...
    .line 73
    :cond_f
    iget-boolean v9, v5, Ltvy;->c:Z

    if-eqz v9, :cond_12

    const-class v9, Lahwg;

    .line 49
    invoke-virtual {v5, v7}, Ltvy;->d(Ltvx;)Lahwk;

    move-result-object v7

    .line 51
    invoke-static {v9, v7}, Ltvy;->e(Ljava/lang/Class;Lahwk;)Ljava/lang/Object;
    ...
    .line 56
    check-cast v10, Lahwf;

    const/4 v11, -0x1

    add-int/2addr v2, v11

    iput v2, v10, Lahwf;->c:I

    iget v2, v10, Lahwf;->b:I

    or-int/2addr v2, v6

    iput v2, v10, Lahwf;->b:I
    ...
    iget v10, v2, Lahwf;->b:I

    or-int/2addr v8, v10

    iput v8, v2, Lahwf;->b:I

    iput-boolean v3, v2, Lahwf;->d:Z
    ...
    iget-object v3, v7, Lahwe;->instance:Ladpf;

    .line 61
    check-cast v3, Lahwg;

    sget-object v8, Lahwg;->a:Lahwg;

    .line 62
    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v8, v3, Lahwg;->f:Ladpr;
    ...
    iput-object v8, v3, Lahwg;->f:Ladpr;

    :cond_11
    iget-object v3, v3, Lahwg;->f:Ladpr;

    .line 65
    invoke-interface {v3, v2}, Ladpr;->add(Ljava/lang/Object;)Z

    .line 49
    invoke-virtual {v5, v7}, Ltvy;->i(Ljava/lang/Object;)V
    ...
    .line 69
    iget-object v3, v1, Ltte;->l:Landroid/hardware/Camera;
    ...
    iput-boolean v6, v1, Ltte;->o:Z

    iput v0, v1, Ltte;->j:I

    iget-object v0, v1, Ltte;->e:Ltta;

    if-eqz v0, :cond_16

    .line 73
    invoke-interface {v0, v4}, Ltta;->a(Z)V
    :try_end_6
