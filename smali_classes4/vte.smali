...
# direct methods
.method public constructor <init>(Lusn;[B)V
    .locals 3

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-object p2, p1, Lusn;->b:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lvte;->b:Ljavax/crypto/spec/SecretKeySpec;
    ...
    iput-object p1, p0, Lvte;->c:Ljavax/crypto/spec/SecretKeySpec;
...
# virtual methods
.method public final a([B)Lvtf;
    .locals 4

    .line 1
    array-length v0, p1

    invoke-static {v0}, Ladnz;->u(I)Ladny;
    ...
    .line 5
    invoke-virtual {v0}, Ladny;->b()Ladnz;
    ...
    .line 7
    invoke-static {v0}, Lvte;->b(Ljava/io/Closeable;)V

    .line 8
    invoke-static {v2}, Lvte;->b(Ljava/io/Closeable;)V
    ...
    iget-object v2, p0, Lvte;->b:Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-object v2, p0, Lvte;->c:Ljavax/crypto/spec/SecretKeySpec;
    ...
    invoke-direct {v3, p1, v0, v1, v2}, Lvtf;-><init>(Ladnz;Ladnz;Ladnz;Ladnz;)V
    :try_end_2
    ...
    .line 21
    invoke-direct {v0, p1}, Lvtg;-><init>(Ljava/lang/Exception;)V
    ...
    .line 6
    invoke-direct {v2, p1}, Lvtg;-><init>(Ljava/lang/Exception;)V
    ...
    .line 8
    invoke-static {v1}, Lvte;->b(Ljava/io/Closeable;)V
...
.method public final c([B[B[BI)[B
    ...
    iget-object v1, p0, Lvte;->c:Ljavax/crypto/spec/SecretKeySpec;
    ...
    .line 13
    invoke-static {p2}, Ladnz;->u(I)Ladny;
    ...
    :try_start_2
    new-instance p4, Lapgs;

    .line 15
    invoke-direct {p4, p1}, Lapgs;-><init>(Ljava/io/InputStream;)V
    ...
    .line 18
    invoke-virtual {p3, p4, v1, v2}, Ladny;->write([BII)V

    goto :goto_4

    .line 19
    :cond_3
    invoke-virtual {p3}, Ladny;->b()Ladnz;
    ...
    .line 21
    :try_start_3
    invoke-static {p3}, Lvte;->b(Ljava/io/Closeable;)V

    .line 22
    invoke-static {p1}, Lvte;->b(Ljava/io/Closeable;)V
    ...
    :goto_7
    :try_start_4
    new-instance p4, Lvtg;

    .line 20
    invoke-direct {p4, p2}, Lvtg;-><init>(Ljava/lang/Exception;)V
    ...
    .line 8
    invoke-direct {p1, p2}, Lvtg;-><init>(Ljava/lang/String;)V
    ...
    .line 26
    invoke-direct {p2, p1}, Lvtg;-><init>(Ljava/lang/Exception;)V
