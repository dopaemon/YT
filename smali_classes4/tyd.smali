...
# direct methods
.method public constructor <init>(Landroid/media/MediaFormat;Ltye;Ltyt;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p3}, Ltyf;-><init>(Landroid/media/MediaFormat;Ltyt;)V

    iput-object p2, p0, Ltyd;->f:Ltye;

    .line 2
    invoke-interface {p2, p0}, Ltye;->f(Ltyd;)V

    .line 3
    invoke-interface {p2, p0}, Ltye;->e(Ltyd;)V
...
.method protected final b()V
    ...
    .line 1
    iput-boolean v0, p0, Ltyd;->g:Z

    iget-object v0, p0, Ltyd;->f:Ltye;

    invoke-interface {v0}, Ltye;->d()Z
...
.method public final f(IIIJ)V
    ...
    :goto_0
    iget-object v7, v1, Ltyd;->b:Landroid/media/MediaCodec;
    ...
    :cond_2
    iput-boolean v6, v1, Ltyd;->h:Z

    if-eqz v6, :cond_5

    iget-boolean v0, v1, Ltyd;->g:Z
    ...
    .line 4
    invoke-virtual {p0, v2}, Ltyf;->i(I)V
...
.method public final onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Ltyd;->b:Landroid/media/MediaCodec;
    ...
    iget-object v1, p0, Ltyd;->f:Ltye;

    .line 5
    invoke-interface {v1, p2, v0}, Ltye;->a(ILjava/nio/ByteBuffer;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
