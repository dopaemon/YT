...
.method final declared-synchronized a([BII)V
    ...
    .line 2
    :goto_0
    invoke-virtual {p0}, Ltzj;->available()I
    ...
    invoke-virtual {p0, p2}, Ltzj;->receive(I)V
    ...
    .line 6
    iget p2, p0, Ltzj;->in:I

    iget v1, p0, Ltzj;->out:I

    if-le p2, v1, :cond_3

    .line 7
    iget-object p2, p0, Ltzj;->buffer:[B

    array-length p2, p2

    iget v1, p0, Ltzj;->in:I
    ...
    .line 8
    iget-object v1, p0, Ltzj;->buffer:[B

    iget v2, p0, Ltzj;->in:I
