...
# direct methods
.method public constructor <init>(Ljava/util/concurrent/Executor;Labnl;Lwiv;Z[B[B[B[B)V
    .locals 0
    ...
    iput-object p2, p0, Lvsa;->c:Labnl;

    iput-object p3, p0, Lvsa;->a:Lwiv;
...
.method public final onRequestFinished(Lorg/chromium/net/RequestFinishedInfo;)V
    ...
    iget-object v1, p0, Lvsa;->c:Labnl;
    ...
    invoke-virtual {v1, v2, v3, v4}, Labnl;->av(Ljava/lang/String;D)V

    iget-boolean v1, p0, Lvsa;->b:Z

    if-eqz v1, :cond_6

    iget-object v1, p0, Lvsa;->a:Lwiv;
    ...
    .line 16
    invoke-virtual {p1, v0}, Lwiv;->aS(Lrly;)V
    ...
    invoke-direct {v0, v6, v7}, Lvkj;-><init>(J)V
