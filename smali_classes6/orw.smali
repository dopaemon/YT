...
.method public static b(Lcom/google/common/util/concurrent/ListenableFuture;)V
    ...
    invoke-direct {v0, p0, v1}, Loki;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;I)V
...
.method public static c(Landroid/content/Context;)Labrk;
    .locals 12
    ...
    invoke-static {v6}, Lorw;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8}, Lorw;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7}, Lorw;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance p0, Looq;

    invoke-direct {p0, v4}, Looq;-><init>(Ljava/util/Map;)V
    :try_end_4
...
.method public static f(Landroid/net/Uri;)Ljava/io/File;
    ...
    .line 6
    invoke-direct {p0, v0}, Lpaj;-><init>(Ljava/lang/String;)V
...
.method public static g(Landroid/net/Uri$Builder;Labwf;)Landroid/net/Uri;
    .locals 0
    ...
    invoke-static {p1}, Lpat;->b(Ljava/util/List;)Ljava/lang/String;
...
.method public static h(Ljava/lang/String;Ljava/lang/String;J)Landroid/net/Uri;
    ...
    .line 2
    invoke-static {p0}, Lpab;->b(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lpab;->a(Ljava/lang/String;)Z
    ...
    sget-object p2, Lpab;->a:Labse;

    .line 7
    invoke-virtual {p2, p1}, Labse;->h(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    .line 8
    invoke-static {p1}, Lpab;->b(Ljava/lang/String;)Z
