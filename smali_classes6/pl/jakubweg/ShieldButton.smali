...
# static fields
.field static TAG:Ljava/lang/String; = "SHIELD"
...
.method public static changeVisibility(ZZ)V
    ...
    .line 86
    sget-object p0, Lpl/jakubweg/ShieldButton;->TAG:Ljava/lang/String;
    ...
    .line 90
    sget-object p0, Lpl/jakubweg/ShieldButton;->fadeIn:Landroid/view/animation/Animation;
    ...
    .line 99
    sget-object p0, Lpl/jakubweg/ShieldButton;->fadeOut:Landroid/view/animation/Animation;
...
.method public static initialize(Ljava/lang/Object;)V
    ...
    sput-object p0, Lpl/jakubweg/ShieldButton;->_youtubeControlsLayout:Landroid/widget/RelativeLayout;

    const-string v0, "sponsorblock_button"

    const-string v1, "id"

    .line 38
    invoke-static {v0, v1}, Lpl/jakubweg/ShieldButton;->getIdentifier(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v1, "Couldn\'t find imageView with tag \"sponsorblock_button\""
    ...
    .line 44
    :cond_2
    sget-object v0, Lpl/jakubweg/SponsorBlockUtils;->sponsorBlockBtnListener:Landroid/view/View$OnClickListener;
    ...
    .line 48
    invoke-static {p0}, Lpl/jakubweg/ShieldButton;->getInteger(Ljava/lang/String;)I

    move-result p0

    sput p0, Lpl/jakubweg/ShieldButton;->fadeDurationFast:I
    ...
    sput p0, Lpl/jakubweg/ShieldButton;->fadeDurationScheduled:I

    const-string p0, "fade_in"

    .line 50
    invoke-static {p0}, Lpl/jakubweg/ShieldButton;->getAnimation(Ljava/lang/String;)Landroid/view/animation/Animation;

    move-result-object p0

    sput-object p0, Lpl/jakubweg/ShieldButton;->fadeIn:Landroid/view/animation/Animation;

    .line 51
    sget v0, Lpl/jakubweg/ShieldButton;->fadeDurationFast:I
    ...
    sput-object p0, Lpl/jakubweg/ShieldButton;->fadeOut:Landroid/view/animation/Animation;

    .line 53
    sget v0, Lpl/jakubweg/ShieldButton;->fadeDurationScheduled:I
    ...
    .line 55
    invoke-static {p0}, Lpl/jakubweg/ShieldButton;->changeVisibilityImmediate(Z)V
    :try_end_0
