...
.field static final PRE_API_29_HIDDEN_METHOD_INVOKER:Lnu;
...
.field private mOnCloseListener:Lnr;
...
.field public mSuggestionsAdapter:Lado;
...
.field private mTouchDelegate:Lnv;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-object v0, Landroid/support/v7/widget/SearchView;->PRE_API_29_HIDDEN_METHOD_INVOKER:Lnu;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct/range {p0 .. p3}, Llq;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v3}, Lbf;-><init>(Landroid/support/v7/widget/SearchView;I)V
    ...
    invoke-direct {v2, v0, v1}, Ljd;-><init>(Landroid/support/v7/widget/SearchView;I)V
    ...
    invoke-direct {v3, v0, v4}, Lbql;-><init>(Landroid/support/v7/widget/SearchView;I)V
    ...
    invoke-direct {v3, v0, v4}, Lgcs;-><init>(Landroid/support/v7/widget/SearchView;I)V
    ...
    invoke-direct {v5, v0, v6}, Lnp;-><init>(Landroid/support/v7/widget/SearchView;I)V
    ...
    invoke-direct {v7, v0, v6}, Lnq;-><init>(Landroid/support/v7/widget/SearchView;I)V

    iput-object v7, v0, Landroid/support/v7/widget/SearchView;->mOnItemSelectedListener:Landroid/widget/AdapterView$OnItemSelectedListener;

    new-instance v8, Lecp;

    invoke-direct {v8, v0, v4}, Lecp;-><init>(Landroid/support/v7/widget/SearchView;I)V

    iput-object v8, v0, Landroid/support/v7/widget/SearchView;->mTextWatcher:Landroid/text/TextWatcher;

    .line 7
    sget-object v8, Lfz;->t:[I
    ...
    invoke-static {v9, v10, v8, v11, v6}, Lkxa;->W(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lkxa;
    ...
    .line 9
    invoke-virtual {v8, v10, v11}, Lkxa;->I(II)I

    move-result v10

    .line 10
    invoke-virtual {v9, v10, v0, v4}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    .line 20
    invoke-virtual {v8, v4}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    .line 21
    invoke-static {v10, v4}, Labl;->N(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 23
    invoke-static {v11, v4}, Labl;->N(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 25
    invoke-virtual {v8, v10}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 29
    invoke-virtual {v8, v1}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 31
    invoke-static {v12, v1}, Lde;->f(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    .line 32
    invoke-virtual {v8, v1, v4}, Lkxa;->I(II)I
    ...
    .line 33
    invoke-virtual {v8, v1, v6}, Lkxa;->I(II)I
    ...
    .line 40
    invoke-virtual {v9, v3}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnEditorActionListener(Landroid/widget/TextView$OnEditorActionListener;)V
    ...
    .line 42
    invoke-virtual {v9, v7}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-direct {v1, v0, v2}, Lfeb;-><init>(Landroid/support/v7/widget/SearchView;I)V
    ...
    .line 45
    invoke-virtual {v8, v1, v2}, Lkxa;->P(IZ)Z
    ...
    .line 46
    invoke-virtual {v8, v2, v1}, Lkxa;->E(II)I
    ...
    .line 48
    invoke-virtual {v8, v2}, Lkxa;->M(I)Ljava/lang/CharSequence;
    ...
    .line 50
    invoke-virtual {v8, v2, v1}, Lkxa;->F(II)I
    ...
    .line 54
    invoke-virtual {v8, v6, v1}, Lkxa;->P(IZ)Z
    ...
    invoke-direct {v2, v0, v3}, Levo;-><init>(Landroid/support/v7/widget/SearchView;I)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    .line 1
    invoke-static {p1, v1}, Loc;->c(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 5
    invoke-static {p1, v3}, Loc;->c(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private launchSuggestion(IILjava/lang/String;)Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lado;

    iget-object v0, v0, Lado;->d:Landroid/database/Cursor;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lado;

    iget-object v1, v1, Lado;->d:Landroid/database/Cursor;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lado;

    .line 3
    invoke-virtual {p1, v1}, Lado;->b(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    .line 6
    invoke-virtual {v0, v1}, Lado;->d(Landroid/database/Cursor;)V
    ...
    invoke-direct {v0, v1, p0, v3, v4}, Loc;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lado;
...
.method public clearFocus()V
    ...
    invoke-super {p0}, Llq;->clearFocus()V
...
.method public forceSuggestionQuery()V
    ...
    :cond_0
    sget-object v0, Landroid/support/v7/widget/SearchView;->PRE_API_29_HIDDEN_METHOD_INVOKER:Lnu;
    ...
    iget-object v0, v0, Lnu;->b:Ljava/lang/Object;
...
.method public getSuggestionsAdapter()Lado;
    .locals 1
...
.method public onCloseClicked()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lnr;

    if-eqz v0, :cond_0

    .line 3
    invoke-interface {v0}, Lnr;->a()Z
...
.method public onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1
    iget-object p2, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lnt;

    const/4 p3, 0x0

    if-eqz p2, :cond_1

    invoke-interface {p2}, Lnt;->a()Z
...
.method public onItemSelected(I)Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lnt;

    if-eqz v0, :cond_1

    invoke-interface {v0}, Lnt;->b()Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Lnv;
    ...
    invoke-direct {p1, p2, p3, p4}, Lnv;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Lnv;
    ...
    .line 6
    invoke-virtual {p1, p2, p3}, Lnv;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected onMeasure(II)V
    ...
    .line 2
    invoke-super {p0, p1, p2}, Llq;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 2
    invoke-super {p0, p1}, Llq;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 4
    invoke-super {p0, v0}, Llq;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1
    invoke-super {p0}, Llq;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public onSubmitQuery()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lns;
...
.method public onTextChanged(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lns;
...
.method public onWindowFocusChanged(Z)V
    ...
    .line 1
    invoke-super {p0, p1}, Llq;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 5
    :cond_3
    invoke-super {p0, p1, p2}, Llq;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Lnr;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lnr;
...
.method public setOnQueryTextListener(Lns;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lns;
...
.method public setOnSuggestionListener(Lnt;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lnt;
...
.method public setSuggestionsAdapter(Lado;)V
    .locals 1

    .line 1
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lado;
