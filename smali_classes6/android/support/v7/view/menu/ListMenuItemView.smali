...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lfz;->q:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Lkxa;->W(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lkxa;
    ...
    .line 4
    invoke-virtual {p2, p3}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 5
    invoke-virtual {p2, p3, v0}, Lkxa;->I(II)I
    ...
    .line 7
    invoke-virtual {p2, v0}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;
...
.method public final a()Lii;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lii;
...
.method public final f(Lii;)V
    .locals 11

    .line 1
    iput-object p1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lii;

    invoke-virtual {p1}, Lii;->isVisible()Z
    ...
    .line 2
    invoke-virtual {p1, p0}, Lii;->f(Lit;)Ljava/lang/CharSequence;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p1}, Lii;->isCheckable()Z
    ...
    .line 42
    :cond_3
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lii;
    ...
    .line 14
    invoke-virtual {v0}, Lii;->isChecked()Z
    ...
    :cond_a
    :goto_3
    invoke-virtual {p1}, Lii;->t()Z

    move-result v0

    invoke-virtual {p1}, Lii;->e()C
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lii;

    .line 23
    invoke-virtual {v5}, Lii;->e()C
    ...
    .line 53
    :cond_c
    iget-object v7, v5, Lii;->j:Lig;

    iget-object v7, v7, Lig;->a:Landroid/content/Context;
    ...
    iget-object v9, v5, Lii;->j:Lig;

    iget-object v9, v9, Lig;->a:Landroid/content/Context;
    ...
    .line 29
    invoke-static {v8, v5, v9, v10}, Lii;->g(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/16 v9, 0x1000

    const v10, 0x7f14000e
    ...
    .line 35
    invoke-static {v8, v5, v1, v9}, Lii;->g(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    .line 39
    invoke-static {v8, v5, v3, v9}, Lii;->g(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    .line 46
    :cond_13
    invoke-virtual {p1}, Lii;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lii;

    iget-object v4, v4, Lii;->j:Lig;
    ...
    :cond_1c
    iget-object p1, p1, Lii;->l:Ljava/lang/CharSequence;
...
.method protected final onFinishInflate()V
    ...
    .line 2
    invoke-static {p0, v0}, Labl;->N(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
