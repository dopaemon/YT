...
.method private final g()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lii;
    ...
    iget-object v2, v2, Lii;->l:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lii;->d:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lii;->m:Ljava/lang/CharSequence;
    ...
    .line 7
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lii;

    iget-object v1, v0, Lii;->d:Ljava/lang/CharSequence;

    :goto_3
    invoke-static {p0, v1}, Lde;->f(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    .line 8
    :cond_6
    invoke-static {p0, v2}, Lde;->f(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Lii;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final f(Lii;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lii;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lli;
    ...
    invoke-direct {p1, p0}, Lhv;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lli;
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lif;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lii;

    invoke-interface {p1, v0}, Lif;->b(Lii;)Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lii;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Lli;
