...
# static fields
.field private static final a:Ladnz;
...
.method public static final a(Ljava/security/interfaces/ECPrivateKey;Ljava/security/interfaces/ECPublicKey;II)V
    ...
    invoke-direct {v0, p0, p2, p3}, Lacuo;-><init>(Ljava/security/interfaces/ECPrivateKey;II)V

    new-instance p0, Lacup;

    .line 2
    invoke-direct {p0, p1, p2, p3}, Lacup;-><init>(Ljava/security/interfaces/ECPublicKey;II)V

    :try_start_0
    sget-object p1, Lacvo;->a:Ladnz;
    ...
    .line 4
    sget-object p3, Lacuz;->c:Lacuz;

    iget-object v1, v0, Lacuo;->b:Ljava/lang/String;

    invoke-virtual {p3, v1}, Lacuz;->a(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Ljava/security/Signature;

    iget-object v1, v0, Lacuo;->a:Ljava/security/interfaces/ECPrivateKey;
    ...
    iget p3, v0, Lacuo;->c:I

    const/4 v1, 0x1

    if-ne p3, v1, :cond_4

    iget-object p3, v0, Lacuo;->a:Ljava/security/interfaces/ECPrivateKey;
    ...
    .line 9
    invoke-static {p3}, Ladfe;->T(Ljava/security/spec/EllipticCurve;)I
    ...
    .line 20
    invoke-virtual {p0, p2, p1}, Lacup;->a([B[B)V
    :try_end_0
...
.method public static final b(Ljava/security/interfaces/RSAPrivateCrtKey;Ljava/security/interfaces/RSAPublicKey;I)V
    ...
    invoke-direct {v0, p0, p2}, Lacvk;-><init>(Ljava/security/interfaces/RSAPrivateCrtKey;I)V

    new-instance p0, Lacvl;

    .line 2
    invoke-direct {p0, p1, p2}, Lacvl;-><init>(Ljava/security/interfaces/RSAPublicKey;I)V
    ...
    .line 4
    sget-object v1, Lacuz;->c:Lacuz;

    iget-object v2, v0, Lacvk;->c:Ljava/lang/String;
    ...
    iget-object v2, v0, Lacvk;->a:Ljava/security/interfaces/RSAPrivateCrtKey;
    ...
    sget-object v2, Lacuz;->c:Lacuz;

    iget-object v3, v0, Lacvk;->c:Ljava/lang/String;
    ...
    iget-object v0, v0, Lacvk;->b:Ljava/security/interfaces/RSAPublicKey;
    ...
    invoke-virtual {p0, v1, p1}, Lacvl;->a([B[B)V
...
.method public static final c(Ljava/security/interfaces/RSAPrivateCrtKey;Ljava/security/interfaces/RSAPublicKey;III)V
    ...
    .line 1
    new-instance v4, Lacvm;

    move-object/from16 v5, p0

    invoke-direct {v4, v5, v0, v1, v2}, Lacvm;-><init>(Ljava/security/interfaces/RSAPrivateCrtKey;III)V

    new-instance v5, Lacvn;

    move-object/from16 v6, p1

    .line 2
    invoke-direct {v5, v6, v0, v1, v2}, Lacvn;-><init>(Ljava/security/interfaces/RSAPublicKey;III)V

    :try_start_0
    sget-object v0, Lacvo;->a:Ladnz;
    ...
    iget-object v1, v4, Lacvm;->b:Ljava/security/interfaces/RSAPublicKey;
    ...
    .line 6
    sget-object v2, Lacuz;->d:Lacuz;

    iget v6, v4, Lacvm;->d:I

    invoke-static {v6}, Ladfe;->N(I)Ljava/lang/String;

    move-result-object v6

    .line 7
    invoke-virtual {v2, v6}, Lacuz;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 10
    invoke-static {v10}, Lacvj;->a(I)[B

    move-result-object v10

    add-int/lit8 v11, v6, 0x8

    iget v13, v4, Lacvm;->c:I
    ...
    iget v0, v4, Lacvm;->e:I

    .line 18
    invoke-static {v2, v8, v0}, Ladfe;->P([BII)[B
    ...
    iget-object v2, v4, Lacvm;->a:Ljava/security/interfaces/RSAPrivateCrtKey;
    ...
    iget-object v3, v4, Lacvm;->b:Ljava/security/interfaces/RSAPublicKey;
    ...
    invoke-virtual {v5, v1, v0}, Lacvn;->a([B[B)V
