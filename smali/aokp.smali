...
# direct methods
.method public constructor <init>(Laokq;)V
    .locals 0

    .line 1
    iput-object p1, p0, Laokp;->a:Laokq;
...
.method public final b(Ljava/lang/Throwable;)V
    ...
    .line 1
    iget-object v0, p0, Laokp;->a:Laokq;

    iget-object v1, v0, Laokq;->b:Lanuz;

    invoke-virtual {v1, p0}, Lanuz;->f(Lanva;)Z

    iget-object v1, v0, Laokq;->d:Laoss;
    ...
    iget-object p1, v0, Laokq;->g:Lanva;

    .line 3
    invoke-interface {p1}, Lanva;->qv()V

    iget-object p1, v0, Laokq;->b:Lanuz;

    .line 4
    invoke-virtual {p1}, Lanuz;->qv()V

    iget-object p1, v0, Laokq;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    .line 5
    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    .line 6
    invoke-virtual {v0}, Laokq;->g()V
...
.method public final e()Z
    ...
    .line 1
    invoke-virtual {p0}, Laokp;->get()Ljava/lang/Object;
...
.method public final sb(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v2}, Laokq;->compareAndSet(II)Z

    move-result v1

    if-eqz v1, :cond_3

    iget-object v1, v0, Laokq;->a:Lanuh;
    ...
    iget-object v1, v0, Laokq;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_0
    iget-object p1, v0, Laokq;->d:Laoss;
    ...
    iget-object v0, v0, Laokq;->a:Lanuh;
    ...
    :cond_1
    iget-object p1, v0, Laokq;->a:Lanuh;
    ...
    .line 15
    :cond_2
    invoke-virtual {v0}, Laokq;->decrementAndGet()I
    ...
    iget-object v2, v0, Laokq;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 10
    invoke-virtual {v0}, Laokq;->getAndIncrement()I
...
.method public final sg()V
    ...
    iget-object v1, v0, Laokq;->c:Ljava/util/concurrent/atomic/AtomicInteger;
