...
.field private u:Lacb;

.field private v:Lacb;

.field private w:Lacb;

.field private x:Lacb;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 10
    sget-object p2, Lacb;->a:Lacb;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lacb;

    sget-object p2, Lacb;->a:Lacb;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lacb;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lacb;

    new-instance p2, Lje;

    .line 11
    invoke-direct {p2, p0}, Lje;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V
    ...
    invoke-direct {p2, p0, v0}, Lbf;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;I)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Laak;
...
.method private static final w(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    iput v0, p0, Ljg;->topMargin:I

    const/4 v0, 0x1

    .line 6
    :cond_1
    iget v1, p0, Ljg;->rightMargin:I
...
.method public final a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lkt;

    .line 2
    invoke-interface {v0}, Lkt;->f()V
...
.method public final c(I)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lkt;

    .line 3
    invoke-interface {p1}, Lkt;->g()V
...
.method public final bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Ljg;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Ljg;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final getNestedScrollAxes()I
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Laak;
...
.method final i()V
    ...
    .line 5
    :goto_0
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lkt;
...
.method public final l(Landroid/view/Menu;Lir;)V
    ...
    .line 2
    invoke-interface {v0, p1, p2}, Lkt;->l(Landroid/view/Menu;Lir;)V
...
.method public final n(Landroid/view/Window$Callback;)V
    ...
    .line 2
    invoke-interface {v0, p1}, Lkt;->r(Landroid/view/Window$Callback;)V
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    .line 7
    invoke-static {p0, p1, v1}, Labl;->ar(Landroid/view/View;Lacb;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v1, v2, v3, v4}, Lacb;->m(IIII)Lacb;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lacb;

    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lacb;

    .line 9
    invoke-virtual {v2, v1}, Lacb;->equals(Ljava/lang/Object;)Z

    move-result v1

    if-nez v1, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lacb;
    ...
    .line 13
    :cond_2
    invoke-virtual {p1}, Lacb;->j()Lacb;

    move-result-object p1

    .line 14
    invoke-virtual {p1}, Lacb;->l()Lacb;

    move-result-object p1

    .line 15
    invoke-virtual {p1}, Lacb;->k()Lacb;
...
.method protected final onLayout(ZIIII)V
    ...
    .line 9
    iget v3, v0, Ljg;->leftMargin:I

    add-int/2addr v3, p2

    .line 10
    iget v0, v0, Ljg;->topMargin:I
...
.method protected final onMeasure(II)V
    ...
    iget v2, v0, Ljg;->leftMargin:I

    add-int/2addr v1, v2

    iget v2, v0, Ljg;->rightMargin:I
    ...
    iget v4, v0, Ljg;->topMargin:I

    add-int/2addr v3, v4

    iget v0, v0, Ljg;->bottomMargin:I
    ...
    .line 9
    invoke-static {p0}, Labl;->j(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lacb;

    iput-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;

    .line 24
    invoke-virtual {v4, v2, v5, v2, v2}, Lacb;->m(IIII)Lacb;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;

    goto :goto_2

    .line 13
    :cond_2
    invoke-virtual {v6}, Lacb;->b()I
    ...
    .line 14
    invoke-virtual {v4}, Lacb;->d()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;

    .line 15
    invoke-virtual {v5}, Lacb;->c()I

    move-result v5

    iget-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;

    .line 16
    invoke-virtual {v6}, Lacb;->a()I

    move-result v6

    invoke-static {v2, v4, v5, v6}, Lxu;->c(IIII)Lxu;
    ...
    .line 17
    invoke-direct {v5, v4}, Labs;-><init>(Lacb;)V
    ...
    .line 18
    invoke-direct {v5, v4}, Labr;-><init>(Lacb;)V
    ...
    .line 19
    invoke-direct {v5, v4}, Labq;-><init>(Lacb;)V

    .line 20
    :goto_1
    invoke-virtual {v5, v2}, Labt;->c(Lxu;)V

    .line 21
    invoke-virtual {v5}, Labt;->a()Lacb;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lacb;

    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;

    .line 26
    invoke-virtual {v2, v4}, Lacb;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lacb;

    iput-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lacb;

    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->l:Landroid/support/v7/widget/ContentFrameLayout;

    .line 27
    invoke-static {v4, v2}, Labl;->r(Landroid/view/View;Lacb;)Lacb;
    ...
    iget v5, v2, Ljg;->leftMargin:I

    iget v6, v2, Ljg;->rightMargin:I
    ...
    iget v5, v2, Ljg;->topMargin:I

    iget v2, v2, Ljg;->bottomMargin:I
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    .line 1
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Laak;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->h:Ljf;

    if-eqz p1, :cond_1

    check-cast p1, Lfy;

    iget-object p2, p1, Lfy;->n:Lhs;
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->h:Ljf;
    ...
    .line 5
    :cond_1
    iget-boolean p1, v2, Lfy;->m:Z

    if-nez p1, :cond_3

    iput-boolean v4, v2, Lfy;->m:Z

    .line 4
    invoke-virtual {v2, v4}, Lfy;->E(Z)V
...
.method protected final onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->h:Ljf;
