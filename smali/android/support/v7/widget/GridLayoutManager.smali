...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Lln;
...
.method public constructor <init>(II)V
    ...
    .line 10
    invoke-direct {p2}, Lll;-><init>()V

    iput-object p2, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Lln;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 18
    invoke-static {p1, p2, p3, p4}, Landroid/support/v7/widget/GridLayoutManager;->ay(Landroid/content/Context;Landroid/util/AttributeSet;II)Lmn;
...
.method private final bB(Lmu;Lnc;I)I
    .locals 0

    .line 1
    iget-boolean p2, p2, Lnc;->g:Z

    if-nez p2, :cond_0

    iget-object p1, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Lln;

    iget p2, p0, Landroid/support/v7/widget/GridLayoutManager;->b:I

    invoke-virtual {p1, p3, p2}, Lln;->c(II)I
    ...
    .line 2
    :cond_0
    invoke-virtual {p1, p3}, Lmu;->a(I)I
    ...
    :cond_1
    iget-object p2, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Lln;

    iget p3, p0, Landroid/support/v7/widget/GridLayoutManager;->b:I

    .line 4
    invoke-virtual {p2, p1, p3}, Lln;->c(II)I
...
.method private final bC(Lmu;Lnc;I)I
    .locals 1
    ...
    invoke-virtual {p1, p3, p2}, Lln;->a(II)I
    ...
    .line 5
    invoke-virtual {p2, p1, p3}, Lln;->a(II)I
...
.method private final bD(Lmu;Lnc;I)I
    .locals 1
    ...
    invoke-virtual {p1, p3}, Lln;->b(I)I
    ...
    .line 5
    invoke-virtual {p2, p1}, Lln;->b(I)I
...
.method private final bG(Landroid/view/View;IZ)V
    ...
    .line 2
    iget-object v1, v0, Llm;->d:Landroid/graphics/Rect;
    ...
    iget v3, v0, Llm;->topMargin:I

    add-int/2addr v2, v3

    iget v3, v0, Llm;->bottomMargin:I
    ...
    iget v1, v0, Llm;->leftMargin:I

    add-int/2addr v3, v1

    iget v1, v0, Llm;->rightMargin:I
    ...
    .line 6
    iget v4, v0, Llm;->width:I

    invoke-static {v1, p2, v3, v4, v5}, Landroid/support/v7/widget/GridLayoutManager;->at(IIIIZ)I

    move-result p2

    iget-object v1, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;
    ...
    iget v0, v0, Llm;->height:I

    invoke-static {v1, v3, v2, v0, v6}, Landroid/support/v7/widget/GridLayoutManager;->at(IIIIZ)I
    ...
    .line 8
    :cond_0
    iget v4, v0, Llm;->height:I

    invoke-static {v1, p2, v2, v4, v5}, Landroid/support/v7/widget/GridLayoutManager;->at(IIIIZ)I
    ...
    iget v0, v0, Llm;->width:I

    invoke-static {v1, v2, v3, v0, v6}, Landroid/support/v7/widget/GridLayoutManager;->at(IIIIZ)I
...
.method private final bH(Landroid/view/View;IIZ)V
    ...
    invoke-static {p4, p2, v2}, Lmo;->bf(III)Z
    ...
    iget v0, v0, Lmp;->height:I

    invoke-static {p4, p3, v0}, Lmo;->bf(III)Z
...
.method public final d(ILmu;Lnc;)I
    ...
    .line 3
    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/widget/LinearLayoutManager;->d(ILmu;Lnc;)I
...
.method public final e(ILmu;Lnc;)I
    ...
    .line 3
    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/widget/LinearLayoutManager;->e(ILmu;Lnc;)I
...
.method public final f()Lmp;
    ...
    invoke-direct {v0, v1, v2}, Llm;-><init>(II)V
    ...
    .line 2
    invoke-direct {v0, v2, v1}, Llm;-><init>(II)V
...
.method public final h(Landroid/content/Context;Landroid/util/AttributeSet;)Lmp;
    ...
    invoke-direct {v0, p1, p2}, Llm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method public final i(Lmu;Lnc;ZZ)Landroid/view/View;
    .locals 8
    ...
    iget-object v2, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;
    ...
    .line 7
    invoke-virtual {p0, p3}, Lmo;->aA(I)Landroid/view/View;

    move-result-object v6

    .line 8
    invoke-static {v6}, Landroid/support/v7/widget/GridLayoutManager;->bn(Landroid/view/View;)I
    ...
    .line 9
    invoke-direct {p0, p1, p2, v7}, Landroid/support/v7/widget/GridLayoutManager;->bC(Lmu;Lnc;I)I
    ...
    :cond_2
    iget-object v7, p0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;
...
.method public final k(Lmu;Lnc;Llt;Lls;)V
    .locals 17
    ...
    .line 1
    iget-object v5, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;
    ...
    invoke-direct {v0, v1, v2, v10}, Landroid/support/v7/widget/GridLayoutManager;->bC(Lmu;Lnc;I)I
    ...
    invoke-direct {v0, v1, v2, v12}, Landroid/support/v7/widget/GridLayoutManager;->bD(Lmu;Lnc;I)I
    ...
    .line 7
    invoke-virtual {v3, v2}, Llt;->d(Lnc;)Z
    ...
    .line 9
    invoke-direct {v0, v1, v2, v13}, Landroid/support/v7/widget/GridLayoutManager;->bD(Lmu;Lnc;I)I
    ...
    .line 10
    :cond_3
    invoke-virtual {v3, v1}, Llt;->a(Lmu;)Landroid/view/View;
    ...
    .line 15
    invoke-static {v8}, Landroid/support/v7/widget/GridLayoutManager;->bn(Landroid/view/View;)I

    move-result v8

    invoke-direct {v0, v1, v2, v8}, Landroid/support/v7/widget/GridLayoutManager;->bD(Lmu;Lnc;I)I
    ...
    .line 18
    iget-object v10, v3, Llt;->l:Ljava/util/List;
    ...
    .line 19
    invoke-virtual {v0, v8}, Lmo;->aE(Landroid/view/View;)V
    ...
    .line 20
    invoke-virtual {v0, v8, v10}, Lmo;->aF(Landroid/view/View;I)V
    ...
    .line 21
    invoke-virtual {v0, v8}, Lmo;->aC(Landroid/view/View;)V

    goto :goto_6

    .line 22
    :cond_a
    invoke-virtual {v0, v8, v10}, Lmo;->aD(Landroid/view/View;I)V
    ...
    .line 23
    invoke-virtual {v0, v8, v13}, Lmo;->aG(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 24
    invoke-direct {v0, v8, v5, v10}, Landroid/support/v7/widget/GridLayoutManager;->bG(Landroid/view/View;IZ)V

    iget-object v10, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;

    .line 25
    invoke-virtual {v10, v8}, Lmc;->b(Landroid/view/View;)I
    ...
    iget-object v13, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;

    .line 27
    invoke-virtual {v13, v8}, Lmc;->c(Landroid/view/View;)I

    move-result v8

    int-to-float v8, v8

    iget v10, v10, Llm;->b:I
    ...
    .line 31
    invoke-direct {v0, v1, v2, v11}, Landroid/support/v7/widget/GridLayoutManager;->bG(Landroid/view/View;IZ)V

    iget-object v2, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;
    ...
    .line 36
    iget-object v5, v2, Llm;->d:Landroid/graphics/Rect;
    ...
    iget v8, v2, Llm;->topMargin:I

    add-int/2addr v6, v8

    iget v8, v2, Llm;->bottomMargin:I
    ...
    iget v5, v2, Llm;->leftMargin:I

    add-int/2addr v8, v5

    iget v5, v2, Llm;->rightMargin:I
    ...
    .line 40
    iget v2, v2, Llm;->width:I

    const/4 v9, 0x0

    const/high16 v13, 0x40000000    # 2.0f

    invoke-static {v5, v13, v8, v2, v9}, Landroid/support/v7/widget/GridLayoutManager;->at(IIIIZ)I
    ...
    .line 43
    iget v2, v2, Llm;->height:I

    invoke-static {v5, v13, v6, v2, v9}, Landroid/support/v7/widget/GridLayoutManager;->at(IIIIZ)I
    ...
    .line 44
    :goto_9
    invoke-direct {v0, v1, v2, v5, v11}, Landroid/support/v7/widget/GridLayoutManager;->bH(Landroid/view/View;IIZ)V
    ...
    iget-object v8, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Lmc;
    ...
    .line 60
    invoke-virtual {v2, v5}, Lmc;->c(Landroid/view/View;)I
    ...
    .line 61
    :goto_e
    invoke-static {v5, v3, v1, v10, v2}, Landroid/support/v7/widget/GridLayoutManager;->br(Landroid/view/View;IIII)V
    ...
    .line 63
    :cond_18
    iput-boolean v11, v4, Lls;->c:Z

    .line 64
    :cond_19
    iget-boolean v6, v4, Lls;->d:Z
    ...
    .line 66
    :cond_1b
    iput-boolean v11, v4, Lls;->b:Z

    return-void
.end method

.method public final l(Lmu;Lnc;Llr;I)V
    .locals 4
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v7/widget/GridLayoutManager;->bC(Lmu;Lnc;I)I
    ...
    .line 6
    invoke-direct {p0, p1, p2, p4}, Landroid/support/v7/widget/GridLayoutManager;->bC(Lmu;Lnc;I)I
    ...
    .line 9
    invoke-direct {p0, p1, p2, v2}, Landroid/support/v7/widget/GridLayoutManager;->bC(Lmu;Lnc;I)I
...
.method public final n(Lmu;Lnc;)V
    ...
    .line 6
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/LinearLayoutManager;->n(Lmu;Lnc;)V
...
.method public final oZ(Lmu;Lnc;)I
    .locals 2
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v7/widget/GridLayoutManager;->bB(Lmu;Lnc;I)I
...
.method public final pa(Lmu;Lnc;)I
    .locals 1
...
.method public qg(Landroid/view/ViewGroup$LayoutParams;)Lmp;
    ...
    invoke-direct {v0, p1}, Llm;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    .line 3
    invoke-direct {v0, p1}, Llm;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final qh(Landroid/view/View;ILmu;Lnc;)Landroid/view/View;
    ...
    .line 1
    invoke-virtual/range {p0 .. p1}, Lmo;->az(Landroid/view/View;)Landroid/view/View;
    ...
    .line 5
    invoke-super/range {p0 .. p4}, Landroid/support/v7/widget/LinearLayoutManager;->qh(Landroid/view/View;ILmu;Lnc;)Landroid/view/View;
    ...
    .line 10
    :goto_2
    invoke-direct {v0, v1, v2, v7}, Landroid/support/v7/widget/GridLayoutManager;->bB(Lmu;Lnc;I)I
    ...
    .line 11
    invoke-direct {v0, v1, v2, v11}, Landroid/support/v7/widget/GridLayoutManager;->bB(Lmu;Lnc;I)I

    move-result v10

    .line 12
    invoke-virtual {v0, v11}, Lmo;->aA(I)Landroid/view/View;
    ...
    iget-object v9, v0, Lmo;->G:Lpj;

    .line 23
    invoke-virtual {v9, v1}, Lpj;->l(Landroid/view/View;)Z

    move-result v9

    if-eqz v9, :cond_f

    iget-object v9, v0, Lmo;->H:Lpj;
...
.method public final qi(Lmu;Lnc;Landroid/view/View;Lach;)V
    .locals 2
    ...
    .line 3
    invoke-super {p0, p3, p4}, Landroid/support/v7/widget/LinearLayoutManager;->aO(Landroid/view/View;Lach;)V
    ...
    .line 5
    invoke-virtual {v0}, Lmp;->kx()I

    move-result p3

    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/GridLayoutManager;->bB(Lmu;Lnc;I)I
    ...
    .line 7
    invoke-static {p2, v0, p1, v1, p3}, Laif;->g(IIIIZ)Laif;

    move-result-object p1

    invoke-virtual {p4, p1}, Lach;->u(Ljava/lang/Object;)V
    ...
    .line 6
    invoke-static {p1, v1, p2, v0, p3}, Laif;->g(IIIIZ)Laif;
...
.method public final qj(Landroid/graphics/Rect;II)V
    ...
    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/widget/LinearLayoutManager;->qj(Landroid/graphics/Rect;II)V
    ...
    invoke-static {p3, p1, v1}, Landroid/support/v7/widget/GridLayoutManager;->aq(III)I
    ...
    .line 6
    invoke-static {p2, p3, v0}, Landroid/support/v7/widget/GridLayoutManager;->aq(III)I
    ...
    invoke-static {p2, p1, v0}, Landroid/support/v7/widget/GridLayoutManager;->aq(III)I
    ...
    .line 10
    invoke-static {p3, p1, v0}, Landroid/support/v7/widget/GridLayoutManager;->aq(III)I
...
.method public final ql()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Lln;
...
.method public final z(Lnc;Llt;Lana;)V
    .locals 5
    ...
    invoke-virtual {p2, p1}, Llt;->d(Lnc;)Z
    ...
    invoke-virtual {p3, v3, v4}, Lana;->q(II)V

    iget-object v4, p0, Landroid/support/v7/widget/GridLayoutManager;->g:Lln;

    .line 4
    invoke-virtual {v4, v3}, Lln;->b(I)I
