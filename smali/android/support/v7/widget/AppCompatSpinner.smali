...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, v0}, Loe;->d(Landroid/view/View;Landroid/content/Context;)V

    .line 9
    sget-object v0, Lfz;->u:[I
    ...
    .line 10
    invoke-direct {v2, p0}, Ljs;-><init>(Landroid/view/View;)V

    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Ljs;
    ...
    .line 11
    invoke-direct {v2, p1, p5}, Lpz;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    .line 12
    invoke-virtual {v0, p5, v1}, Lkxa;->I(II)I
    ...
    .line 13
    invoke-direct {v2, p1, p5}, Lpz;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p4, p0, v4, p2, p3}, Lki;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object v4, p0, Landroid/support/v7/widget/AppCompatSpinner;->a:Landroid/content/Context;

    sget-object v5, Lfz;->u:[I

    .line 20
    invoke-static {v4, p2, v5, p3, v1}, Lkxa;->W(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lkxa;
    ...
    .line 21
    invoke-virtual {v4, v5, v6}, Lkxa;->H(II)I
    ...
    .line 22
    invoke-virtual {v4, v3}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    .line 23
    invoke-virtual {p4, v5}, Llw;->f(Landroid/graphics/drawable/Drawable;)V

    .line 24
    invoke-virtual {v0, p5}, Lkxa;->N(I)Ljava/lang/String;

    move-result-object p5

    iput-object p5, p4, Lki;->a:Ljava/lang/CharSequence;

    .line 25
    invoke-virtual {v4}, Lkxa;->O()V

    iput-object p4, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lkj;

    .line 26
    new-instance p5, Lkf;

    invoke-direct {p5, p0, p0, p4}, Lkf;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Lki;)V

    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Lli;
    ...
    invoke-direct {p4, p0}, Lkg;-><init>(Landroid/support/v7/widget/AppCompatSpinner;)V
    ...
    invoke-interface {p4, p5}, Lkj;->i(Ljava/lang/CharSequence;)V

    .line 17
    :cond_8
    :goto_4
    iget-object p4, v0, Lkxa;->a:Ljava/lang/Object;
    ...
    :cond_a
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Ljs;
...
.method public final b()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lkj;
    ...
    invoke-interface {v0, v1, v2}, Lkj;->l(II)V
...
.method protected final drawableStateChanged()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Ljs;
...
.method public final getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lkj;->c()Landroid/graphics/drawable/Drawable;
...
.method public final getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lkj;->d()Ljava/lang/CharSequence;
...
.method protected final onMeasure(II)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lkj;
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {v0, p0, v1}, Lix;-><init>(Landroid/support/v7/widget/AppCompatSpinner;I)V
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lkj;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Lli;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lli;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public final setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-direct {v2, p1, v0}, Lkh;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    invoke-interface {v1, v2}, Lkj;->e(Landroid/widget/ListAdapter;)V
...
.method public final setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lkj;->h(I)V

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:Lkj;

    .line 2
    invoke-interface {v0, p1}, Lkj;->g(I)V
...
.method public final setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lkj;->j(I)V
...
.method public final setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Lkj;->f(Landroid/graphics/drawable/Drawable;)V
...
.method public final setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Lkj;->i(Ljava/lang/CharSequence;)V
