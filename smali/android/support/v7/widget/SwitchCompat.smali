...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lod;-><init>(Ljava/lang/Class;)V

    sput-object v0, Landroid/support/v7/widget/SwitchCompat;->g:Landroid/util/Property;
    ...
    sput-object v0, Landroid/support/v7/widget/SwitchCompat;->h:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p0, v2}, Loe;->d(Landroid/view/View;Landroid/content/Context;)V
    ...
    .line 10
    sget-object v4, Lfz;->v:[I

    invoke-static {p1, p2, v4, p3, v1}, Lkxa;->W(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lkxa;

    move-result-object v4

    sget-object v7, Lfz;->v:[I

    iget-object v5, v4, Lkxa;->a:Ljava/lang/Object;
    ...
    .line 11
    invoke-static/range {v5 .. v11}, Labl;->K(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    const/4 v5, 0x2

    .line 12
    invoke-virtual {v4, v5}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 14
    invoke-virtual {v4, v6}, Lkxa;->K(I)Landroid/graphics/drawable/Drawable;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    .line 16
    :cond_1
    invoke-virtual {v4, v1}, Lkxa;->M(I)Ljava/lang/CharSequence;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->c:Ljava/lang/CharSequence;

    .line 17
    invoke-virtual {v4, v3}, Lkxa;->M(I)Ljava/lang/CharSequence;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->d:Ljava/lang/CharSequence;

    const/4 v6, 0x3

    .line 18
    invoke-virtual {v4, v6, v3}, Lkxa;->P(IZ)Z
    ...
    .line 19
    invoke-virtual {v4, v7, v1}, Lkxa;->E(II)I
    ...
    .line 22
    invoke-virtual {v4, v7, v1}, Lkxa;->P(IZ)Z
    ...
    .line 23
    invoke-virtual {v4, v7}, Lkxa;->J(I)Landroid/content/res/ColorStateList;
    ...
    .line 24
    invoke-virtual {v4, v7, v8}, Lkxa;->F(II)I

    move-result v7

    .line 25
    invoke-static {v7, v0}, Llc;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/SwitchCompat;->a:Landroid/content/res/ColorStateList;
    ...
    iget-object v9, p0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/PorterDuff$Mode;

    if-eq v9, v7, :cond_a

    iput-object v7, p0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v3, p0, Landroid/support/v7/widget/SwitchCompat;->p:Z

    :cond_a
    iget-boolean v7, p0, Landroid/support/v7/widget/SwitchCompat;->b:Z
    ...
    .line 34
    invoke-virtual {v4, v7, v1}, Lkxa;->I(II)I

    move-result v7

    if-eqz v7, :cond_18

    sget-object v9, Lfz;->w:[I

    .line 35
    invoke-static {p1, v7, v9}, Lkxa;->U(Landroid/content/Context;I[I)Lkxa;

    move-result-object v7

    .line 36
    invoke-virtual {v7, v6}, Lkxa;->J(I)Landroid/content/res/ColorStateList;

    move-result-object v9

    if-eqz v9, :cond_d

    iput-object v9, p0, Landroid/support/v7/widget/SwitchCompat;->J:Landroid/content/res/ColorStateList;
    ...
    .line 38
    :goto_0
    invoke-virtual {v7, v1, v1}, Lkxa;->E(II)I
    ...
    .line 42
    :cond_e
    invoke-virtual {v7, v3, v8}, Lkxa;->F(II)I

    move-result v9

    .line 43
    invoke-virtual {v7, v5, v8}, Lkxa;->F(II)I
    ...
    .line 53
    invoke-virtual {v7, v2, v1}, Lkxa;->P(IZ)Z
    ...
    invoke-direct {v0, v1}, Lgq;-><init>(Landroid/content/Context;)V
    ...
    .line 55
    :goto_5
    invoke-virtual {v7}, Lkxa;->O()V

    :cond_18
    new-instance v0, Lkl;

    .line 56
    invoke-direct {v0, p0}, Lkl;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->N:Lkl;

    .line 57
    invoke-virtual {v0, p2, p3}, Lkl;->g(Landroid/util/AttributeSet;I)V

    .line 58
    invoke-virtual {v4}, Lkxa;->O()V
...
.method private final g()I
    ...
    iget v1, p0, Landroid/support/v7/widget/SwitchCompat;->e:F
    ...
    .line 2
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/SwitchCompat;->e:F
...
.method private final h()I
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {v0}, Llc;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final a()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/SwitchCompat;->b:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/PorterDuff$Mode;
...
.method public final b()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->d:Ljava/lang/CharSequence;
    ...
    .line 2
    :cond_0
    invoke-static {p0, v0}, Labl;->Z(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final c()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->c:Ljava/lang/CharSequence;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    .line 2
    invoke-static {v6}, Llc;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 3
    :cond_0
    sget-object v6, Llc;->a:Landroid/graphics/Rect;

    .line 2
    :goto_0
    iget-object v7, p0, Landroid/support/v7/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    iget-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
...
.method protected final drawableStateChanged()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
...
.method public final f(F)V
    ...
    .line 1
    iput p1, p0, Landroid/support/v7/widget/SwitchCompat;->e:F
...
.method public final jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->f:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->f:Landroid/animation/ObjectAnimator;
...
.method protected final onCreateDrawableState(I)[I
    ...
    sget-object v0, Landroid/support/v7/widget/SwitchCompat;->h:[I
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 7
    invoke-static {v4}, Llc;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SwitchCompat;->i:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    invoke-static {p3}, Llc;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iput p2, p0, Landroid/support/v7/widget/SwitchCompat;->F:I
...
.method public final onMeasure(II)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/SwitchCompat;->i:Landroid/graphics/drawable/Drawable;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput v5, p0, Landroid/support/v7/widget/SwitchCompat;->v:I
    ...
    iget v7, p0, Landroid/support/v7/widget/SwitchCompat;->A:I
...
.method public final setChecked(Z)V
    ...
    :goto_1
    sget-object p1, Landroid/support/v7/widget/SwitchCompat;->g:Landroid/util/Property;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SwitchCompat;->f:Landroid/animation/ObjectAnimator;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/SwitchCompat;->f:Landroid/animation/ObjectAnimator;
