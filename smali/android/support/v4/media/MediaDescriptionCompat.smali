...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    .line 2
    invoke-static {p0}, Ldd;->i(Landroid/media/MediaDescription;)Ljava/lang/String;

    move-result-object v1

    .line 3
    invoke-static {p0}, Ldd;->h(Landroid/media/MediaDescription;)Ljava/lang/CharSequence;

    move-result-object v2

    .line 4
    invoke-static {p0}, Ldd;->oT(Landroid/media/MediaDescription;)Ljava/lang/CharSequence;

    move-result-object v3

    .line 5
    invoke-static {p0}, Ldd;->f(Landroid/media/MediaDescription;)Ljava/lang/CharSequence;

    move-result-object v4

    .line 6
    invoke-static {p0}, Ldd;->lP(Landroid/media/MediaDescription;)Landroid/graphics/Bitmap;

    move-result-object v5

    .line 7
    invoke-static {p0}, Ldd;->d(Landroid/media/MediaDescription;)Landroid/net/Uri;

    move-result-object v6

    .line 8
    invoke-static {p0}, Ldd;->e(Landroid/media/MediaDescription;)Landroid/os/Bundle;
    ...
    .line 9
    invoke-static {v7}, Lea;->a(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 14
    invoke-static {p0}, Lde;->a(Landroid/media/MediaDescription;)Landroid/net/Uri;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {}, Ldd;->lQ()Landroid/media/MediaDescription$Builder;
    ...
    .line 2
    invoke-static {v0, v1}, Ldd;->oW(Landroid/media/MediaDescription$Builder;Ljava/lang/String;)V

    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->a:Ljava/lang/CharSequence;

    .line 3
    invoke-static {v0, v1}, Ldd;->p(Landroid/media/MediaDescription$Builder;Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->b:Ljava/lang/CharSequence;

    .line 4
    invoke-static {v0, v1}, Ldd;->oX(Landroid/media/MediaDescription$Builder;Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->f:Ljava/lang/CharSequence;

    .line 5
    invoke-static {v0, v1}, Ldd;->oU(Landroid/media/MediaDescription$Builder;Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->c:Landroid/graphics/Bitmap;

    .line 6
    invoke-static {v0, v1}, Ldd;->l(Landroid/media/MediaDescription$Builder;Landroid/graphics/Bitmap;)V

    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->d:Landroid/net/Uri;

    .line 7
    invoke-static {v0, v1}, Ldd;->oV(Landroid/media/MediaDescription$Builder;Landroid/net/Uri;)V

    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->g:Landroid/os/Bundle;

    .line 8
    invoke-static {v0, v1}, Ldd;->k(Landroid/media/MediaDescription$Builder;Landroid/os/Bundle;)V

    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->h:Landroid/net/Uri;

    .line 9
    invoke-static {v0, v1}, Lde;->b(Landroid/media/MediaDescription$Builder;Landroid/net/Uri;)V

    .line 10
    invoke-static {v0}, Ldd;->c(Landroid/media/MediaDescription$Builder;)Landroid/media/MediaDescription;
