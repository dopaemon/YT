...
.field private final d:Lacuq;

.field private final e:I

.field private final f:Ladci;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lacur;->a:[B

    return-void
.end method

.method public constructor <init>(Ljava/security/interfaces/ECPublicKey;[BLjava/lang/String;ILacuq;)V
    .locals 1

    .line 1
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-static {p1}, Ladfe;->X(Ljava/security/interfaces/ECPublicKey;)V

    new-instance v0, Ladci;

    invoke-direct {v0, p1}, Ladci;-><init>(Ljava/security/interfaces/ECPublicKey;)V

    iput-object v0, p0, Lacur;->f:Ladci;

    iput-object p2, p0, Lacur;->c:[B

    iput-object p3, p0, Lacur;->b:Ljava/lang/String;

    iput p4, p0, Lacur;->e:I

    iput-object p5, p0, Lacur;->d:Lacuq;
...
.method public final a([B[B)[B
    ...
    iget-object v2, v1, Lacur;->f:Ladci;

    iget-object v3, v1, Lacur;->b:Ljava/lang/String;

    iget-object v4, v1, Lacur;->c:[B

    iget-object v5, v1, Lacur;->d:Lacuq;

    check-cast v5, Lacqc;

    .line 1
    iget v5, v5, Lacqc;->b:I

    iget v6, v1, Lacur;->e:I

    iget-object v7, v2, Ladci;->a:Ljava/lang/Object;

    invoke-interface {v7}, Ljava/security/interfaces/ECPublicKey;->getParams()Ljava/security/spec/ECParameterSpec;

    move-result-object v7

    invoke-static {v7}, Ladfe;->V(Ljava/security/spec/ECParameterSpec;)Ljava/security/KeyPair;
    ...
    invoke-static {v2, v9}, Ladfe;->W(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    .line 16
    sget-object v2, Lacuz;->g:Lacuz;

    const-string v9, "EC"

    invoke-virtual {v2, v9}, Lacuz;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-object v9, Lacuz;->e:Lacuz;

    const-string v10, "ECDH"

    .line 18
    invoke-virtual {v9, v10}, Lacuz;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v7}, Ladfe;->U(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;
    ...
    .line 60
    invoke-static {v7, v0}, Ladfe;->W(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V

    .line 61
    invoke-static {v0}, Ladfe;->T(Ljava/security/spec/EllipticCurve;)I
    ...
    sget-object v2, Lacuz;->b:Lacuz;

    .line 82
    invoke-virtual {v2, v3}, Lacuz;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 97
    invoke-static {v9}, Ladci;->S([B)Ladci;

    move-result-object v0

    .line 98
    invoke-static {v4}, Ladci;->S([B)Ladci;

    move-result-object v2

    iget-object v3, v1, Lacur;->d:Lacuq;
    ...
    iget v5, v3, Lacqc;->b:I

    if-ne v4, v5, :cond_1c

    .line 101
    iget-object v4, v3, Lacqc;->a:Ljava/lang/String;

    .line 102
    sget-object v5, Lacny;->b:Ljava/lang/String;
    ...
    iget-object v5, v3, Lacqc;->c:Lacrk;

    .line 105
    invoke-virtual {v4, v5}, Ladox;->mergeFrom(Ladpf;)Ladox;
    ...
    .line 106
    invoke-static {v2, v6, v5}, Ladnz;->y([BII)Ladnz;
    ...
    iput-object v2, v5, Lacrk;->c:Ladnz;
    ...
    iget-object v3, v3, Lacqc;->a:Ljava/lang/String;

    const-class v4, Lacna;

    .line 110
    invoke-static {v3, v2, v4}, Lacnw;->e(Ljava/lang/String;Ladqq;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    sget-object v5, Lacny;->a:Ljava/lang/String;
    ...
    iget v5, v3, Lacqc;->e:I

    iget v6, v3, Lacqc;->b:I
    ...
    iget-object v6, v3, Lacqc;->d:Lacrc;

    iget-object v6, v6, Lacrc;->c:Lacre;

    if-nez v6, :cond_16

    sget-object v6, Lacre;->a:Lacre;

    .line 117
    :cond_16
    invoke-virtual {v5, v6}, Ladox;->mergeFrom(Ladpf;)Ladox;
    ...
    iput-object v4, v6, Lacre;->d:Ladnz;
    ...
    iget-object v6, v6, Lacrc;->d:Lacsf;

    if-nez v6, :cond_17

    sget-object v6, Lacsf;->a:Lacsf;
    ...
    iput-object v2, v6, Lacsf;->d:Ladnz;
    ...
    iput-object v4, v6, Lacrc;->c:Lacre;
    ...
    iput-object v2, v4, Lacrc;->d:Lacsf;
    ...
    .line 141
    sget-object v5, Lacpr;->a:Ljava/lang/String;
    ...
    iget-object v5, v3, Lacqc;->f:Lacro;
    ...
    iput-object v2, v5, Lacro;->c:Ladnz;
    ...
    .line 151
    invoke-interface {v2, v5, v4}, Lacna;->a([B[B)[B
    ...
    .line 152
    invoke-interface {v3, v5, v4}, Lacnd;->a([B[B)[B
