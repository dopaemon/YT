...
.field private static b:Ladig;


# instance fields
.field private c:I

.field private final d:Ladih;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ladig;->e:Landroid/content/Context;

    new-instance v0, Ladih;

    invoke-direct {v0, p1}, Ladih;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Ladig;->d:Ladih;
    ...
    iput p1, p0, Ladig;->c:I

    sget-object p1, Ladig;->a:Lacby;
    ...
    invoke-interface {p1, v1, v3, v4, v5}, Lacbw;->i(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Laccn;
    ...
    iget v3, p0, Ladig;->c:I

    invoke-interface {p1, v1, v3}, Lacbw;->r(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    .line 5
    iget p1, p0, Ladig;->c:I

    .line 6
    invoke-virtual {v0}, Ladih;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 6
    invoke-static {v0, p1, v1}, Ladih;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)V
...
.method public static declared-synchronized a()Ladig;
    .locals 2
...
.method public static declared-synchronized c(Landroid/content/Context;)V
    ...
    .line 2
    invoke-direct {v1, p0}, Ladig;-><init>(Landroid/content/Context;)V

    sput-object v1, Ladig;->b:Ladig;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized b(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Ladig;->e:Landroid/content/Context;
    ...
    iget-object v2, p0, Ladig;->e:Landroid/content/Context;
    ...
    iget v1, p0, Ladig;->c:I

    if-eqz v1, :cond_1

    iget-object v5, p0, Ladig;->d:Ladih;

    .line 8
    invoke-virtual {v5}, Ladih;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v5, v6, v8, v7}, Ladih;->a(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :try_start_5
    iget v0, p0, Ladig;->c:I

    if-eqz v0, :cond_3

    iget-object v0, p0, Ladig;->d:Ladih;
    ...
    invoke-static {v0, v2, v7}, Ladih;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-interface {v2, v3, p1}, Lacbw;->s(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_8
...
.method public final declared-synchronized d()V
    ...
    invoke-interface {v0, v2, v1}, Lacbw;->s(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 6
    :cond_0
    invoke-virtual {p0, v4}, Ladig;->b(Ljava/lang/String;)Ljava/lang/String;
    :try_end_2
