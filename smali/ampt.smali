...
.method public constructor <init>(Landroid/content/Context;Lamps;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/google/vr/ndk/base/GvrSurfaceView;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lampt;->a:Lamps;

    .line 2
    new-instance p1, Lampw;

    invoke-direct {p1}, Lampw;-><init>()V

    iput-object p1, p0, Lampt;->e:Lampw;
...
.method protected final onAttachedToWindow()V
    ...
    iput-boolean v0, p0, Lampt;->c:Z

    iget-object v1, p0, Lampt;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v0, p0, Lampt;->d:Ljava/util/ArrayList;
...
.method protected final onDetachedFromWindow()V
    ...
    .line 1
    iget-boolean v0, p0, Lampt;->b:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lampt;->a:Lamps;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lamps;->onSurfaceViewDetachedFromWindow()V
...
.method public final queueEvent(Ljava/lang/Runnable;)V
    ...
    iput-object v0, p0, Lampt;->d:Ljava/util/ArrayList;
...
.method public final setEGLContextClientVersion(I)V
    ...
    iget-object v0, p0, Lampt;->e:Lampw;

    iput p1, v0, Lampw;->e:I
