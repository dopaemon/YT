...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Ladbr;->e:Ljava/lang/String;

    iput-object v0, p0, Ladbr;->a:Ljava/lang/Boolean;

    iput-object v0, p0, Ladbr;->b:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Ladbr;->c:Ljava/util/Queue;

    return-void
.end method

.method public static declared-synchronized a()Ladbr;
    .locals 2

    const-class v0, Ladbr;

    monitor-enter v0

    .line 1
    :try_start_0
    sget-object v1, Ladbr;->d:Ladbr;

    if-nez v1, :cond_0

    new-instance v1, Ladbr;

    invoke-direct {v1}, Ladbr;-><init>()V

    sput-object v1, Ladbr;->d:Ladbr;
...
.method public final declared-synchronized b(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Ladbr;->e:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    iput-object p1, p0, Ladbr;->e:Ljava/lang/String;
    ...
    .line 8
    :goto_1
    iget-object p1, p0, Ladbr;->e:Ljava/lang/String;
    :try_end_1
...
.method final c(Landroid/content/Context;)Z
    ...
    .line 1
    iget-object v0, p0, Ladbr;->a:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Ladbr;->a:Ljava/lang/Boolean;

    :cond_1
    iget-object p1, p0, Ladbr;->a:Ljava/lang/Boolean;
