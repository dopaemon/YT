...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ladba;->a:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method static a(Ladci;)Z
    .locals 1

    const-string v0, "google.c.a.e"

    .line 1
    invoke-virtual {p0, v0}, Ladci;->I(Ljava/lang/String;)Z
...
.method public static b(Landroid/content/Context;Ladci;)Ladqw;
    .locals 20
    ...
    .line 7
    invoke-virtual {v2, v0}, Ladci;->F(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 28
    invoke-direct {v12, v1, v0}, Lwn;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    const-string v0, "gcm.n.title"

    .line 29
    invoke-virtual {v2, v9, v8, v0}, Ladci;->E(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 31
    invoke-virtual {v12, v0}, Lwn;->k(Ljava/lang/CharSequence;)V
    ...
    .line 34
    invoke-virtual {v12, v0}, Lwn;->j(Ljava/lang/CharSequence;)V
    ...
    .line 35
    invoke-virtual {v14, v0}, Lwm;->c(Ljava/lang/CharSequence;)V

    invoke-virtual {v12, v14}, Lwn;->s(Lwp;)V
    ...
    .line 39
    invoke-static {v9, v14}, Ladba;->e(Landroid/content/res/Resources;I)Z
    ...
    .line 48
    :goto_7
    invoke-virtual {v12, v15}, Lwn;->r(I)V
    ...
    .line 52
    iget-object v9, v12, Lwn;->I:Landroid/app/Notification;

    .line 57
    iput-object v0, v9, Landroid/app/Notification;->sound:Landroid/net/Uri;

    iget-object v0, v12, Lwn;->I:Landroid/app/Notification;
    ...
    .line 60
    invoke-virtual {v9, v15}, Landroid/media/AudioAttributes$Builder;->setContentType(I)Landroid/media/AudioAttributes$Builder;
    ...
    .line 61
    invoke-virtual {v9, v15}, Landroid/media/AudioAttributes$Builder;->setUsage(I)Landroid/media/AudioAttributes$Builder;
    ...
    iget-object v10, v2, Ladci;->a:Ljava/lang/Object;
    ...
    .line 86
    invoke-static/range {p1 .. p1}, Ladba;->a(Ladci;)Z
    ...
    .line 87
    invoke-virtual/range {p1 .. p1}, Ladci;->B()Landroid/os/Bundle;
    ...
    .line 88
    :cond_1e
    invoke-static {}, Ladba;->c()I

    move-result v8

    .line 89
    invoke-static {v1, v8, v9, v0}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v8

    .line 77
    :goto_c
    iput-object v8, v12, Lwn;->g:Landroid/app/PendingIntent;
    ...
    const-string v13, "com.google.firebase.MESSAGING_EVENT"

    invoke-direct {v10, v13}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    new-instance v13, Landroid/content/ComponentName;

    const-string v15, "com.google.firebase.iid.FirebaseInstanceIdReceiver"

    invoke-direct {v13, v1, v15}, Landroid/content/ComponentName;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v13, "wrapped_intent"

    .line 95
    invoke-virtual {v10, v13, v8}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    move-result-object v8

    .line 96
    invoke-static {v1, v9, v8, v0}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    .line 97
    invoke-virtual {v12, v0}, Lwn;->m(Landroid/app/PendingIntent;)V
    ...
    invoke-static {v1, v0, v7}, Ladba;->d(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    .line 100
    invoke-virtual {v2, v0}, Ladci;->I(Ljava/lang/String;)Z
    ...
    .line 101
    invoke-virtual {v12, v0}, Lwn;->g(Z)V
    ...
    .line 104
    invoke-virtual {v12, v0}, Lwn;->u(Ljava/lang/CharSequence;)V

    :cond_22
    const-string v0, "gcm.n.notification_priority"

    .line 105
    invoke-virtual {v2, v0}, Ladci;->C(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 121
    :catch_3
    invoke-static {v0}, Ladci;->G(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v12, v5, v6}, Lwn;->w(J)V

    :cond_2f
    const-string v0, "gcm.n.vibrate_timings"

    .line 124
    invoke-virtual {v2, v0}, Ladci;->H(Ljava/lang/String;)Lorg/json/JSONArray;
    ...
    .line 130
    invoke-virtual {v12, v6}, Lwn;->v([J)V
    ...
    iget-object v6, v12, Lwn;->I:Landroid/app/Notification;
    ...
    .line 149
    invoke-virtual {v2, v1}, Ladci;->I(Ljava/lang/String;)Z
    ...
    .line 151
    :cond_3a
    invoke-virtual {v12, v0}, Lwn;->l(I)V
    ...
    .line 152
    invoke-virtual {v2, v1}, Ladci;->F(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3b
    invoke-direct {v0, v12, v1}, Ladqw;-><init>(Lwn;Ljava/lang/String;)V
...
.method private static c()I
    ...
    .line 1
    sget-object v0, Ladba;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private static d(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    .line 5
    :try_start_1
    invoke-static {p0, p1}, Lxc;->a(Landroid/content/Context;I)I
