...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laory;->c:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Laorr;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Laory;->b:Laorr;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Laory;->d:Ljava/util/concurrent/atomic/AtomicReference;

    .line 2
    invoke-static {v0}, Laorw;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final a()Lanul;
    ...
    iget-object v1, p0, Laory;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Laorx;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lanva;
    ...
    :try_start_0
    iget-object p1, p0, Laory;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lanva;
    ...
    iget-object p4, p0, Laory;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 3
    new-instance p5, Laorj;

    invoke-direct {p5, p1, p4}, Laorj;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 6
    :goto_0
    invoke-virtual {p5, p1}, Laorj;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
