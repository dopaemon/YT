...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laanr;->a:Labwk;

    return-void
.end method

.method public constructor <init>(Lspi;Laadt;Laakw;Laadt;[B[B[B)V
    .locals 9

    .line 1
    sget-object v2, Lalcn;->t:Lalcn;
    ...
    iput-object v1, v0, Laanr;->b:Laadt;
...
.method private final s(Laamd;Z)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    iget-object v1, p1, Laamd;->an:Ljava/lang/String;
    ...
    :cond_4
    :goto_2
    iget-object v0, p0, Laanr;->d:Laadt;
    ...
    :cond_5
    sget-object v2, Laanr;->a:Labwk;

    iget-object v3, p0, Laanr;->b:Laadt;
    ...
    .line 14
    :cond_6
    iget-object p1, p0, Laanr;->d:Laadt;
...
.method public final c(Ljava/lang/String;Laajx;Laamd;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 1
    invoke-static {p3}, Laanu;->c(Laamd;)Z

    move-result p1

    if-eqz p1, :cond_0

    new-instance p1, Laajz;

    const/4 p2, 0x0

    invoke-direct {p1, p2}, Laajz;-><init>(I)V
    ...
    .line 3
    invoke-direct {p0, p3, p1}, Laanr;->s(Laamd;Z)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final d(Ljava/lang/String;Laajx;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 4
    invoke-direct {p0, p1, p2}, Laanr;->s(Laamd;Z)Lcom/google/common/util/concurrent/ListenableFuture;
