...
# instance fields
.field public final synthetic a:Labjl;

.field public final synthetic b:Z


# direct methods
.method public synthetic constructor <init>(Labjl;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Labjk;->a:Labjl;

    iput-boolean p2, p0, Labjk;->b:Z
...
.method public final a()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 1
    iget-object v0, p0, Labjk;->a:Labjl;

    iget-boolean v1, p0, Labjk;->b:Z

    const/4 v2, 0x0

    :try_start_0
    iget-object v3, v0, Labjl;->e:Laouj;
    ...
    .line 12
    :try_start_1
    invoke-static {v6}, Labjl;->b(Ljava/io/RandomAccessFile;)I
    ...
    .line 13
    :try_start_3
    invoke-static {v6, v3}, Labjl;->d(Ljava/io/RandomAccessFile;I)V

    new-instance v3, Lmez;

    const/4 v5, 0x3

    invoke-direct {v3, v0, v6, v4, v5}, Lmez;-><init>(Labjl;Ljava/io/RandomAccessFile;II)V
    :try_end_3
    ...
    :cond_2
    iget-object v4, v0, Labjl;->d:Lamxz;
    ...
    iget-object v5, v0, Labjl;->c:Lacmg;

    .line 19
    invoke-static {v3}, Labnx;->g(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Callable;

    move-result-object v3

    invoke-interface {v5, v3}, Lacmg;->qt(Ljava/util/concurrent/Callable;)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object v3

    invoke-virtual {v4, v3}, Labhm;->c(Lcom/google/common/util/concurrent/ListenableFuture;)V
    ...
    iget-object v1, v0, Labjl;->a:Landroid/content/Context;
    ...
    invoke-direct {v3, v0, v4}, Lcom/google/android/youtube/api/jar/client/c;-><init>(Labjl;I)V

    .line 24
    invoke-static {v1, v3}, Lmzq;->b(Landroid/content/Context;Ljava/lang/Runnable;)V
