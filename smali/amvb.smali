...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lamvb;->a:Ljava/util/logging/Logger;
    ...
    sput-object v0, Lamvb;->b:Ljava/util/Map;
    ...
    const-class v1, Lamuv;

    .line 4
    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v1, Lamvd;

    .line 5
    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v1, Lamus;
    ...
    const-class v1, Lamva;

    .line 8
    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v1, Lamvc;

    .line 9
    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v1, Lamur;

    .line 10
    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v1, Lamuz;

    .line 11
    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v1, Lamux;

    .line 12
    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v1, Lamuu;
    ...
    .line 16
    invoke-interface {v2}, Lamuw;->b()[I

    move-result-object v3

    .line 17
    invoke-interface {v2}, Lamuw;->a()I

    move-result v2

    sget-object v4, Lamvb;->b:Ljava/util/Map;
    ...
    :cond_1
    sget-object v1, Lamvb;->b:Ljava/util/Map;
...
.method public static a(ILjava/nio/ByteBuffer;)Lamus;
    .locals 10
    ...
    sget-object v3, Lamvb;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v3}, Lamve;-><init>()V

    :goto_1
    iput v0, v3, Lamus;->T:I
    ...
    iput v2, v3, Lamus;->U:I

    goto :goto_2

    :cond_3
    iput v1, v3, Lamus;->V:I
    ...
    iget v0, v3, Lamus;->U:I

    .line 15
    invoke-virtual {p0, v0}, Ljava/nio/ByteBuffer;->limit(I)Ljava/nio/Buffer;

    .line 16
    invoke-virtual {v3, p0}, Lamus;->a(Ljava/nio/ByteBuffer;)V
