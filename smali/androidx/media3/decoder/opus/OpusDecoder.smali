...
.method public constructor <init>(ILjava/util/List;Landroidx/media3/decoder/CryptoConfig;Z)V
    ...
    .line 3
    iput-object v1, v7, Landroidx/media3/decoder/opus/OpusDecoder;->c:Landroidx/media3/decoder/CryptoConfig;
    ...
    .line 32
    invoke-direct {v0, v1}, Lapx;-><init>(Ljava/lang/String;)V
    ...
    .line 23
    invoke-static {v0, v3, v12, v13, v10}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    .line 26
    invoke-virtual/range {p0 .. p1}, Lapr;->o(I)V
    ...
    .line 20
    invoke-direct {v0, v3}, Lapx;-><init>(Ljava/lang/String;)V
...
.method protected final bridge synthetic g(Ljava/lang/Throwable;)Lapl;
    ...
    invoke-direct {v0, v1, p1}, Lapx;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected final bridge synthetic h(Lapn;Lapp;Z)Lapl;
    ...
    check-cast v14, Landroidx/media3/decoder/SimpleDecoderOutputBuffer;
    ...
    .line 4
    :cond_1
    iget-object v5, v0, Lapn;->c:Ljava/nio/ByteBuffer;

    sget v1, Lang;->a:I

    .line 5
    iget-object v1, v0, Lapn;->b:Lapj;

    .line 6
    invoke-virtual/range {p1 .. p1}, Lapn;->d()Z
    ...
    iget-object v10, v15, Landroidx/media3/decoder/opus/OpusDecoder;->c:Landroidx/media3/decoder/CryptoConfig;

    iget v11, v1, Lapj;->c:I

    iget-object v0, v1, Lapj;->b:[B
    ...
    iget-object v0, v1, Lapj;->d:[I

    iget-object v1, v1, Lapj;->e:[I
    ...
    invoke-direct {v1, v0}, Lapi;-><init>(Ljava/lang/String;)V

    new-instance v2, Lapx;

    .line 15
    invoke-direct {v2, v0, v1}, Lapx;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_3
    invoke-direct {v1, v0}, Lapx;-><init>(Ljava/lang/String;)V
    ...
    .line 17
    iget-object v3, v2, Landroidx/media3/decoder/SimpleDecoderOutputBuffer;->data:Ljava/nio/ByteBuffer;
    ...
    .line 21
    invoke-virtual {v2, v4}, Laph;->addFlag(I)V
...
.method protected final bridge synthetic k()Lapp;
    ...
    invoke-direct {v1, p0, v2}, Lapw;-><init>(Landroidx/media3/decoder/opus/OpusDecoder;I)V

    invoke-direct {v0, v1}, Landroidx/media3/decoder/SimpleDecoderOutputBuffer;-><init>(Lapo;)V
