...
.method private final addListener(Ljava/util/concurrent/Executor;Lzk;Lapcd;)V
    .locals 4
    ...
    .line 4
    invoke-direct {v2, p3, p2, v3}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lapcd;Lzk;Laovg;)V

    invoke-static {p1, v2}, Laoxi;->g(Laozt;Laowq;)Lapal;
...
.method private final removeListener(Lzk;)V
    .locals 2
...
# virtual methods
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lzk;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroidx/window/layout/WindowInfoTracker;->windowLayoutInfo(Landroid/app/Activity;)Lapcd;

    move-result-object p1

    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Lzk;Lapcd;)V

    return-void
.end method

.method public final removeWindowLayoutInfoListener(Lzk;)V
    .locals 0

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 1
    invoke-direct {p0, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->removeListener(Lzk;)V
