...
.method public static b(Ljava/io/File;)J
    ...
    .line 16
    invoke-virtual {v0, v10, v11, v7}, Ljava/io/RandomAccessFile;->read([BII)I
    ...
    .line 17
    invoke-virtual {p0, v10, v11, v7}, Ljava/util/zip/CRC32;->update([BII)V
...
.method public static d(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    invoke-direct {v0, v6, v7}, Lstl;-><init>(Ljava/lang/String;I)V
    ...
    .line 15
    invoke-direct {v14, v1, v0}, Lau;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    .line 34
    :try_start_4
    invoke-static {v15}, Lav;->e(Ljava/io/Closeable;)V
    ...
    .line 36
    :try_start_5
    invoke-static {v14}, Lav;->b(Ljava/io/File;)J

    move-result-wide v0

    iput-wide v0, v14, Lau;->a:J
    :try_end_5
    ...
    invoke-virtual {v14}, Lau;->getAbsolutePath()Ljava/lang/String;
    ...
    .line 39
    invoke-virtual {v14}, Lau;->length()J

    if-nez v15, :cond_4

    .line 40
    invoke-virtual {v14}, Lau;->delete()Z

    .line 41
    invoke-virtual {v14}, Lau;->exists()Z
    ...
    .line 43
    invoke-virtual {v14}, Lau;->getPath()Ljava/lang/String;
...
.method public static f(Landroid/content/Context;JJLjava/util/List;)V
    ...
    .line 1
    invoke-static {p0}, Lav;->c(Landroid/content/Context;)Landroid/content/SharedPreferences;
