...
.method public constructor <init>(Lacwz;Laczw;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ladad;Ladad;Ladah;)V
    .locals 8
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->g:Ljava/util/List;

    .line 2
    invoke-static {p1}, Laczw;->e(Lacwz;)Ljava/lang/String;
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/FirebaseInstanceId;->i:Labnl;
    ...
    invoke-direct {v1, v2, v3}, Labnl;-><init>(Landroid/content/Context;[B)V

    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceId;->i:Labnl;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->c:Lacwz;

    iput-object p2, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->d:Laczw;
    ...
    invoke-direct {v4, v1}, Llkr;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v7}, Laczv;-><init>(Lacwz;Laczw;Llkr;Ladad;Ladad;Ladah;)V

    iput-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->e:Laczv;

    iput-object p4, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->b:Ljava/util/concurrent/Executor;

    new-instance p1, Ladar;

    invoke-direct {p1, p3}, Ladar;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->h:Ladar;

    iput-object p7, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->f:Ladah;
...
.method public static g(Lacwz;)V
    .locals 2
    ...
    iget-object p0, p0, Lacxd;->a:Ljava/lang/String;
    ...
    .line 12
    invoke-static {p0, v0}, Lmio;->bp(ZLjava/lang/Object;)V

    return-void
.end method

.method public static getInstance(Lacwz;)Lcom/google/firebase/iid/FirebaseInstanceId;
    .locals 1

    .line 1
    invoke-static {p0}, Lcom/google/firebase/iid/FirebaseInstanceId;->g(Lacwz;)V
...
.method private final n(Lmhv;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-static {p1, v0, v1, v2}, Lmio;->f(Lmhv;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method public final a(Ljava/lang/String;Ljava/lang/String;)Lmhv;
    ...
    invoke-direct {v2, p0, p1, p2}, Laczt;-><init>(Lcom/google/firebase/iid/FirebaseInstanceId;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b()Ladaa;
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->c:Lacwz;

    invoke-static {v0}, Laczw;->e(Lacwz;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "*"

    invoke-virtual {p0, v0, v1}, Lcom/google/firebase/iid/FirebaseInstanceId;->c(Ljava/lang/String;Ljava/lang/String;)Ladaa;
...
.method public final c(Ljava/lang/String;Ljava/lang/String;)Ladaa;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1, p2}, Labnl;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ladaa;
...
.method public final e()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/firebase/iid/FirebaseInstanceId;->g(Lacwz;)V

    .line 2
    invoke-virtual {p0}, Lcom/google/firebase/iid/FirebaseInstanceId;->b()Ladaa;

    move-result-object v0

    .line 3
    invoke-virtual {p0, v0}, Lcom/google/firebase/iid/FirebaseInstanceId;->l(Ladaa;)Z
    ...
    .line 5
    :cond_0
    invoke-static {v0}, Ladaa;->c(Ladaa;)Ljava/lang/String;
...
.method public final f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 4
    invoke-virtual {p0, p1, p2}, Lcom/google/firebase/iid/FirebaseInstanceId;->a(Ljava/lang/String;Ljava/lang/String;)Lmhv;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/google/firebase/iid/FirebaseInstanceId;->n(Lmhv;)Ljava/lang/Object;
...
.method public final declared-synchronized k(J)V
    ...
    .line 2
    invoke-direct {v2, p0, v0, v1, v3}, Ladbu;-><init>(Lcom/google/firebase/iid/FirebaseInstanceId;JI)V
...
.method public final l(Ladaa;)Z
    .locals 7

    if-eqz p1, :cond_1

    .line 1
    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->d:Laczw;
    ...
    iget-wide v3, p1, Ladaa;->d:J

    sget-wide v5, Ladaa;->a:J
    ...
    iget-object p1, p1, Ladaa;->c:Ljava/lang/String;
