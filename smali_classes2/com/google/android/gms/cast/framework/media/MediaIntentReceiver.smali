...
.method private static getRemoteMediaClient(Llfe;)Llid;
    .locals 1

    if-eqz p0, :cond_1

    .line 1
    invoke-virtual {p0}, Llga;->o()Z
...
.method private seek(Llfe;J)V
    ...
    .line 1
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->getRemoteMediaClient(Llfe;)Llid;
    ...
    .line 4
    :cond_1
    invoke-virtual {p1}, Llid;->c()J

    move-result-wide v0

    add-long/2addr v0, p2

    invoke-static {v0, v1}, Llhk;->d(J)Ller;

    move-result-object p2

    .line 5
    invoke-virtual {p1, p2}, Llid;->t(Ller;)V
...
.method private togglePlayback(Llfe;)V
    .locals 0
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 2
    :cond_0
    invoke-static {p1}, Llfa;->b(Landroid/content/Context;)Llfa;

    move-result-object v1

    invoke-virtual {v1}, Llfa;->d()Llgb;

    move-result-object v1

    .line 3
    invoke-virtual {v1}, Llgb;->b()Llga;
    ...
    .line 4
    :pswitch_0
    invoke-virtual {p0, v2, p2}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->onReceiveActionMediaButton(Llga;Landroid/content/Intent;)V

    return-void

    .line 5
    :pswitch_1
    invoke-virtual {v1, v4}, Llgb;->d(Z)V

    return-void

    .line 6
    :pswitch_2
    invoke-virtual {v1, v5}, Llgb;->d(Z)V
    ...
    .line 8
    invoke-virtual {p0, v2, p1, p2}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->onReceiveActionRewind(Llga;J)V
    ...
    .line 10
    invoke-virtual {p0, v2, p1, p2}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->onReceiveActionForward(Llga;J)V

    return-void

    .line 11
    :pswitch_5
    invoke-virtual {p0, v2}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->onReceiveActionSkipPrev(Llga;)V

    return-void

    .line 12
    :pswitch_6
    invoke-virtual {p0, v2}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->onReceiveActionSkipNext(Llga;)V

    return-void

    .line 13
    :pswitch_7
    invoke-virtual {p0, v2}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->onReceiveActionTogglePlayback(Llga;)V
...
.method protected onReceiveActionForward(Llga;J)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->seek(Llfe;J)V

    :cond_0
    return-void
.end method

.method protected onReceiveActionMediaButton(Llga;Landroid/content/Intent;)V
    .locals 2
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/cast/framework/media/MediaIntentReceiver;->togglePlayback(Llfe;)V
...
.method protected onReceiveActionRewind(Llga;J)V
    .locals 1
...
.method protected onReceiveActionSkipNext(Llga;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Llho;-><init>(Llid;)V
...
.method protected onReceiveActionSkipPrev(Llga;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Llhn;-><init>(Llid;)V
...
.method protected onReceiveActionTogglePlayback(Llga;)V
    .locals 1
