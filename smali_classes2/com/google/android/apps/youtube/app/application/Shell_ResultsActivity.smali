...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0}, Ldzu;-><init>()V

    invoke-static {p0}, Lablz;->a(Landroid/app/Activity;)Lablz;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->n:Lablz;
...
.method private final o()Leae;
    .locals 1

    .line 1
    invoke-direct {p0}, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->p()V

    iget-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->m:Leae;
...
.method private final p()V
    ...
    .line 12
    instance-of v3, v2, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;
    ...
    check-cast v5, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;
    ...
    .line 16
    invoke-direct/range {v3 .. v10}, Leae;-><init>(Lgzw;Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;Laber;Lsuf;[B[B[B)V

    iput-object v1, p0, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->m:Leae;
    :try_end_2
...
.method public final applyOverrideConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Ldzu;->applyOverrideConfiguration(Landroid/content/res/Configuration;)V
...
.method protected final attachBaseContext(Landroid/content/Context;)V
    ...
    invoke-super {p0, p1}, Ldzu;->attachBaseContext(Landroid/content/Context;)V
...
.method protected final g()I
    ...
    .line 1
    invoke-direct {p0}, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->o()Leae;
...
.method public final getLifecycle()Lagz;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->q:Lahf;
    ...
    iput-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->q:Lahf;
...
.method public final invalidateOptionsMenu()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->invalidateOptionsMenu()V
    :try_end_0
...
.method protected final onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->n:Lablz;
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2, p3}, Ldzu;->onActivityResult(IILandroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onBackPressed()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onBackPressed()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Ldzu;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/youtube/app/application/Shell_ResultsActivity;->n:Lablz;
    ...
    .line 6
    invoke-super {p0, p1}, Ldzu;->onCreate(Landroid/os/Bundle;)V
...
.method public final onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2}, Ldzu;->onCreatePanelMenu(ILandroid/view/Menu;)Z
...
.method protected final onDestroy()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onDestroy()V
...
.method protected final onNewIntent(Landroid/content/Intent;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Ldzu;->onNewIntent(Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Ldzu;->onOptionsItemSelected(Landroid/view/MenuItem;)Z
...
.method protected final onPause()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onPause()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onPictureInPictureModeChanged(ZLandroid/content/res/Configuration;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2}, Ldzu;->onPictureInPictureModeChanged(ZLandroid/content/res/Configuration;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onPostCreate(Landroid/os/Bundle;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Ldzu;->onPostCreate(Landroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onPostResume()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onPostResume()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Ldzu;->onPrepareOptionsMenu(Landroid/view/Menu;)Z
...
.method public final onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1, p2, p3}, Ldzu;->onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onResume()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onResume()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 2
    :try_start_0
    invoke-super {p0, p1}, Ldzu;->onSaveInstanceState(Landroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected final onStart()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onStart()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onSupportNavigateUp()Z
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onSupportNavigateUp()Z
...
.method public final onUserInteraction()V
    ...
    .line 2
    :try_start_0
    invoke-super {p0}, Ldzu;->onUserInteraction()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
