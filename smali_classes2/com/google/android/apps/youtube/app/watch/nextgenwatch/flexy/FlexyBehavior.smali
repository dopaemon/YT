...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljwl;Ljwi;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->d:Ljwl;

    iput-object p3, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->e:Ljwi;

    new-instance p3, Ljwu;

    invoke-direct {p3, p0, p2}, Ljwu;-><init>(Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;Ljwl;)V

    iput-object p3, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->f:Ljwu;
...
.method private final u()I
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->e:Ljwi;

    invoke-interface {v0}, Ljwi;->a()I
...
.method private final x(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
    .locals 1
    ...
    invoke-direct {p0, p1}, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->x(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
...
.method public final i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;FFZ)Z
    ...
    .line 2
    invoke-direct {p0}, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->A()Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->d:Ljwl;
...
.method public final j(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;FF)Z
    ...
    .line 1
    :goto_0
    invoke-direct {p0, p2}, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->y(Z)V
...
.method public final l(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    .line 1
    invoke-direct {p0, p4}, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->x(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object p2, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->f:Ljwu;
    ...
    iget-object p4, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->e:Ljwi;

    .line 5
    invoke-interface {p4}, Ljwi;->e()Z
...
.method public final pA(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    iget-object p5, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->e:Ljwi;
    ...
    invoke-interface {p5, p6}, Ljwi;->d(I)V
    ...
    .line 8
    :cond_1
    invoke-direct {p0, p4}, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->y(Z)V
...
.method public final pB(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;IIIII[I)V
    ...
    iget-object p3, p0, Lcom/google/android/apps/youtube/app/watch/nextgenwatch/flexy/FlexyBehavior;->e:Ljwi;
    ...
    invoke-interface {p3, p4}, Ljwi;->d(I)V
