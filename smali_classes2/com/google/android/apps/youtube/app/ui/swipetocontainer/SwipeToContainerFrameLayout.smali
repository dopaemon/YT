...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Ljnh;-><init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->l:Lanuz;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    invoke-direct {p0, p1, p2}, Ljnh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 7
    invoke-direct {p0, p1, p2, p3}, Ljnh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p3, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->l:Lanuz;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 10
    invoke-direct {p0, p1, p2, p3, p4}, Ljnh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private final k(J)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->q:Ljnn;
    ...
    iput-object v1, v0, Ljnn;->a:Landroid/view/View;
    ...
    iget-object p1, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->f:Ljnm;
    ...
    .line 10
    invoke-interface {p1, p2, v0}, Ljnm;->r(IF)V
...
.method private final m(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget-object p1, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->j:Lspd;
    ...
    invoke-direct {p1, p2}, Lrwl;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->e:Lrwl;

    new-instance p1, Ljnn;

    invoke-direct {p1, p0}, Ljnn;-><init>(Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;)V

    iput-object p1, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->q:Ljnn;
...
.method private final p()Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->f:Ljnm;
    ...
    .line 1
    iget-object v2, v0, Ljnl;->a:Landroid/app/Activity;
    ...
    iget-object v3, v0, Ljnl;->f:Lfhy;

    .line 2
    invoke-interface {v3}, Lfhy;->H()Z
    ...
    .line 3
    invoke-interface {v3}, Lfhy;->d()Lcom/google/android/apps/youtube/app/common/ui/navigation/PaneDescriptor;
    ...
    invoke-virtual {v3}, Lcom/google/android/apps/youtube/app/common/ui/navigation/PaneDescriptor;->e()Laezv;

    move-result-object v3

    .line 5
    invoke-static {v3}, Lfft;->j(Laezv;)Ljava/lang/String;
    ...
    :goto_0
    iget-object v5, v0, Ljnl;->g:Lenf;

    .line 7
    invoke-interface {v5}, Lenf;->j()Lenv;
    ...
    :goto_2
    iget-boolean v6, v0, Ljnl;->n:Z

    if-eqz v6, :cond_6

    iget-object v6, v0, Ljnl;->q:Lggs;

    if-eqz v6, :cond_6

    iget-object v6, v6, Lggs;->ap:Lggt;

    check-cast v6, Lggr;

    iget-object v6, v6, Lggr;->a:Lgjj;

    check-cast v6, Lggs;

    invoke-virtual {v6}, Lggs;->ar()Z
    ...
    .line 9
    :cond_4
    invoke-virtual {v6}, Lggs;->E()Lch;

    move-result-object v6

    const v7, 0x7f0b0cd2

    invoke-virtual {v6, v7}, Lch;->e(I)Lbp;

    move-result-object v6

    .line 10
    instance-of v7, v6, Lghj;
    ...
    .line 13
    invoke-virtual {v6}, Lggo;->aW()Z

    move-result v7

    if-nez v7, :cond_3

    iget-boolean v6, v6, Lggo;->aj:Z
    ...
    .line 8
    :goto_4
    iget-object v7, v0, Ljnl;->m:Laezv;
...
.method protected final onAttachedToWindow()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->l:Lanuz;
    ...
    iget-object v1, p0, Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;->a:Lanuc;

    new-instance v2, Liys;

    const/16 v3, 0x11

    invoke-direct {v2, p0, v3}, Liys;-><init>(Lcom/google/android/apps/youtube/app/ui/swipetocontainer/SwipeToContainerFrameLayout;I)V
    ...
    .line 3
    :cond_0
    invoke-super {p0}, Ljnh;->onAttachedToWindow()V
...
.method protected final onDetachedFromWindow()V
    ...
    .line 2
    invoke-super {p0}, Ljnh;->onDetachedFromWindow()V
...
.method public final onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 9
    invoke-virtual {v0, p1}, Lrwl;->e(Landroid/view/MotionEvent;)V
    ...
    .line 10
    invoke-virtual {v0, p1, v3}, Lrwl;->c(Landroid/view/MotionEvent;I)I
...
.method protected final onLayout(ZIIII)V
    ...
    .line 1
    invoke-super/range {p0 .. p5}, Ljnh;->onLayout(ZIIII)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 2
    invoke-super {p0, p1}, Ljnh;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Ljnh;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1
    invoke-super {p0}, Ljnh;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 15
    :goto_2
    invoke-interface {p1, v0, v1}, Ljnm;->r(IF)V
...
.method public final onViewAdded(Landroid/view/View;)V
    ...
    .line 1
    invoke-super {p0, p1}, Ljnh;->onViewAdded(Landroid/view/View;)V
...
.method public final onViewRemoved(Landroid/view/View;)V
    ...
    .line 1
    invoke-super {p0, p1}, Ljnh;->onViewRemoved(Landroid/view/View;)V
...
.method public final requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-virtual {v0}, Lrwl;->f()V

    .line 2
    :cond_0
    invoke-super {p0, p1}, Ljnh;->requestDisallowInterceptTouchEvent(Z)V
