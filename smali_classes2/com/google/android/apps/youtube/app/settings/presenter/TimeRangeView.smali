...
.field public e:Lajxk;

.field public f:Labho;

.field public g:Labho;
...
.method public final a()I
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/settings/presenter/TimeRangeView;->f:Labho;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v0, v0, Labho;->b:I
...
.method public final b()I
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/settings/presenter/TimeRangeView;->g:Labho;
...
.method public final c(Lajxk;I)Z
    .locals 5
    ...
    iput-object p1, p0, Lcom/google/android/apps/youtube/app/settings/presenter/TimeRangeView;->e:Lajxk;

    invoke-static {p1}, Limx;->g(Lajxk;)Ljava/util/List;
    ...
    invoke-direct {v0, v3, p1, v2}, Labho;-><init>(Landroid/content/Context;Landroid/view/ViewStub;Lajxr;)V

    iput-object v0, p0, Lcom/google/android/apps/youtube/app/settings/presenter/TimeRangeView;->f:Labho;

    if-ltz p2, :cond_1

    new-instance p1, Lzob;

    invoke-direct {p1, p0, p2}, Lzob;-><init>(Lcom/google/android/apps/youtube/app/settings/presenter/TimeRangeView;I)V

    iget-object p2, v0, Labho;->d:Ljava/lang/Object;
    ...
    invoke-direct {p2, v0, p1, v2}, Labho;-><init>(Landroid/content/Context;Landroid/view/ViewStub;Lajxr;)V

    iput-object p2, p0, Lcom/google/android/apps/youtube/app/settings/presenter/TimeRangeView;->g:Labho;

    :cond_2
    return v1
.end method

.method public final d(Lajxk;)V
    .locals 3
    ...
    invoke-virtual {v0, p1, v1}, Labho;->b(Landroid/content/Context;Lajxr;)V

    :cond_1
    iget-object p1, p0, Lcom/google/android/apps/youtube/app/settings/presenter/TimeRangeView;->g:Labho;
    ...
    invoke-virtual {p1, v0, v1}, Labho;->b(Landroid/content/Context;Lajxr;)V
