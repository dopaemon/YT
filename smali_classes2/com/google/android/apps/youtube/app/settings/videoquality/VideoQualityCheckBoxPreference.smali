...
.method protected final ad()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/youtube/app/settings/videoquality/VideoQualityCheckBoxPreference;->c:Lbqj;

    if-eqz v1, :cond_0

    const v2, 0x1020001

    invoke-virtual {v1, v2}, Lbqj;->E(I)Landroid/view/View;
...
.method public final qG(Lbqj;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lcom/google/android/libraries/youtube/common/ui/preferences/ProtoDataStoreCheckBoxPreference;->qG(Lbqj;)V

    iput-object p1, p0, Lcom/google/android/apps/youtube/app/settings/videoquality/VideoQualityCheckBoxPreference;->c:Lbqj;
