...
.method private constructor <init>(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;)V
    ...
    .line 2
    invoke-static {p2, p1}, Labbm;->i(Ljava/lang/Object;Ljava/lang/Object;)V

    iput-object p2, p0, Lcom/google/android/apps/youtube/embeddedplayer/service/context/a;->b:Landroid/content/res/Resources;

    const-string p1, "theme cannot be null"

    .line 3
    invoke-static {p3, p1}, Labbm;->i(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;Ljava/lang/ClassLoader;Landroid/content/res/Resources$Theme;)Lcom/google/android/apps/youtube/embeddedplayer/service/context/a;
    .locals 1

    .line 1
    new-instance v0, Lcom/google/android/apps/youtube/embeddedplayer/service/context/a;

    invoke-direct {v0, p0, p1, p3}, Lcom/google/android/apps/youtube/embeddedplayer/service/context/a;-><init>(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;)V
    ...
    .line 4
    invoke-direct {p1, p2}, Lcom/google/android/apps/youtube/embeddedplayer/service/clientinfo/service/c;-><init>(Ljava/lang/ClassLoader;)V

    new-instance p2, Laac;

    const/4 p3, 0x0

    invoke-direct {p2, p1, p3}, Laac;-><init>(Lcom/google/android/apps/youtube/embeddedplayer/service/clientinfo/service/c;[B)V

    .line 5
    invoke-virtual {p0, p2}, Landroid/view/LayoutInflater;->setFactory2(Landroid/view/LayoutInflater$Factory2;)V

    iput-object p0, v0, Lcom/google/android/apps/youtube/embeddedplayer/service/context/a;->c:Landroid/view/LayoutInflater;
...
.method public final getResources()Landroid/content/res/Resources;
    ...
    iget-object v0, p0, Lcom/google/android/apps/youtube/embeddedplayer/service/context/a;->b:Landroid/content/res/Resources;
...
.method public final getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lcom/google/android/apps/youtube/embeddedplayer/service/context/a;->c:Landroid/view/LayoutInflater;
