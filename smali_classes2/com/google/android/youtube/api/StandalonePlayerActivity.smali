...
.field private h:Lkjs;

.field private i:Lkjt;
...
.method public final a(Lkia;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->g:Lkia;
    ...
    invoke-direct {v1, p0, v2}, Lgyf;-><init>(Lcom/google/android/youtube/api/StandalonePlayerActivity;I)V

    .line 2
    invoke-interface {p1, v0, v1}, Lkia;->f(Ljava/lang/String;Lwrg;)V
...
.method public final c()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->g:Lkia;

    iget-object v1, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->k:Ljava/lang/String;

    check-cast v0, Lkie;

    iput-object v1, v0, Lkie;->h:Ljava/lang/String;

    .line 2
    new-instance v0, Lkjs;

    iget-object v1, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->g:Lkia;

    new-instance v8, Lwjt;

    iget-object v2, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->g:Lkia;

    check-cast v2, Lkie;

    iget-object v2, v2, Lkie;->f:Lkhy;

    .line 3
    invoke-interface {v2}, Lkhy;->M()Labac;
    ...
    .line 4
    invoke-direct/range {v2 .. v7}, Lwjt;-><init>(Landroid/content/Context;Labac;[B[B[B)V

    invoke-direct {v0, p0, v1, v8}, Lkjs;-><init>(Landroid/app/Activity;Lkia;Lwjp;)V

    iput-object v0, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->h:Lkjs;

    const/4 v1, 0x1

    .line 5
    invoke-virtual {v0, v1}, Labdj;->ap(Z)V

    iget-object v0, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->b:Lcom/google/android/libraries/youtube/player/model/WatchDescriptor;

    iget-object v0, v0, Lcom/google/android/libraries/youtube/player/model/WatchDescriptor;->b:Ladox;
    ...
    iget-boolean v0, v0, Lklb;->d:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->h:Lkjs;

    new-instance v2, Labdr;

    .line 7
    invoke-direct {v2, p0}, Labdr;-><init>(Lcom/google/android/youtube/api/StandalonePlayerActivity;)V

    invoke-virtual {v0, v2}, Labdj;->ao(Labds;)V

    :cond_1
    iget-object v0, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->h:Lkjs;

    .line 8
    invoke-virtual {v0}, Labdj;->J()Labec;
    ...
    iget-object v5, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->h:Lkjs;
    ...
    .line 10
    invoke-direct/range {v2 .. v9}, Lkjt;-><init>(Landroid/app/Activity;Landroid/view/View;Lkjs;Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;ZZZ)V

    iput-object v0, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->i:Lkjt;

    .line 11
    invoke-virtual {v0}, Lkjt;->show()V
    ...
    .line 12
    invoke-virtual {v0, v2}, Labdj;->K(I)V
    ...
    .line 13
    :goto_0
    invoke-virtual {v0, v1}, Labdj;->am(Z)V
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    .line 20
    invoke-static {v4, v5, v6}, Llat;->n(Ljava/lang/String;J)Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;
    ...
    .line 25
    invoke-static {v4, v5, v6, v7}, Llat;->m(Ljava/lang/String;IJ)Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;
    ...
    .line 26
    :cond_2
    invoke-virtual {v1}, Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;->k()Ljava/util/List;
    ...
    .line 31
    invoke-static {v4, v5, v6, v7}, Llat;->o(Ljava/util/List;IJ)Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;
    ...
    .line 32
    invoke-static {v4}, Labbm;->k(Ljava/lang/String;)V
    ...
    .line 10
    invoke-static {v5, v6, v9, v10}, Llat;->o(Ljava/util/List;IJ)Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;
    ...
    .line 11
    invoke-static {v4, v6, v9, v10}, Llat;->m(Ljava/lang/String;IJ)Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;
    ...
    .line 12
    invoke-static {v1, v4, v5}, Llat;->n(Ljava/lang/String;J)Lcom/google/android/libraries/youtube/player/model/PlaybackStartDescriptor;
    ...
    iput-boolean v8, v1, Lyku;->d:Z

    xor-int/lit8 v4, v8, 0x1

    .line 15
    invoke-virtual {v1, v4}, Lyku;->b(Z)V
    ...
    .line 54
    invoke-static/range {v3 .. v11}, Lkie;->n(Lkif;Landroid/os/Handler;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZI)V
...
.method public final onDestroy()V
    ...
    invoke-virtual {v0, v1}, Labdj;->al(Z)V

    :cond_0
    iget-object v0, p0, Lcom/google/android/youtube/api/StandalonePlayerActivity;->i:Lkjt;

    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0}, Lkjt;->isShowing()Z
    ...
    .line 4
    invoke-virtual {v0}, Lkjt;->dismiss()V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Labdj;->aw(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Labdj;->ax(ILandroid/view/KeyEvent;)Z
