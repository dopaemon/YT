...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct {p0, p1, p2, p3}, Lrxb;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 4
    sget-object p3, Lrwy;->h:[I
...
.method public final addView(Landroid/view/View;)V
    ...
    .line 3
    invoke-super {p0, p1}, Lrxb;->addView(Landroid/view/View;)V
...
.method public final g(IIZ)V
    ...
    invoke-virtual {p0, p1, p2}, Lrxb;->b(II)V
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1}, Lrxb;->a(I)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1
    invoke-super {p0, p1}, Lrxb;->e(Landroid/view/MotionEvent;)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 7
    invoke-virtual {p0, v0, p1}, Lrxb;->b(II)V
...
.method protected final onScrollChanged(IIII)V
    ...
    .line 1
    invoke-super {p0, p1, p2, p3, p4}, Lrxb;->onScrollChanged(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 4
    invoke-virtual/range {p0 .. p0}, Lrxb;->getScrollY()I
    ...
    iget-object v3, v0, Lrxb;->f:Landroid/view/VelocityTracker;
    ...
    iput-object v3, v0, Lrxb;->f:Landroid/view/VelocityTracker;
    ...
    .line 10
    invoke-super/range {p0 .. p1}, Lrxb;->e(Landroid/view/MotionEvent;)Z
    ...
    .line 32
    iget-boolean v2, v0, Lrxb;->h:Z

    if-eqz v2, :cond_5

    iput-boolean v6, v0, Lrxb;->h:Z

    .line 11
    invoke-virtual/range {p0 .. p0}, Lrxb;->performClick()Z
    ...
    :cond_4
    iget-object v2, v0, Lrxb;->a:[F

    .line 12
    aget v2, v2, v7

    .line 13
    invoke-virtual/range {p0 .. p1}, Lrxb;->d(Landroid/view/MotionEvent;)V

    iget-object v3, v0, Lrxb;->a:[F
    ...
    invoke-virtual {v0, v8}, Lrxb;->a(I)V
    ...
    :cond_6
    iput-boolean v6, v0, Lrxb;->g:Z

    if-eq v2, v3, :cond_8

    .line 17
    invoke-virtual/range {p0 .. p0}, Lrxb;->getChildCount()I

    move-result v2

    if-lez v2, :cond_8

    iget-object v2, v0, Lrxb;->f:Landroid/view/VelocityTracker;
    ...
    .line 20
    invoke-virtual/range {p0 .. p0}, Lrxb;->getScrollX()I
    ...
    iget-object v8, v0, Lrxb;->j:Landroid/widget/Scroller;

    iget-object v3, v0, Lrxb;->b:[I
    ...
    .line 23
    invoke-virtual/range {p0 .. p0}, Lrxb;->invalidate()V
    ...
    iput-object v5, v0, Lrxb;->f:Landroid/view/VelocityTracker;
    ...
    .line 33
    invoke-virtual {v0, v1}, Lrxb;->c(I)V

    goto :goto_3

    .line 32
    :cond_e
    invoke-virtual {v0, v6}, Lrxb;->c(I)V
