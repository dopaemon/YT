...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2}, Laaqi;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 3
    sget-object v0, Laaqj;->f:[I
...
.method static final y(Ljava/util/List;)Lcom/google/android/material/appbar/AppBarLayout;
    .locals 4
...
.method public f(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    iget p1, p0, Laaqi;->f:I

    add-int/2addr v0, p1

    .line 6
    invoke-virtual {p0, p3}, Laaqi;->z(Landroid/view/View;)I
...
.method public bridge synthetic h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    .line 1
    invoke-super {p0, p1, p2, p3}, Laaqi;->h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
...
.method public final k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->y(Ljava/util/List;)Lcom/google/android/material/appbar/AppBarLayout;
...
.method public final o(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V
    ...
    .line 2
    sget-object p2, Lacg;->c:Lacg;

    invoke-virtual {p2}, Lacg;->a()I

    move-result p2

    invoke-static {p1, p2}, Labl;->I(Landroid/view/View;I)V

    sget-object p2, Lacg;->d:Lacg;
...
.method public final bridge synthetic p(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    .line 3
    invoke-virtual {p0, v2}, Laaqi;->x(Ljava/util/List;)Landroid/view/View;
    ...
    iget-object v1, p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lacb;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, v2}, Laaqi;->w(Landroid/view/View;)I
...
.method public final bridge synthetic x(Ljava/util/List;)Landroid/view/View;
    .locals 0

    .line 1
    invoke-static {p1}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->y(Ljava/util/List;)Lcom/google/android/material/appbar/AppBarLayout;
