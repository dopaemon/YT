...
.field public f:Lamrg;

.field public g:Lrzt;

.field private final j:I

.field private final k:Lamrf;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)V
    ...
    invoke-direct {v1, p2, v0, v2}, Lrzt;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lcom/google/vr/vrcore/controller/api/ControllerListenerOptions;I)V

    iput-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrzt;
    ...
    new-instance p2, Lamrf;

    const/4 p3, 0x2

    .line 6
    invoke-direct {p2, p0, p3}, Lamrf;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;I)V

    iput-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lamrf;
    ...
    move-result v2
    :try_end_0
    .catch Lamqw; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final e(ILrzt;)Z
    .locals 5
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lamrg;
    ...
    invoke-direct {v3, p2, v0, v4, v4}, Lamrf;-><init>(Lrzt;I[B[B)V
    ...
    .line 4
    invoke-static {p2, v3}, Ldtj;->i(Landroid/os/Parcel;Landroid/os/IInterface;)V

    const/4 p1, 0x5

    .line 1
    invoke-virtual {v1, p1, p2}, Ldth;->pQ(ILandroid/os/Parcel;)Landroid/os/Parcel;
...
.method public final a()V
    ...
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lamrg;
    ...
    .line 5
    invoke-virtual {v0, v2, v3}, Ldth;->pQ(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    iget-object v2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lamrf;
    ...
    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lamrg;
...
.method public final b()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrzt;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e(ILrzt;)Z
    ...
    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrzt;
...
.method public controllerHapticsEffect(III)V
    ...
    iget v3, v2, Lamrh;->b:I

    or-int/lit8 v3, v3, 0x1

    iput v3, v2, Lamrh;->b:I

    iput p2, v2, Lamrh;->c:I
    ...
    iget v2, p2, Lamrh;->b:I

    or-int/lit8 v2, v2, 0x2

    iput v2, p2, Lamrh;->b:I

    iput p3, p2, Lamrh;->d:I
    ...
    iput-object p2, p3, Lamrj;->d:Lamrh;

    iget p2, p3, Lamrj;->b:I

    or-int/lit8 p2, p2, 0x2

    iput p2, p3, Lamrj;->b:I
    ...
    .line 15
    invoke-virtual {p3, p2}, Lcom/google/vr/vrcore/base/api/ParcelableProtoLite;->c(Ladqq;)V
    ...
    invoke-direct {v0, p0, p1, p3, v1}, Lxld;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILcom/google/vr/vrcore/controller/api/ControllerRequest;I)V
...
.method public createAndConnectController(ILcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)Z
    ...
    iget-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lamrg;
    ...
    invoke-direct {p3, p2, v0, p1}, Lrzt;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lcom/google/vr/vrcore/controller/api/ControllerListenerOptions;I)V

    iget p2, p3, Lrzt;->a:I

    .line 2
    invoke-direct {p0, p2, p3}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e(ILrzt;)Z
    ...
    iput-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrzt;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, p2}, Lamrg;-><init>(Landroid/os/IBinder;)V

    move-object p2, v0

    .line 1
    :goto_0
    iput-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lamrg;
    ...
    .line 5
    invoke-virtual {p2, v1, v0}, Ldth;->pQ(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    iget-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrzt;
    ...
    :try_start_1
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lamrg;

    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lamrf;
    ...
    .line 17
    invoke-static {v1, v0}, Ldtj;->i(Landroid/os/Parcel;Landroid/os/IInterface;)V

    const/16 v0, 0x8

    .line 16
    invoke-virtual {p2, v0, v1}, Ldth;->pQ(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrzt;
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iput-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->f:Lamrg;
...
.method public requestBind()V
    ...
    invoke-direct {v1, p0, v2}, Ladaf;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;I)V
...
.method public vibrateController(IIII)V
    ...
    iget v3, v2, Lamri;->b:I

    or-int/lit8 v3, v3, 0x1

    iput v3, v2, Lamri;->b:I
    ...
    iget v2, p2, Lamri;->b:I

    or-int/lit8 v2, v2, 0x2

    iput v2, p2, Lamri;->b:I

    iput p3, p2, Lamri;->d:I
    ...
    iget p3, p2, Lamri;->b:I

    or-int/lit8 p3, p3, 0x4

    iput p3, p2, Lamri;->b:I

    iput p4, p2, Lamri;->e:I
    ...
    iput-object p2, p3, Lamrj;->c:Lamri;
    ...
    invoke-direct {p4, p0, p1, p3, v0}, Lxld;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILcom/google/vr/vrcore/controller/api/ControllerRequest;I)V
