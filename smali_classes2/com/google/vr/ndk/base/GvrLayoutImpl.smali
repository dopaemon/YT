...
# instance fields
.field private androidPCompat:Lampr;
...
.field private eglFactory:Lampw;
...
.field private scanlineRacingRenderer:Lamql;
...
# direct methods
.method static bridge synthetic -$$Nest$fgetscanlineRacingRenderer(Lcom/google/vr/ndk/base/GvrLayoutImpl;)Lamql;
    .locals 0

    iget-object p0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->scanlineRacingRenderer:Lamql;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/ndk/base/ExtensionManager;)V
    ...
    .line 3
    instance-of p2, p1, Lamqt;

    if-nez p2, :cond_1

    .line 4
    invoke-static {p1}, Lampr;->c(Landroid/content/Context;)Landroid/app/Activity;
...
.method private addScanlineRacingView()V
    ...
    invoke-direct {v0}, Lampw;-><init>()V

    iput-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->eglFactory:Lampw;
    ...
    iput-boolean v1, v0, Lampw;->c:Z

    iget-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->eglFactory:Lampw;

    const/4 v1, 0x1

    iput-boolean v1, v0, Lampw;->a:Z
    ...
    :goto_0
    iput-boolean v2, v0, Lampw;->b:Z

    const/4 v2, 0x3

    iput v2, v0, Lampw;->e:I
    ...
    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->eglFactory:Lampw;
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->scanlineRacingRenderer:Lamql;
    ...
    invoke-direct {v0, v2}, Lamql;-><init>(Lcom/google/vr/ndk/base/GvrApi;)V

    iput-object v0, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->scanlineRacingRenderer:Lamql;
    ...
    .line 13
    iput-object v2, v0, Lamql;->a:Lcom/google/vr/ndk/base/GvrSurfaceView;

    .line 14
    invoke-virtual {v2, v0}, Lcom/google/vr/ndk/base/GvrLayoutImpl$AsyncReprojectionSurfaceView;->setRenderer(Lamql;)V
...
.method private initWithInjectedObjects(Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/cardboard/DisplaySynchronizer;Lcom/google/vr/cardboard/EglReadyListener;Lcom/google/vr/ndk/base/FadeOverlayView;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;Lcom/google/vr/ndk/base/ExtensionManager;Lcom/google/vr/ndk/base/GvrUiLayoutImpl;Lampr;)V
    ...
    iput-object p8, p0, Lcom/google/vr/ndk/base/GvrLayoutImpl;->androidPCompat:Lampr;
...
.method private isContextSharingEnabled()Z
    ...
    .line 3
    invoke-virtual {v0}, Lcom/google/vr/ndk/base/GvrApi;->getSdkConfigurationParams()Lachn;

    move-result-object v0

    iget v0, v0, Lachn;->bitField0_:I
    ...
    iget-object v0, v0, Lachn;->asyncReprojectionConfig_:Lachh;

    if-nez v0, :cond_1

    .line 5
    sget-object v0, Lachh;->DEFAULT_INSTANCE:Lachh;

    :cond_1
    iget v2, v0, Lachh;->bitField0_:I
    ...
    iget-wide v4, v0, Lachh;->flags_:J
...
.method private isDeviceDetectionEnabled()Z
    ...
    iget-boolean v0, v0, Lachn;->useDeviceIdleDetection_:Z
...
.method private isDimUiEnabled()Z
    ...
    iget-boolean v0, v0, Lachn;->dimUiLayer_:Z
...
.method private registerLatchListener()V
    ...
    sget-object v2, Lamrv;->a:Landroid/content/ComponentName;
...
.method private tryCreatePresentationHelper()Lcom/google/vr/ndk/base/GvrLayoutImpl$PresentationHelper;
    ...
    invoke-static {v0}, Lampr;->k(Landroid/content/Context;)Ljava/lang/String;
...
.method private updateMarginsForDisplayCutout()V
    ...
    invoke-static {v0}, Lampr;->c(Landroid/content/Context;)Landroid/app/Activity;
    ...
    invoke-static {v1}, Lampr;->j(Landroid/content/Context;)Landroid/view/Display;

    move-result-object v1

    .line 11
    invoke-static {v1}, Lampr;->b(Landroid/view/Display;)Lampq;
    ...
    .line 12
    invoke-virtual {v1}, Lampq;->b()I

    move-result v2

    .line 13
    invoke-virtual {v1}, Lampq;->d()I

    move-result v3

    .line 14
    invoke-virtual {v1}, Lampq;->c()I

    move-result v4

    .line 15
    invoke-virtual {v1}, Lampq;->a()I
...
.method protected createVrCoreSdkClient(Landroid/content/Context;Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;Lcom/google/vr/ndk/base/FadeOverlayView;)Lcom/google/vr/ndk/base/VrCoreSdkClient;
    ...
    .line 1
    invoke-static {p1}, Lampr;->d(Landroid/content/Context;)Landroid/content/ComponentName;
...
.method public enableAsyncReprojection(I)Z
    ...
    iget-object v0, p1, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Lamqg;

    if-eqz v0, :cond_6

    .line 8
    invoke-virtual {v0}, Lamqg;->b()V

    const/4 v0, 0x0

    iput-object v0, p1, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Lamqg;
...
.method public synthetic lambda$setStereoModeEnabled$0$com-google-vr-ndk-base-GvrLayoutImpl(Z)V
    .locals 0
...
.method public onPause()V
    ...
    invoke-virtual {v1}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->getLoggingService()Lamrx;
    ...
    .line 2
    invoke-interface {v0, v1}, Lcom/google/vr/ndk/base/ExtensionManager;->reportTelemetry(Lamrx;)V
...
.method public onResume()V
    ...
    iget-object v0, v0, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Lamqg;

    const/4 v1, 0x1

    if-eqz v0, :cond_1

    iget-boolean v2, v0, Lamqg;->c:Z

    if-nez v2, :cond_1

    iput-boolean v1, v0, Lamqg;->c:Z

    iget-object v0, v0, Lamqg;->b:Landroid/os/Handler;
...
.method public shutdown()V
    ...
    iget-object v1, v0, Lcom/google/vr/cardboard/DisplaySynchronizer;->c:Lamqg;

    if-eqz v1, :cond_0

    .line 2
    invoke-virtual {v1}, Lamqg;->b()V
