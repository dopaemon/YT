...
.field private daydreamManager:Lamra;
...
.field private loggingService:Lamrx;
...
.field private vrCoreSdkService:Lamre;
...
.method static bridge synthetic -$$Nest$fgetdaydreamManager(Lcom/google/vr/ndk/base/VrCoreSdkClient;)Lamra;
    .locals 0

    iget-object p0, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->daydreamManager:Lamra;
...
.method static bridge synthetic -$$Nest$fgetvrCoreSdkService(Lcom/google/vr/ndk/base/VrCoreSdkClient;)Lamre;
    .locals 0

    iget-object p0, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->vrCoreSdkService:Lamre;

    return-object p0
.end method

.method static bridge synthetic -$$Nest$fputdaydreamManager(Lcom/google/vr/ndk/base/VrCoreSdkClient;Lamra;)V
    .locals 0

    iput-object p1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->daydreamManager:Lamra;

    return-void
.end method

.method static bridge synthetic -$$Nest$fputloggingService(Lcom/google/vr/ndk/base/VrCoreSdkClient;Lamrx;)V
    .locals 0

    iput-object p1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->loggingService:Lamrx;

    return-void
.end method

.method static bridge synthetic -$$Nest$fputvrCoreSdkService(Lcom/google/vr/ndk/base/VrCoreSdkClient;Lamre;)V
    .locals 0

    iput-object p1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->vrCoreSdkService:Lamre;
...
.method private doUnbind()V
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->daydreamManager:Lamra;
    ...
    .line 3
    invoke-interface {v0, v2}, Lamra;->q(Landroid/content/ComponentName;)V
    :try_end_0
    ...
    .line 3
    :goto_1
    iput-object v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->daydreamManager:Lamra;

    :cond_2
    iput-object v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->vrCoreSdkService:Lamre;

    iput-object v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->loggingService:Lamrx;
...
.method private prepareVr(Lcom/google/vr/vrcore/common/api/HeadTrackingState;)I
    ...
    invoke-interface {v0, v1, p1}, Lamra;->a(Landroid/content/ComponentName;Lcom/google/vr/vrcore/common/api/HeadTrackingState;)I
    ...
    .line 5
    instance-of v3, v2, Lamqt;

    if-nez v3, :cond_1

    .line 6
    invoke-static {v2}, Lampr;->c(Landroid/content/Context;)Landroid/app/Activity;
    ...
    .line 18
    invoke-interface {v0, v2, p1}, Lamra;->g(Landroid/os/Bundle;Lcom/google/vr/vrcore/common/api/HeadTrackingState;)I
    ...
    :cond_3
    iget-object v2, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->daydreamManager:Lamra;
    ...
    .line 19
    invoke-interface {v2, v3, v0, v1, p1}, Lamra;->b(Landroid/content/ComponentName;ILandroid/app/PendingIntent;Lcom/google/vr/vrcore/common/api/HeadTrackingState;)I
...
.method private warnIfIncompatibleClient()V
    ...
    .line 5
    invoke-static {v0, v1}, Lamqs;->b(Landroid/content/Context;Ljava/lang/Runnable;)Landroid/app/AlertDialog;
...
.method public getLoggingService()Lamrx;
    .locals 1

    iget-object v0, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->loggingService:Lamrx;
