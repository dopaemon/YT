...
.field private final vrParamsProvider:Lamqu;


# direct methods
.method static bridge synthetic -$$Nest$fgetvrParamsProvider(Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;)Lamqu;
    .locals 0

    iget-object p0, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Lamqu;

    return-object p0
.end method

.method static bridge synthetic -$$Nest$minit(Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Lampq;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->init(Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Lampq;)V
...
.method public constructor <init>(Lcom/google/vr/ndk/base/GvrLayoutImpl;)V
    ...
    iget v1, v1, Lachn;->daydreamImageAlignment_:I

    .line 3
    invoke-static {v1}, Lachk;->a(I)Lachk;

    move-result-object v1

    if-nez v1, :cond_0

    sget-object v1, Lachk;->UNKNOWN_ALIGNMENT:Lachk;

    :cond_0
    sget-object v2, Lachk;->DISABLED:Lachk;
    ...
    iget-boolean v0, v0, Lachn;->touchOverlayEnabled_:Z
    ...
    .line 6
    invoke-static {p1}, Lamif;->g(Landroid/content/Context;)Lamqu;

    move-result-object v0

    iput-object v0, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Lamqu;
    ...
    .line 8
    invoke-static {p1}, Lampr;->j(Landroid/content/Context;)Landroid/view/Display;
...
.method private init(Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Lampq;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/vr/ndk/base/AbstractDaydreamTouchListener;->initWithDisplayParams(Landroid/util/DisplayMetrics;Lcom/google/vr/sdk/proto/Display$DisplayParams;Lampq;)V
...
.method protected logEvent(Lachf;Lache;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->getLoggingService()Lamrx;
    ...
    .line 4
    sget-object v1, Lachf;->Z:Lachf;

    invoke-direct {p1, v1, p2}, Lcom/google/vr/vrcore/logging/api/VREventParcelable;-><init>(Lachf;Lache;)V
    ...
    invoke-virtual {p2}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->getLoggingService()Lamrx;

    move-result-object p2

    invoke-interface {p2, p1}, Lamrx;->a(Lcom/google/vr/vrcore/logging/api/VREventParcelable;)V
    :try_end_0
...
.method public shutdown()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Lamqu;

    invoke-interface {v0}, Lamqu;->f()V
