...
.method private static readDeviceParams(Landroid/content/Context;)[B
    ...
    .line 2
    invoke-interface {p0}, Lamqu;->b()Lcom/google/vr/sdk/proto/CardboardDevice$DeviceParams;
...
.method private static readDisplayParams(Landroid/content/Context;J)V
    ...
    invoke-static {v1}, Lampr;->f(Lcom/google/vr/sdk/proto/Display$DisplayParams;)F
    ...
    .line 5
    invoke-interface {v1}, Lamqu;->d()Lcom/google/vr/sdk/proto/Display$DisplayParams;

    move-result-object v2

    .line 6
    invoke-interface {v1}, Lamqu;->f()V
    ...
    .line 8
    invoke-static {v1, v2}, Lampr;->i(Landroid/view/Display;Lcom/google/vr/sdk/proto/Display$DisplayParams;)Landroid/util/DisplayMetrics;

    move-result-object v3

    invoke-static {v2}, Lampr;->f(Lcom/google/vr/sdk/proto/Display$DisplayParams;)F
...
.method private static readUserPrefs(Landroid/content/Context;)[B
    ...
    .line 2
    invoke-interface {p0}, Lamqu;->e()Lcom/google/vr/sdk/proto/Preferences$UserPrefs;
...
.method private static writeDeviceParams(Landroid/content/Context;[B)Z
    ...
    .line 3
    invoke-static {p1, v0}, Lcom/google/vr/sdk/proto/CardboardDevice$DeviceParams;->parseFrom([BLadop;)Lcom/google/vr/sdk/proto/CardboardDevice$DeviceParams;
    ...
    .line 4
    :goto_0
    invoke-interface {p0, p1}, Lamqu;->g(Lcom/google/vr/sdk/proto/CardboardDevice$DeviceParams;)Z
