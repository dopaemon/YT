...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldlc;->h:Landroid/graphics/drawable/Drawable;
    ...
    sput-object v2, Ldlc;->a:Landroid/content/res/ColorStateList;
    ...
    sput-object v2, Ldlc;->b:Landroid/content/res/ColorStateList;

    const-string v2, ""

    sput-object v2, Ldlc;->c:Ljava/lang/CharSequence;

    sput-object v2, Ldlc;->d:Ljava/lang/CharSequence;

    sput-object v0, Ldlc;->e:Landroid/graphics/drawable/Drawable;

    sget-object v0, Landroid/graphics/Typeface;->DEFAULT:Landroid/graphics/Typeface;

    sput-object v0, Ldlc;->f:Landroid/graphics/Typeface;
    ...
    sput-object v0, Ldlc;->g:Landroid/text/method/MovementMethod;
    ...
    sput-object v0, Ldlc;->i:Landroid/graphics/Rect;

    new-array v0, v1, [Landroid/text/InputFilter;

    sput-object v0, Ldlc;->j:[Landroid/text/InputFilter;

    return-void
.end method

.method static a(Lczu;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    .locals 3

    .line 1
    sget-object v0, Ldlc;->h:Landroid/graphics/drawable/Drawable;
...
.method static b(Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;Lday;)Z
    .locals 16
    ...
    .line 1
    iget-object v15, v2, Lday;->a:Ljava/lang/Object;

    iget-object v2, v2, Lday;->b:Ljava/lang/Object;

    invoke-static {v15, v2}, Ldlc;->k(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v2, v0, Lday;->a:Ljava/lang/Object;

    iget-object v0, v0, Lday;->b:Ljava/lang/Object;

    .line 2
    invoke-static {v2, v0}, Ldlc;->k(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 3
    invoke-static {v0, v1}, Ldlc;->k(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v0, v11, Lday;->a:Ljava/lang/Object;

    iget-object v1, v11, Lday;->b:Ljava/lang/Object;
    ...
    .line 16
    invoke-static {v1, v0}, Ldlc;->k(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 26
    :cond_4
    invoke-static {v4, v5}, Ldlc;->k(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v3, v0, Lday;->b:Ljava/lang/Object;

    .line 30
    invoke-static {v1, v3}, Ldlc;->k(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method static c(Lczu;IILddl;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;IILandroid/graphics/Typeface;IIIIILjava/util/List;ZIILjava/util/concurrent/atomic/AtomicReference;)V
    .locals 21
    ...
    invoke-direct {v14, v1}, Ldlb;-><init>(Landroid/content/Context;)V
    ...
    sget-object v1, Ldlc;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    :goto_0
    invoke-static {v0, v1}, Ldlc;->a(Lczu;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 8
    invoke-static/range {v0 .. v19}, Ldlc;->l(Lczu;Landroid/widget/EditText;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;IILandroid/graphics/Typeface;IIIIILjava/util/List;ZILandroid/text/method/MovementMethod;Ljava/lang/CharSequence;I)V

    .line 9
    invoke-static/range {p1 .. p1}, Ldaq;->J(I)I

    move-result v0

    invoke-static/range {p2 .. p2}, Ldaq;->J(I)I
...
.method protected static d(Landroid/content/Context;)Ldla;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Ldla;-><init>(Landroid/content/Context;[B)V

    return-object v0
.end method

.method static e(Lczu;Ldla;Ljava/util/List;)V
    .locals 2
    ...
    .line 2
    invoke-direct {v0, p2}, Ldkz;-><init>(Ljava/util/List;)V

    move-object p2, v0

    :goto_0
    iput-object p2, p1, Ldla;->e:Landroid/text/TextWatcher;

    iget-object p2, p1, Ldla;->e:Landroid/text/TextWatcher;

    if-eqz p2, :cond_1

    .line 3
    instance-of v0, p2, Ldlf;
    ...
    iput-object p1, v0, Ldlf;->a:Landroid/widget/EditText;

    .line 5
    :cond_1
    invoke-virtual {p1, p2}, Ldla;->addTextChangedListener(Landroid/text/TextWatcher;)V

    :cond_2
    iput-object p0, p1, Ldla;->c:Lczu;
    ...
    iget-object v0, v0, Ldky;->I:Ldbi;

    .line 6
    :goto_1
    iput-object v0, p1, Ldla;->a:Ldbi;
    ...
    iget-object p2, p2, Ldky;->J:Ldbi;

    .line 10
    :goto_2
    iput-object p2, p1, Ldla;->b:Ldbi;
...
.method static f(Ldla;)V
    .locals 3

    .line 1
    iget-object v0, p0, Ldla;->e:Landroid/text/TextWatcher;

    const/4 v1, 0x0

    if-eqz v0, :cond_1

    invoke-virtual {p0, v0}, Ldla;->removeTextChangedListener(Landroid/text/TextWatcher;)V
    ...
    iput-object v1, v0, Ldlf;->a:Landroid/widget/EditText;

    :cond_0
    iput-object v1, p0, Ldla;->e:Landroid/text/TextWatcher;

    :cond_1
    iput-object v1, p0, Ldla;->c:Lczu;

    iput-object v1, p0, Ldla;->a:Ldbi;

    iput-object v1, p0, Ldla;->b:Ldbi;

    return-void
.end method

.method static g(Ldla;Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    iput-object v0, p0, Ldla;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method static h(Lczu;Ldla;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;IILandroid/graphics/Typeface;IIIIILjava/util/List;ZILandroid/text/method/MovementMethod;ILjava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 21
    ...
    .line 2
    invoke-static {v0, v3}, Ldlc;->a(Lczu;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v0, Ldla;->d:Ljava/util/concurrent/atomic/AtomicReference;

    return-void
.end method

.method static i(Ldrj;)V
    .locals 1
...
.method static j(Ldrj;Ldrj;Ldrj;Ljava/lang/CharSequence;)V
    .locals 1
    ...
    iput-object p0, p2, Ldrj;->a:Ljava/lang/Object;
...
.method private static l(Lczu;Landroid/widget/EditText;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;IILandroid/graphics/Typeface;IIIIILjava/util/List;ZILandroid/text/method/MovementMethod;Ljava/lang/CharSequence;I)V
    ...
    .line 53
    :cond_4
    sget-object v3, Ldlc;->j:[Landroid/text/InputFilter;
    ...
    sget-object v3, Ldlc;->i:Landroid/graphics/Rect;
    ...
    .line 49
    invoke-static {v5, v3}, Lxb;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v1}, Labl;->O(Landroid/view/View;Landroid/content/res/ColorStateList;)V
