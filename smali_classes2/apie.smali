...
# direct methods
.method public constructor <init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lapif;I)V
    .locals 0

    iput p3, p0, Lapie;->c:I

    iput-object p1, p0, Lapie;->b:Lorg/chromium/net/HttpNegotiateAuthenticator;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lapie;->a:Lapif;
...
.method public final run(Landroid/accounts/AccountManagerFuture;)V
    ...
    .line 14
    invoke-static {v3, v0, p1}, Laphj;->f(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object p1, p0, Lapie;->a:Lapif;

    .line 15
    iget-wide v3, p1, Lapif;->a:J

    iget-object p1, p0, Lapie;->b:Lorg/chromium/net/HttpNegotiateAuthenticator;
    ...
    :cond_1
    iget-object v0, p0, Lapie;->b:Lorg/chromium/net/HttpNegotiateAuthenticator;
    ...
    .line 22
    invoke-static {v3, v0, p1}, Laphj;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object p1, p0, Lapie;->a:Lapif;

    .line 23
    iget-wide v0, p1, Lapif;->a:J
    ...
    :cond_2
    iget-object v0, p0, Lapie;->a:Lapif;

    .line 25
    aget-object p1, p1, v5

    iput-object p1, v0, Lapif;->e:Ljava/lang/Object;

    .line 26
    iget-object p1, v0, Lapif;->b:Ljava/lang/Object;

    iget-object v1, v0, Lapif;->e:Ljava/lang/Object;

    iget-object v2, v0, Lapif;->d:Ljava/lang/Object;

    iget-object v3, v0, Lapif;->c:Ljava/lang/Object;

    new-instance v11, Lapie;

    iget-object v4, p0, Lapie;->b:Lorg/chromium/net/HttpNegotiateAuthenticator;

    invoke-direct {v11, v4, v0, v5}, Lapie;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lapif;I)V
    ...
    .line 10
    invoke-static {v3, p1, v0}, Laphj;->f(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    sget-object p1, Lanlm;->a:Landroid/content/Context;

    new-instance v0, Lapid;

    .line 6
    invoke-direct {v0, p0, p1}, Lapid;-><init>(Lapie;Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lapie;->a:Lapif;

    .line 8
    invoke-static {v0, p1, v1}, Lorg/chromium/net/HttpNegotiateAuthenticator;->access$100(Lorg/chromium/net/HttpNegotiateAuthenticator;Landroid/os/Bundle;Lapif;)V
