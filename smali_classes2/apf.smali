...
.method public final declared-synchronized onFailed(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;Lorg/chromium/net/CronetException;)V
    ...
    .line 1
    :try_start_0
    iget-object p2, p0, Lapf;->a:Lapg;

    iget-object p2, p2, Lapg;->e:Lorg/chromium/net/UrlRequest;
    :try_end_0
    ...
    iput-object p2, p1, Lapg;->h:Ljava/io/IOException;
    ...
    iput-object p3, p1, Lapg;->h:Ljava/io/IOException;

    .line 3
    :goto_0
    iget-object p1, p0, Lapf;->a:Lapg;

    iget-object p1, p1, Lapg;->j:Leez;
...
.method public final declared-synchronized onReadCompleted(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;Ljava/nio/ByteBuffer;)V
    ...
    iget-object p3, p2, Lapg;->e:Lorg/chromium/net/UrlRequest;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onRedirectReceived(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;Ljava/lang/String;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lapf;->a:Lapg;

    iget-object v0, v0, Lapg;->e:Lorg/chromium/net/UrlRequest;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v1, p0, Lapf;->a:Lapg;

    iget-object v1, v1, Lapg;->f:Lanz;
    ...
    invoke-direct {p3, v2, v5, p2, v1}, Laop;-><init>(ILjava/io/IOException;Ljava/util/Map;Lanz;)V
    ...
    :cond_2
    :try_start_2
    iget-object v3, p0, Lapf;->a:Lapg;

    iget-boolean v6, v3, Lapg;->c:Z

    if-eqz v6, :cond_3

    .line 7
    invoke-virtual {v3}, Lapg;->p()V

    :cond_3
    iget-object v3, p0, Lapf;->a:Lapg;

    iget-boolean v3, v3, Lapg;->d:Z
    ...
    invoke-virtual {v1, p1}, Lanz;->d(Landroid/net/Uri;)Lanz;
    ...
    .line 14
    invoke-virtual {p2, p1}, Lapg;->o(Lanz;)Lorg/chromium/net/UrlRequest$Builder;
    ...
    iput-object p1, p2, Lapg;->e:Lorg/chromium/net/UrlRequest;

    iget-object p1, p0, Lapf;->a:Lapg;

    iget-object p1, p1, Lapg;->e:Lorg/chromium/net/UrlRequest;
    ...
    iput-object p1, p2, Lapg;->h:Ljava/io/IOException;
    :try_end_5
...
.method public final declared-synchronized onResponseStarted(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;)V
    ...
    iget-object v1, v0, Lapg;->e:Lorg/chromium/net/UrlRequest;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    iput-object p2, v0, Lapg;->g:Lorg/chromium/net/UrlResponseInfo;

    iget-object p1, v0, Lapg;->j:Leez;
...
.method public final declared-synchronized onSucceeded(Lorg/chromium/net/UrlRequest;Lorg/chromium/net/UrlResponseInfo;)V
    ...
    iget-object v0, p2, Lapg;->e:Lorg/chromium/net/UrlRequest;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
