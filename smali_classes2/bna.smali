...
.method public constructor <init>(Landroid/media/MediaRouter2$RoutingController;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lbna;->e:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Lbna;->g:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Lafa;

    const/16 v1, 0x11

    invoke-direct {v0, p0, v1}, Lafa;-><init>(Lbna;I)V

    iput-object v0, p0, Lbna;->o:Ljava/lang/Runnable;

    const/4 v0, -0x1

    iput v0, p0, Lbna;->h:I

    iput-object p1, p0, Lbna;->b:Landroid/media/MediaRouter2$RoutingController;

    iput-object p2, p0, Lbna;->a:Ljava/lang/String;
    ...
    .line 3
    :goto_1
    iput-object p1, p0, Lbna;->c:Landroid/os/Messenger;
    ...
    invoke-direct {p1, p0}, Lbmz;-><init>(Lbna;)V

    invoke-direct {p2, p1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    .line 3
    :goto_2
    iput-object p2, p0, Lbna;->d:Landroid/os/Messenger;
    ...
    iput-object p1, p0, Lbna;->f:Landroid/os/Handler;
...
.method private final j()V
    ...
    .line 1
    iget-object v0, p0, Lbna;->f:Landroid/os/Handler;

    iget-object v1, p0, Lbna;->o:Ljava/lang/Runnable;
...
.method public final a()V
    ...
    .line 1
    iget-object v0, p0, Lbna;->b:Landroid/media/MediaRouter2$RoutingController;
...
.method public final c(I)V
    ...
    iget-object p1, p0, Lbna;->b:Landroid/media/MediaRouter2$RoutingController;
...
.method final d(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Lbna;->c:Landroid/os/Messenger;
    ...
    :cond_0
    iget-object v0, p0, Lbna;->g:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, p0, Lbna;->d:Landroid/os/Messenger;

    .line 10
    iput-object p1, v1, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    :try_start_0
    iget-object p1, p0, Lbna;->c:Landroid/os/Messenger;
