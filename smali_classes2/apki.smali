...
# static fields
.field private static final a:Ljava/lang/String; = "apki"


# instance fields
.field private final b:Lapjc;
...
.method public constructor <init>(Ljava/lang/String;Lorg/chromium/net/UrlRequest$Callback;Ljava/util/concurrent/Executor;Lapjc;)V
    .locals 1
    ...
    iput-object v0, p0, Lapki;->g:Ljava/util/ArrayList;

    const/4 v0, 0x3

    iput v0, p0, Lapki;->j:I

    const/4 v0, 0x0

    iput v0, p0, Lapki;->t:I
    ...
    .line 4
    iput-object p1, p0, Lapki;->c:Ljava/lang/String;

    iput-object p2, p0, Lapki;->d:Lorg/chromium/net/UrlRequest$Callback;

    iput-object p3, p0, Lapki;->e:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Lapki;->b:Lapjc;
...
# virtual methods
.method public final a()Lapkh;
    .locals 15

    .line 1
    iget-object v0, p0, Lapki;->b:Lapjc;

    iget-object v1, p0, Lapki;->c:Ljava/lang/String;

    iget-object v2, p0, Lapki;->d:Lorg/chromium/net/UrlRequest$Callback;

    iget-object v3, p0, Lapki;->e:Ljava/util/concurrent/Executor;

    iget v4, p0, Lapki;->j:I

    iget-object v5, p0, Lapki;->k:Ljava/util/Collection;

    iget-boolean v6, p0, Lapki;->h:Z

    iget-boolean v7, p0, Lapki;->i:Z

    iget-boolean v8, p0, Lapki;->n:Z

    iget-boolean v9, p0, Lapki;->o:Z

    iget v10, p0, Lapki;->p:I

    iget-boolean v11, p0, Lapki;->q:Z

    iget v12, p0, Lapki;->r:I

    iget-object v13, p0, Lapki;->s:Lorg/chromium/net/RequestFinishedInfo$Listener;

    iget v14, p0, Lapki;->t:I

    invoke-virtual/range {v0 .. v14}, Lapjc;->b(Ljava/lang/String;Lorg/chromium/net/UrlRequest$Callback;Ljava/util/concurrent/Executor;ILjava/util/Collection;ZZZZIZILorg/chromium/net/RequestFinishedInfo$Listener;I)Lapkh;

    move-result-object v0

    iget-object v1, p0, Lapki;->f:Ljava/lang/String;

    if-eqz v1, :cond_0

    .line 2
    invoke-virtual {v0, v1}, Lapkh;->g(Ljava/lang/String;)V

    :cond_0
    iget-object v1, p0, Lapki;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v5, v4}, Lapkh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v1, p0, Lapki;->l:Lorg/chromium/net/UploadDataProvider;

    if-eqz v1, :cond_2

    iget-object v2, p0, Lapki;->m:Ljava/util/concurrent/Executor;

    .line 5
    invoke-virtual {v0, v1, v2}, Lapkh;->h(Lorg/chromium/net/UploadDataProvider;Ljava/util/concurrent/Executor;)V
...
.method public final bridge synthetic addHeader(Ljava/lang/String;Ljava/lang/String;)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lapki;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final bridge synthetic addRequestAnnotation(Ljava/lang/Object;)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
    ...
    .line 1
    iget-object v0, p0, Lapki;->k:Ljava/util/Collection;
    ...
    iput-object v0, p0, Lapki;->k:Ljava/util/Collection;
...
.method public final b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p1, Lapki;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lapki;->g:Ljava/util/ArrayList;
...
.method public final bridge synthetic build()Lorg/chromium/net/ExperimentalUrlRequest;
    ...
    .line 1
    invoke-virtual {p0}, Lapki;->a()Lapkh;
...
.method public final e(Lorg/chromium/net/UploadDataProvider;Ljava/util/concurrent/Executor;)V
    ...
    .line 2
    iget-object v0, p0, Lapki;->f:Ljava/lang/String;

    if-nez v0, :cond_0

    const-string v0, "POST"

    iput-object v0, p0, Lapki;->f:Ljava/lang/String;

    :cond_0
    iput-object p1, p0, Lapki;->l:Lorg/chromium/net/UploadDataProvider;

    iput-object p2, p0, Lapki;->m:Ljava/util/concurrent/Executor;
...
.method public final setHttpMethod(Ljava/lang/String;)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
    ...
    .line 1
    iput-object p1, p0, Lapki;->f:Ljava/lang/String;
...
.method public final bridge synthetic setHttpMethod(Ljava/lang/String;)Lorg/chromium/net/UrlRequest$Builder;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lapki;->setHttpMethod(Ljava/lang/String;)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
...
.method public final synthetic setRequestFinishedListener(Lorg/chromium/net/RequestFinishedInfo$Listener;)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
    ...
    iput-object p1, p0, Lapki;->s:Lorg/chromium/net/RequestFinishedInfo$Listener;
...
.method public final bridge synthetic setTrafficStatsTag(I)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
    ...
    iput-boolean v0, p0, Lapki;->o:Z

    iput p1, p0, Lapki;->p:I
...
.method public final bridge synthetic setTrafficStatsUid(I)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
    ...
    iput-boolean v0, p0, Lapki;->q:Z

    iput p1, p0, Lapki;->r:I
...
.method public final bridge synthetic setUploadDataProvider(Lorg/chromium/net/UploadDataProvider;Ljava/util/concurrent/Executor;)Lorg/chromium/net/ExperimentalUrlRequest$Builder;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lapki;->e(Lorg/chromium/net/UploadDataProvider;Ljava/util/concurrent/Executor;)V
