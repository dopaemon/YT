...
# direct methods
.method public constructor <init>(Lbjw;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    .locals 2
    ...
    iput-object p3, p0, Lbjz;->d:Ljava/util/Map;

    iput-object p4, p0, Lbjz;->e:Ljava/util/Map;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableMap(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p2

    iput-object p2, p0, Lbjz;->c:Ljava/util/Map;
    ...
    .line 3
    invoke-virtual {p1, p2, p3}, Lbjw;->d(Ljava/util/TreeSet;Z)V
...
.method public final d(J)Ljava/util/List;
    ...
    .line 1
    iget-object v6, p0, Lbjz;->a:Lbjw;

    iget-object v7, p0, Lbjz;->c:Ljava/util/Map;

    iget-object v8, p0, Lbjz;->d:Ljava/util/Map;

    iget-object v9, p0, Lbjz;->e:Ljava/util/Map;

    new-instance v10, Ljava/util/ArrayList;

    invoke-direct {v10}, Ljava/util/ArrayList;-><init>()V

    iget-object v0, v6, Lbjw;->h:Ljava/lang/String;

    .line 2
    invoke-virtual {v6, p1, p2, v0, v10}, Lbjw;->e(JLjava/lang/String;Ljava/util/List;)V
    ...
    iget-object v4, v6, Lbjw;->h:Ljava/lang/String;
    ...
    iget-object v5, v6, Lbjw;->h:Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v6}, Lbjw;->f(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    iput-object v3, v4, Lamj;->b:Landroid/graphics/Bitmap;
    ...
    .line 11
    invoke-virtual {v4, v3, v0}, Lamj;->b(FI)V
    ...
    iget-object v3, v1, Lamj;->a:Ljava/lang/CharSequence;
    ...
    .line 37
    invoke-virtual {v1, v3, v4}, Lamj;->b(FI)V
    ...
    .line 38
    invoke-virtual {v1, v3, v4}, Lamj;->c(FI)V
