...
.method public constructor <init>(Lorg/chromium/net/impl/CronetBidirectionalStream;Ljava/nio/ByteBuffer;Z)V
    ...
    iput-object p1, p0, Lapjb;->a:Lorg/chromium/net/impl/CronetBidirectionalStream;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lapjb;->b:Ljava/nio/ByteBuffer;

    iput-boolean p3, p0, Lapjb;->c:Z
...
.method public final run()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lapjb;->b:Ljava/nio/ByteBuffer;

    const/4 v1, 0x0

    iput-object v1, p0, Lapjb;->b:Ljava/nio/ByteBuffer;

    iget-object v1, p0, Lapjb;->a:Lorg/chromium/net/impl/CronetBidirectionalStream;
    ...
    :try_start_1
    iget-object v2, p0, Lapjb;->a:Lorg/chromium/net/impl/CronetBidirectionalStream;
    ...
    iget-boolean v5, p0, Lapjb;->c:Z

    .line 3
    invoke-virtual {v2, v1, v3, v0, v5}, Lapkm;->onWriteCompleted(Lorg/chromium/net/BidirectionalStream;Lorg/chromium/net/UrlResponseInfo;Ljava/nio/ByteBuffer;Z)V

    if-eqz v4, :cond_2

    iget-object v0, p0, Lapjb;->a:Lorg/chromium/net/impl/CronetBidirectionalStream;
