...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Ldv;->c:Ljava/lang/Object;
    ...
    iput-object v0, p0, Ldv;->e:Landroid/os/RemoteCallbackList;

    .line 2
    invoke-virtual {p0, p1, p2}, Ldv;->s(Landroid/content/Context;Ljava/lang/String;)Landroid/media/session/MediaSession;

    move-result-object p1

    iput-object p1, p0, Ldv;->a:Landroid/media/session/MediaSession;
    ...
    invoke-direct {v0, p0}, Ldk;-><init>(Ldv;)V

    invoke-direct {p2, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Ldl;)V

    iput-object p2, p0, Ldv;->b:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    .line 4
    invoke-virtual {p0}, Ldv;->q()V
...
.method public final b()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iget-object v0, p0, Ldv;->b:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public final c()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iget-object v0, p0, Ldv;->f:Landroid/support/v4/media/session/PlaybackStateCompat;

    return-object v0
.end method

.method public d()Lajo;
    .locals 2
...
.method public final e()Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Ldv;->a:Landroid/media/session/MediaSession;
    ...
    iget-object v2, p0, Ldv;->a:Landroid/media/session/MediaSession;
...
.method public final f()V
    ...
    iget-object v1, p0, Ldv;->e:Landroid/os/RemoteCallbackList;
    ...
    :try_start_0
    iget-object v1, p0, Ldv;->a:Landroid/media/session/MediaSession;
...
.method public final h(Ldt;Landroid/os/Handler;)V
    .locals 4
    ...
    .line 4
    :cond_0
    iget-object v3, p1, Ldt;->b:Landroid/media/session/MediaSession$Callback;
    ...
    iget-object v1, p1, Ldt;->a:Ljava/lang/Object;
    ...
    iput-object v3, p1, Ldt;->c:Ljava/lang/ref/WeakReference;

    iget-object v3, p1, Ldt;->d:Ldr;

    if-eqz v3, :cond_1

    .line 3
    invoke-virtual {v3, v2}, Ldr;->removeCallbacksAndMessages(Ljava/lang/Object;)V
    ...
    invoke-direct {v2, p1, p2}, Ldr;-><init>(Ldt;Landroid/os/Looper;)V

    .line 3
    :goto_1
    iput-object v2, p1, Ldt;->d:Ldr;
...
.method public final k(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 6
    iput-object p1, p0, Ldv;->g:Landroid/support/v4/media/MediaMetadataCompat;
...
.method public final l(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 1
    iput-object p1, p0, Ldv;->f:Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iget-object v2, p0, Ldv;->e:Landroid/os/RemoteCallbackList;
    ...
    .line 3
    :try_start_1
    invoke-interface {v2, p1}, Ldi;->a(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    :try_end_1
    ...
    .line 6
    invoke-static {}, Leb;->i()Landroid/media/session/PlaybackState$Builder;
    ...
    .line 7
    invoke-static/range {v2 .. v8}, Leb;->x(Landroid/media/session/PlaybackState$Builder;IJFJ)V

    iget-wide v2, p1, Landroid/support/v4/media/session/PlaybackStateCompat;->c:J

    .line 8
    invoke-static {v1, v2, v3}, Leb;->u(Landroid/media/session/PlaybackState$Builder;J)V

    iget-wide v2, p1, Landroid/support/v4/media/session/PlaybackStateCompat;->e:J

    .line 9
    invoke-static {v1, v2, v3}, Leb;->s(Landroid/media/session/PlaybackState$Builder;J)V

    iget-object v2, p1, Landroid/support/v4/media/session/PlaybackStateCompat;->g:Ljava/lang/CharSequence;

    .line 10
    invoke-static {v1, v2}, Leb;->v(Landroid/media/session/PlaybackState$Builder;Ljava/lang/CharSequence;)V
    ...
    .line 12
    invoke-static {v4, v5, v6}, Leb;->j(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/media/session/PlaybackState$CustomAction$Builder;
    ...
    .line 13
    invoke-static {v4, v3}, Leb;->w(Landroid/media/session/PlaybackState$CustomAction$Builder;Landroid/os/Bundle;)V

    .line 14
    invoke-static {v4}, Leb;->k(Landroid/media/session/PlaybackState$CustomAction$Builder;)Landroid/media/session/PlaybackState$CustomAction;

    move-result-object v4

    .line 15
    :cond_1
    invoke-static {v1, v4}, Leb;->r(Landroid/media/session/PlaybackState$Builder;Landroid/media/session/PlaybackState$CustomAction;)V
    ...
    .line 16
    invoke-static {v1, v2, v3}, Leb;->t(Landroid/media/session/PlaybackState$Builder;J)V

    iget-object v2, p1, Landroid/support/v4/media/session/PlaybackStateCompat;->k:Landroid/os/Bundle;

    .line 17
    invoke-static {v1, v2}, Lec;->b(Landroid/media/session/PlaybackState$Builder;Landroid/os/Bundle;)V

    .line 18
    invoke-static {v1}, Leb;->l(Landroid/media/session/PlaybackState$Builder;)Landroid/media/session/PlaybackState;
...
.method public final m(I)V
    ...
    iget-object p1, p0, Ldv;->a:Landroid/media/session/MediaSession;
...
.method public final n(Lajt;)V
    .locals 1

    .line 1
    iget-object v0, p0, Ldv;->a:Landroid/media/session/MediaSession;

    invoke-virtual {p1}, Lajt;->a()Ljava/lang/Object;
